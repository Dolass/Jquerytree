var zWizContentSelector="body",zWizEditorCallback={callback:{getDomImg:function(){alert("getImg");zWizEditorUpdateImg({src:""})},getDomTxt:function(f){alert(f)}}};
...
b._main=this,b.initHtml(),this.bind("click",{callback:function(b){typeof b=="string"?a.callback.getDomTxt.apply(this,[b]):a.callback.getDomImg.apply(this,[])}},b.handler.onClick)};f.fn.wizEditorStop=function(){if(this.get(0))b._isEditing=!1,b._curObj=null,b.recoverHtml(),b._main=null,this.unbind("click",b.handler.onClick)};window.zWizEditorGetHtml=function(){return b.getHTML()};window.zWizEditorUpdateHtml=function(a){b.updateText(a)};window.zWizEditorUpdateImg=function(a){b.updateImg(a)};window.zWizEditorReset=
