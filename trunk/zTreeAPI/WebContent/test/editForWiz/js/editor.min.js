var zWizContentSelector="body",zWizEditorCallback={callback:{getDomImg:function(f){window.WizNote.onEditorClickImage(f)},getDomTxt:function(f){window.WizNote.onEditorClickText(f)}}};
...
c=a.target,e=c.childNodes,f=!1,g,h;b._curObj&&b.resetEdit();if(c.tagName.toLowerCase()=="img")c.style.border=b.IMG_BORDER,b._curObj=c,a.data.callback.apply(this,[c]);else{for(g=0,h=e.length;g<h;g++)if(e[g]==d){f=!0;break}e="";if(f)b._curObj=d,e=d.textContent;else if(c.children.length==0)b._curObj=c,e=c.innerText;e.length>0?a.data.callback.apply(this,[e]):b._curObj=null}a.preventDefault&&a.preventDefault();if(a.bubbles)a.bubbles=!1}}};f.fn.wizEditorStart=function(a){if(this.get(0)&&!b._isEditing)b.resetEdit(),
b._main=this,b.initHtml(),this.bind("click",{callback:function(b){typeof b=="string"?a.callback.getDomTxt.apply(this,[b]):a.callback.getDomImg.apply(this,[b.src])}},b.handler.onClick)};f.fn.wizEditorStop=function(){if(this.get(0))b._isEditing=!1,b._curObj=null,b.recoverHtml(),b._main=null,this.unbind("click",b.handler.onClick)};window.zWizEditorGetHtml=function(){return b.getHTML()};window.zWizEditorUpdateText=function(a){b.updateText(a)};window.zWizEditorUpdateImg=function(a){b.updateImg(a)};window.zWizEditorReset=
