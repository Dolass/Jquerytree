...
e[B].edit.enable&&e[B].treeId!=g.treeId&&(b.target.id==e[B].treeId||m(b.target).parents("#"+e[B].treeId).length>0))D=!0,j=e[B];B=x.scrollTop();k=x.scrollLeft();i=j.treeObj.offset();a=j.treeObj.get(0).scrollHeight;e=j.treeObj.get(0).scrollWidth;c=b.clientY+B-i.top;var E=j.treeObj.height()+i.top-b.clientY-B,q=b.clientX+k-i.left,p=j.treeObj.width()+i.left-b.clientX-k;i=c<g.edit.drag.borderMax&&c>g.edit.drag.borderMin;var s=E<g.edit.drag.borderMax&&E>g.edit.drag.borderMin,N=q<g.edit.drag.borderMax&&q>
g.edit.drag.borderMin,G=p<g.edit.drag.borderMax&&p>g.edit.drag.borderMin,E=c>g.edit.drag.borderMin&&E>g.edit.drag.borderMin&&q>g.edit.drag.borderMin&&p>g.edit.drag.borderMin,q=i&&j.treeObj.scrollTop()<=0,p=s&&j.treeObj.scrollTop()+j.treeObj.height()+10>=a,O=N&&j.treeObj.scrollLeft()<=0,P=G&&j.treeObj.scrollLeft()+j.treeObj.width()+10>=e;if(b.target.id&&j.treeObj.find("#"+b.target.id).length>0){for(var A=b.target;A&&A.tagName&&!h.eqs(A.tagName,"li")&&A.id!=j.treeId;)A=A.parentNode;var K=!0;for(a=0,
c=n.length;a<c;a++)if(e=n[a],A.id===e.tId){K=!1;break}else if(m("#"+e.tId).find("#"+A.id).length>0){K=!1;break}if(K&&b.target.id&&(b.target.id==A.id+d.id.A||m(b.target).parents("#"+A.id+d.id.A).length>0))r=m(A),v=A.id}e=n[0];if(E&&(b.target.id==j.treeId||m(b.target).parents("#"+j.treeId).length>0)){if(!r&&(b.target.id==j.treeId||q||p||O||P)&&(D||!D&&e.parentTId))r=j.treeObj;i?j.treeObj.scrollTop(j.treeObj.scrollTop()-10):s&&j.treeObj.scrollTop(j.treeObj.scrollTop()+10);N?j.treeObj.scrollLeft(j.treeObj.scrollLeft()-
...
d.move.TYPE_INNER;var q,n;p?n=q=b.treeObj:k||(l==d.move.TYPE_INNER?f.expandCollapseNode(b,a,!0,!1):f.expandCollapseNode(b,a.getParentNode(),!0,!1),q=m("#"+a.tId),n=m("#"+a.tId+d.id.UL));var x=m("#"+c.tId).remove();n&&l==d.move.TYPE_INNER?n.append(x):q&&l==d.move.TYPE_PREV?q.before(x):q&&l==d.move.TYPE_NEXT&&q.after(x);var w=-1,u=0,r=null;q=null;var C=c.level;if(c.isFirstNode){if(w=0,h[g].length>1)r=h[g][1],r.isFirstNode=!0}else if(c.isLastNode)w=h[g].length-1,r=h[g][w-1],r.isLastNode=!0;else for(n=
0,x=h[g].length;n<x;n++)if(h[g][n].tId==c.tId){w=n;break}w>=0&&h[g].splice(w,1);if(l!=d.move.TYPE_INNER)for(n=0,x=i[g].length;n<x;n++)i[g][n].tId==a.tId&&(u=n);if(l==d.move.TYPE_INNER){p?c.parentTId=null:(a.isParent=!0,a.open=!1,c.parentTId=a.tId);a[g]||(a[g]=[]);if(a[g].length>0)q=a[g][a[g].length-1],q.isLastNode=!1;a[g].splice(a[g].length,0,c);c.isLastNode=!0;c.isFirstNode=a[g].length==1}else a.isFirstNode&&l==d.move.TYPE_PREV?(i[g].splice(u,0,c),q=a,q.isFirstNode=!1,c.parentTId=a.parentTId,c.isFirstNode=
!0,c.isLastNode=!1):a.isLastNode&&l==d.move.TYPE_NEXT?(i[g].splice(u+1,0,c),q=a,q.isLastNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!0):(l==d.move.TYPE_PREV?i[g].splice(u,0,c):i[g].splice(u+1,0,c),c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!1);o.fixPIdKeyValue(b,c);o.setSonNodeLevel(b,c.getParentNode(),c);f.setNodeLineIcos(b,c);f.repairNodeLevelClass(b,c,C);!b.data.keep.parent&&h[g].length<1?(h.isParent=!1,h.open=!1,a=m("#"+h.tId+d.id.UL),l=m("#"+h.tId+d.id.SWITCH),g=
m("#"+h.tId+d.id.ICON),f.replaceSwitchClass(h,l,d.folder.DOCU),f.replaceIcoClass(h,g,d.folder.DOCU),a.css("display","none")):r&&f.setNodeLineIcos(b,r);q&&f.setNodeLineIcos(b,q);b.check.enable&&f.repairChkClass&&(f.repairChkClass(b,h),f.repairParentChkClassWithSelf(b,h),h!=c.parent&&f.repairParentChkClassWithSelf(b,c));k||f.expandCollapseParentNode(b,c.getParentNode(),!0,e)}},removeChildNodes:function(b,a){if(a){var c=b.data.key.children,l=a[c];if(l){for(var e=0,k=l.length;e<k;e++)o.removeNodeCache(b,
l[e]);o.removeSelectedNode(b);delete a[c];b.data.keep.parent?m("#"+a.tId+d.id.UL).empty():(a.isParent=!1,a.open=!1,c=m("#"+a.tId+d.id.SWITCH),l=m("#"+a.tId+d.id.ICON),f.replaceSwitchClass(a,c,d.folder.DOCU),f.replaceIcoClass(a,l,d.folder.DOCU),m("#"+a.tId+d.id.UL).remove())}}},removeEditBtn:function(b){m("#"+b.tId+d.id.EDIT).unbind().remove()},removeNode:function(b,a){var c=o.getRoot(b),l=b.data.key.children,e=a.parentTId?a.getParentNode():c;if(c.curEditNode===a)c.curEditNode=null;a.isFirstNode=!1;
...
c,c[d][a])}}}};m.extend(!0,m.fn.zTree.consts,{event:{DRAG:"ztree_drag",DROP:"ztree_drop",REMOVE:"ztree_remove",RENAME:"ztree_rename"},id:{EDIT:"_edit",INPUT:"_input",REMOVE:"_remove"},move:{TYPE_INNER:"inner",TYPE_PREV:"prev",TYPE_NEXT:"next"},node:{CURSELECTED_EDIT:"curSelectedNode_Edit",TMPTARGET_TREE:"tmpTargetzTree",TMPTARGET_NODE:"tmpTargetNode"}});m.extend(!0,m.fn.zTree._z,p);var p=m.fn.zTree,h=p._z.tools,d=p.consts,f=p._z.view,o=p._z.data,p=p._z.event;o.exSetting({edit:{enable:!1,editNameSelectAll:!1,
showRemoveBtn:!0,showRenameBtn:!0,removeTitle:"remove",renameTitle:"rename",drag:{autoExpandTrigger:!1,isCopy:!0,isMove:!0,prev:!0,next:!0,inner:!0,minMoveSize:5,borderMax:10,borderMin:-5,maxShowNodeNum:5,autoOpenTime:500}},view:{addHoverDom:null,removeHoverDom:null},callback:{beforeDrag:null,beforeDragOpen:null,beforeDrop:null,beforeEditName:null,beforeRemove:null,beforeRename:null,onDrag:null,onDrop:null,onRemove:null,onRename:null}});o.addInitBind(function(b){var a=b.treeObj,c=d.event;a.unbind(c.RENAME);
a.bind(c.RENAME,function(a,c,d){h.apply(b.callback.onRename,[a,c,d])});a.unbind(c.REMOVE);a.bind(c.REMOVE,function(a,c,d){h.apply(b.callback.onRemove,[a,c,d])});a.unbind(c.DRAG);a.bind(c.DRAG,function(a,c,d){h.apply(b.callback.onDrag,[a,c,d])});a.unbind(c.DROP);a.bind(c.DROP,function(a,c,d,f,g){h.apply(b.callback.onDrop,[a,c,d,f,g])})});o.addInitCache(function(){});o.addInitNode(function(b,a,c){if(c)c.isHover=!1,c.editNameFlag=!1});o.addInitProxy(function(b){var a=b.target,c=o.getSetting(b.data.treeId),
f=b.relatedTarget,e="",k=null,i="",g=null,m=null;if(h.eqs(b.type,"mouseover")){if(m=h.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+d.id.A}]))e=m.parentNode.id,i="hoverOverNode"}else if(h.eqs(b.type,"mouseout"))m=h.getMDom(c,f,[{tagName:"a",attrName:"treeNode"+d.id.A}]),m||(e="remove",i="hoverOutNode");else if(h.eqs(b.type,"mousedown")&&(m=h.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+d.id.A}])))e=m.parentNode.id,i="mousedownNode";if(e.length>0)switch(k=o.getNodeCache(c,e),i){case "mousedownNode":g=
C.onMousedownNode;break;case "hoverOverNode":g=C.onHoverOverNode;break;case "hoverOutNode":g=C.onHoverOutNode}return{stop:!1,node:k,nodeEventType:i,nodeEventCallback:g,treeEventType:"",treeEventCallback:null}});o.addInitRoot(function(b){b=o.getRoot(b);b.curEditNode=null;b.curEditInput=null;b.curHoverNode=null;b.dragFlag=0;b.dragNodeShowBefore=[];b.dragMaskList=[];b.showHoverDom=!0});o.addZTreeTools(function(b,a){a.addNodes=function(a,d,e){function k(){f.addNodes(b,a,i,e==!0)}if(!d)return null;a||
(a=null);if(a&&!a.isParent&&b.data.keep.leaf)return null;var i=h.clone(h.isArray(d)?d:[d]);b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,e,k):k();return i};a.cancelEditName=function(a){var d=o.getRoot(b),e=b.data.key.name,h=d.curEditNode;d.curEditNode&&f.cancelCurEditNode(b,a?a:h[e])};a.copyNode=function(a,l,e,k){if(!l)return null;if(a&&!a.isParent&&b.data.keep.leaf&&e===d.move.TYPE_INNER)return null;var i=h.clone(l);if(!a)a=null,e=d.move.TYPE_INNER;e==d.move.TYPE_INNER?(l=function(){f.addNodes(b,
a,[i],k)},b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,k,l):l()):(f.addNodes(b,a.parentNode,[i],k),f.moveNode(b,a,i,e,!1,k));return i};a.editName=function(a){a&&a.tId&&a===o.getNodeCache(b,a.tId)&&(a.parentTId&&f.expandCollapseParentNode(b,a.getParentNode(),!0),f.editNode(b,a))};a.moveNode=function(a,l,e,k){function i(){f.moveNode(b,a,l,e,!1,k)}if(!l)return l;if(a&&!a.isParent&&b.data.keep.leaf&&e===d.move.TYPE_INNER)return null;else if(a&&(l.parentTId==a.tId&&e==d.move.TYPE_INNER||m("#"+l.tId).find("#"+
a.tId).length>0))return null;else a||(a=null);b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,k,i):i();return l};a.removeNode=function(a,l){a&&(l=!!l,l&&h.apply(b.callback.beforeRemove,[b.treeId,a],!0)==!1||(f.removeNode(b,a),l&&this.setting.treeObj.trigger(d.event.REMOVE,[b.treeId,a])))};a.removeChildNodes=function(a){if(!a)return null;var d=a[b.data.key.children];f.removeChildNodes(b,a);return d?d:null};a.setEditable=function(a){b.edit.enable=a;return this.refresh()}});var H=f.cancelPreSelectedNode;
f.cancelPreSelectedNode=function(b,a){for(var c=o.getRoot(b).curSelectedList,d=0,e=c.length;d<e;d++)if(!a||a===c[d])if(f.removeTreeDom(b,c[d]),a)break;H&&H.apply(f,arguments)};var I=f.createNodes;f.createNodes=function(b,a,c,d){I&&I.apply(f,arguments);c&&f.repairParentChkClassWithSelf&&f.repairParentChkClassWithSelf(b,d)};f.makeNodeUrl=function(b,a){return a.url&&!b.edit.enable?a.url:null};var F=f.selectNode;f.selectNode=function(b,a,c){var d=o.getRoot(b);if(o.isSelectedNode(b,a)&&d.curEditNode==
a&&a.editNameFlag)return!1;F&&F.apply(f,arguments);f.addHoverDom(b,a);return!0};var G=h.uCanDo;h.uCanDo=function(b,a){var c=o.getRoot(b);return a&&(h.eqs(a.type,"mouseover")||h.eqs(a.type,"mouseout")||h.eqs(a.type,"mousedown")||h.eqs(a.type,"mouseup"))?!0:!c.curEditNode&&(G?G.apply(f,arguments):!0)}})(jQuery);
