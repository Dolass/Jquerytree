...
c=n.length;a<c;a++)if(e=n[a],A.id===e.tId){K=!1;break}else if(m("#"+e.tId).find("#"+A.id).length>0){K=!1;break}if(K&&b.target.id&&(b.target.id==A.id+d.id.A||m(b.target).parents("#"+A.id+d.id.A).length>0))r=m(A),v=A.id}e=n[0];if(q&&(b.target.id==j.treeId||m(b.target).parents("#"+j.treeId).length>0)){if(!r&&(b.target.id==j.treeId||p||E||O||P)&&(D||!D&&e.parentTId))r=j.treeObj;i?j.treeObj.scrollTop(j.treeObj.scrollTop()-10):s&&j.treeObj.scrollTop(j.treeObj.scrollTop()+10);N?j.treeObj.scrollLeft(j.treeObj.scrollLeft()-
...
[j.treeId,n,null],!!j.edit.drag.inner)?r.addClass(d.node.TMPTARGET_TREE):r=null,u.css({display:"none"}),window.zTreeMoveTimer)clearTimeout(window.zTreeMoveTimer),window.zTreeMoveTargetNodeTId=null;L=v;M=t}return!1}function l(b){if(window.zTreeMoveTimer)clearTimeout(window.zTreeMoveTimer),window.zTreeMoveTargetNodeTId=null;M=L=null;x.unbind("mousemove",c);x.unbind("mouseup",l);x.unbind("selectstart",e);m("body").css("cursor","auto");r&&(r.removeClass(d.node.TMPTARGET_TREE),v&&m("#"+v+d.id.A,r).removeClass(d.node.TMPTARGET_NODE));
...
[j.treeId,n,p,t],!0)!=!1){var s=q?h.clone(n):n,b=function(){if(D){if(!q)for(var b=0,a=n.length;b<a;b++)f.removeNode(g,n[b]);if(t==d.move.TYPE_INNER)f.addNodes(j,p,s);else if(f.addNodes(j,p.getParentNode(),s),t==d.move.TYPE_PREV)for(b=0,a=s.length;b<a;b++)f.moveNode(j,p,s[b],t,!1);else for(b=-1,a=s.length-1;b<a;a--)f.moveNode(j,p,s[a],t,!1)}else if(q&&t==d.move.TYPE_INNER)f.addNodes(j,p,s);else if(q&&f.addNodes(j,p.getParentNode(),s),t==d.move.TYPE_PREV)for(b=0,a=s.length;b<a;b++)f.moveNode(j,p,s[b],
t,!1);else for(b=-1,a=s.length-1;b<a;a--)f.moveNode(j,p,s[a],t,!1);for(b=0,a=s.length;b<a;b++)f.selectNode(j,s[b],b>0);m("#"+s[0].tId+d.id.ICON).focus().blur()};t==d.move.TYPE_INNER&&h.canAsync(j,p)?f.asyncNode(j,p,!1,b):b();g.treeObj.trigger(d.event.DROP,[j.treeId,s,p,t])}}else{for(a=0,k=n.length;a<k;a++)f.selectNode(j,n[a],a>0);g.treeObj.trigger(d.event.DROP,[g.treeId,null,null,null])}}}function e(){return!1}var k,i,g=o.getSetting(b.data.treeId),z=o.getRoot(g);if(b.button==2||!g.edit.enable||!g.edit.drag.isCopy&&
...
c);x.bind("mouseup",l);x.bind("selectstart",e);b.preventDefault&&b.preventDefault();return!0}},p={tools:{getAbs:function(b){b=b.getBoundingClientRect();return[b.left,b.top]},inputFocus:function(b){b.get(0)&&(b.focus(),h.setCursorPosition(b.get(0),b.val().length))},inputSelect:function(b){b.get(0)&&(b.focus(),b.select())},setCursorPosition:function(b,a){if(b.setSelectionRange)b.focus(),b.setSelectionRange(a,a);else if(b.createTextRange){var c=b.createTextRange();c.collapse(!0);c.moveEnd("character",
a);c.moveStart("character",a);c.select()}},showIfameMask:function(b,a){for(var c=o.getRoot(b);c.dragMaskList.length>0;)c.dragMaskList[0].remove(),c.dragMaskList.shift();if(a)for(var d=m("iframe"),e=0,f=d.length;e<f;e++){var i=d.get(e),g=h.getAbs(i),i=m("<div id='zTreeMask_"+e+"' class='zTreeMask' style='background-color:yellow;opacity: 0.3;filter: alpha(opacity=30);    top:"+g[1]+"px; left:"+g[0]+"px; width:"+i.offsetWidth+"px; height:"+i.offsetHeight+"px;'></div>");i.appendTo("body");c.dragMaskList.push(i)}}},
view:{addEditBtn:function(b,a){if(!(a.editNameFlag||m("#"+a.tId+d.id.EDIT).length>0)&&h.apply(b.edit.showRenameBtn,[b.treeId,a],b.edit.showRenameBtn)){var c=m("#"+a.tId+d.id.A),l="<button type='button' class='edit' id='"+a.tId+d.id.EDIT+"' title='"+h.apply(b.edit.renameTitle,[b.treeId,a],b.edit.renameTitle)+"' treeNode"+d.id.EDIT+" onfocus='this.blur();' style='display:none;'></button>";c.append(l);m("#"+a.tId+d.id.EDIT).bind("click",function(){if(!h.uCanDo(b)||h.apply(b.callback.beforeEditName,[b.treeId,
a],!0)==!1)return!0;f.editNode(b,a);return!1}).show()}},addRemoveBtn:function(b,a){if(!(a.editNameFlag||m("#"+a.tId+d.id.REMOVE).length>0)&&h.apply(b.edit.showRemoveBtn,[b.treeId,a],b.edit.showRemoveBtn)){var c=m("#"+a.tId+d.id.A),l="<button type='button' class='remove' id='"+a.tId+d.id.REMOVE+"' title='"+h.apply(b.edit.removeTitle,[b.treeId,a],b.edit.removeTitle)+"' treeNode"+d.id.REMOVE+" onfocus='this.blur();' style='display:none;'></button>";c.append(l);m("#"+a.tId+d.id.REMOVE).bind("click",function(){if(!h.uCanDo(b)||
h.apply(b.callback.beforeRemove,[b.treeId,a],!0)==!1)return!0;f.removeNode(b,a);b.treeObj.trigger(d.event.REMOVE,[b.treeId,a]);return!1}).bind("mousedown",function(){return!0}).show()}},addHoverDom:function(b,a){if(o.getRoot(b).showHoverDom)a.isHover=!0,b.edit.enable&&(f.addEditBtn(b,a),f.addRemoveBtn(b,a)),h.apply(b.view.addHoverDom,[b.treeId,a])},cancelCurEditNode:function(b,a){var c=o.getRoot(b),l=b.data.key.name,e=c.curEditNode;if(e){var k=c.curEditInput,i=a?a:k.val();if(!a&&h.apply(b.callback.beforeRename,
[b.treeId,e,i],!0)===!1)return e.editNameFlag=!0,!1;else e[l]=i?i:k.val(),a||b.treeObj.trigger(d.event.RENAME,[b.treeId,e]);m("#"+e.tId+d.id.A).removeClass(d.node.CURSELECTED_EDIT);k.unbind();f.setNodeName(b,e);e.editNameFlag=!1;c.curEditNode=null;c.curEditInput=null;f.selectNode(b,e,!1)}return c.noSelection=!0},editNode:function(b,a){var c=o.getRoot(b);f.editNodeBlur=!1;if(o.isSelectedNode(b,a)&&c.curEditNode==a&&a.editNameFlag)setTimeout(function(){h.inputFocus(c.curEditInput)},0);else{var l=b.data.key.name;
a.editNameFlag=!0;f.removeTreeDom(b,a);f.cancelCurEditNode(b);f.selectNode(b,a,!1);m("#"+a.tId+d.id.SPAN).html("<input type=text class='rename' id='"+a.tId+d.id.INPUT+"' treeNode"+d.id.INPUT+" >");var e=m("#"+a.tId+d.id.INPUT);e.attr("value",a[l]);b.edit.editNameSelectAll?h.inputSelect(e):h.inputFocus(e);e.bind("blur",function(){f.editNodeBlur||f.cancelCurEditNode(b)}).bind("keydown",function(c){c.keyCode=="13"?(f.editNodeBlur=!0,f.cancelCurEditNode(b,null,!0)):c.keyCode=="27"&&f.cancelCurEditNode(b,
a[l])}).bind("click",function(){return!1}).bind("dblclick",function(){return!1});m("#"+a.tId+d.id.A).addClass(d.node.CURSELECTED_EDIT);c.curEditInput=e;c.noSelection=!1;c.curEditNode=a}},moveNode:function(b,a,c,l,e,k){var i=o.getRoot(b),g=b.data.key.children;if(a!=c&&(!b.data.keep.leaf||!a||a.isParent||l!=d.move.TYPE_INNER)){var h=c.parentTId?c.getParentNode():i,p=a===null||a==i;p&&a===null&&(a=i);if(p)l=d.move.TYPE_INNER;i=a.parentTId?a.getParentNode():i;if(l!=d.move.TYPE_PREV&&l!=d.move.TYPE_NEXT)l=
d.move.TYPE_INNER;var q,n;p?n=q=b.treeObj:k||(l==d.move.TYPE_INNER?f.expandCollapseNode(b,a,!0,!1):f.expandCollapseNode(b,a.getParentNode(),!0,!1),q=m("#"+a.tId),n=m("#"+a.tId+d.id.UL),n.get(0)||(n=[],f.makeUlHtml(b,a,n,""),q.append(n.join(""))),n=m("#"+a.tId+d.id.UL));var x=m("#"+c.tId);n.get(0)&&l==d.move.TYPE_INNER?n.append(x):q.get(0)&&l==d.move.TYPE_PREV?q.before(x):q.get(0)&&l==d.move.TYPE_NEXT&&q.after(x);var w=-1,u=0,r=null;q=null;var C=c.level;if(c.isFirstNode){if(w=0,h[g].length>1)r=h[g][1],
r.isFirstNode=!0}else if(c.isLastNode)w=h[g].length-1,r=h[g][w-1],r.isLastNode=!0;else for(n=0,x=h[g].length;n<x;n++)if(h[g][n].tId==c.tId){w=n;break}w>=0&&h[g].splice(w,1);if(l!=d.move.TYPE_INNER)for(n=0,x=i[g].length;n<x;n++)i[g][n].tId==a.tId&&(u=n);if(l==d.move.TYPE_INNER){p?c.parentTId=null:(a.isParent=!0,a.open=!1,c.parentTId=a.tId);a[g]||(a[g]=[]);if(a[g].length>0)q=a[g][a[g].length-1],q.isLastNode=!1;a[g].splice(a[g].length,0,c);c.isLastNode=!0;c.isFirstNode=a[g].length==1}else a.isFirstNode&&
l==d.move.TYPE_PREV?(i[g].splice(u,0,c),q=a,q.isFirstNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!0,c.isLastNode=!1):a.isLastNode&&l==d.move.TYPE_NEXT?(i[g].splice(u+1,0,c),q=a,q.isLastNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!0):(l==d.move.TYPE_PREV?i[g].splice(u,0,c):i[g].splice(u+1,0,c),c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!1);o.fixPIdKeyValue(b,c);o.setSonNodeLevel(b,c.getParentNode(),c);f.setNodeLineIcos(b,c);f.repairNodeLevelClass(b,c,C);!b.data.keep.parent&&
h[g].length<1?(h.isParent=!1,h.open=!1,a=m("#"+h.tId+d.id.UL),l=m("#"+h.tId+d.id.SWITCH),g=m("#"+h.tId+d.id.ICON),f.replaceSwitchClass(h,l,d.folder.DOCU),f.replaceIcoClass(h,g,d.folder.DOCU),a.css("display","none")):r&&f.setNodeLineIcos(b,r);q&&f.setNodeLineIcos(b,q);b.check.enable&&f.repairChkClass&&(f.repairChkClass(b,h),f.repairParentChkClassWithSelf(b,h),h!=c.parent&&f.repairParentChkClassWithSelf(b,c));k||f.expandCollapseParentNode(b,c.getParentNode(),!0,e)}},removeChildNodes:function(b,a){if(a){var c=
b.data.key.children,l=a[c];if(l){for(var e=0,k=l.length;e<k;e++)o.removeNodeCache(b,l[e]);o.removeSelectedNode(b);delete a[c];b.data.keep.parent?m("#"+a.tId+d.id.UL).empty():(a.isParent=!1,a.open=!1,c=m("#"+a.tId+d.id.SWITCH),l=m("#"+a.tId+d.id.ICON),f.replaceSwitchClass(a,c,d.folder.DOCU),f.replaceIcoClass(a,l,d.folder.DOCU),m("#"+a.tId+d.id.UL).remove())}}},removeEditBtn:function(b){m("#"+b.tId+d.id.EDIT).unbind().remove()},removeNode:function(b,a){var c=o.getRoot(b),l=b.data.key.children,e=a.parentTId?
a.getParentNode():c;if(c.curEditNode===a)c.curEditNode=null;a.isFirstNode=!1;a.isLastNode=!1;a.getPreNode=function(){return null};a.getNextNode=function(){return null};m("#"+a.tId).remove();o.removeNodeCache(b,a);o.removeSelectedNode(b,a);for(var k=0,i=e[l].length;k<i;k++)if(e[l][k].tId==a.tId){e[l].splice(k,1);break}var g;if(!b.data.keep.parent&&e[l].length<1)e.isParent=!1,e.open=!1,k=m("#"+e.tId+d.id.UL),i=m("#"+e.tId+d.id.SWITCH),g=m("#"+e.tId+d.id.ICON),f.replaceSwitchClass(e,i,d.folder.DOCU),
f.replaceIcoClass(e,g,d.folder.DOCU),k.css("display","none");else if(b.view.showLine&&e[l].length>0){var h=e[l][e[l].length-1];h.isLastNode=!0;h.isFirstNode=e[l].length==1;k=m("#"+h.tId+d.id.UL);i=m("#"+h.tId+d.id.SWITCH);g=m("#"+h.tId+d.id.ICON);e==c?e[l].length==1?f.replaceSwitchClass(h,i,d.line.ROOT):(c=m("#"+e[l][0].tId+d.id.SWITCH),f.replaceSwitchClass(e[l][0],c,d.line.ROOTS),f.replaceSwitchClass(h,i,d.line.BOTTOM)):f.replaceSwitchClass(h,i,d.line.BOTTOM);k.removeClass(d.line.LINE)}},removeRemoveBtn:function(b){m("#"+
b.tId+d.id.REMOVE).unbind().remove()},removeTreeDom:function(b,a){a.isHover=!1;f.removeEditBtn(a);f.removeRemoveBtn(a);h.apply(b.view.removeHoverDom,[b.treeId,a])},repairNodeLevelClass:function(b,a,c){if(c!==a.level){var b=m("#"+a.tId),l=m("#"+a.tId+d.id.A),e=m("#"+a.tId+d.id.UL),c="level"+c,a="level"+a.level;b.removeClass(c);b.addClass(a);l.removeClass(c);l.addClass(a);e.removeClass(c);e.addClass(a)}}},event:p,data:{setSonNodeLevel:function(b,a,c){if(c){var d=b.data.key.children;c.level=a?a.level+
1:0;if(c[d])for(var a=0,e=c[d].length;a<e;a++)c[d][a]&&o.setSonNodeLevel(b,c,c[d][a])}}}};m.extend(!0,m.fn.zTree.consts,{event:{DRAG:"ztree_drag",DROP:"ztree_drop",REMOVE:"ztree_remove",RENAME:"ztree_rename"},id:{EDIT:"_edit",INPUT:"_input",REMOVE:"_remove"},move:{TYPE_INNER:"inner",TYPE_PREV:"prev",TYPE_NEXT:"next"},node:{CURSELECTED_EDIT:"curSelectedNode_Edit",TMPTARGET_TREE:"tmpTargetzTree",TMPTARGET_NODE:"tmpTargetNode"}});m.extend(!0,m.fn.zTree._z,p);var p=m.fn.zTree,h=p._z.tools,d=p.consts,
f=p._z.view,o=p._z.data,p=p._z.event;o.exSetting({edit:{enable:!1,editNameSelectAll:!1,showRemoveBtn:!0,showRenameBtn:!0,removeTitle:"remove",renameTitle:"rename",drag:{autoExpandTrigger:!1,isCopy:!0,isMove:!0,prev:!0,next:!0,inner:!0,minMoveSize:5,borderMax:10,borderMin:-5,maxShowNodeNum:5,autoOpenTime:500}},view:{addHoverDom:null,removeHoverDom:null},callback:{beforeDrag:null,beforeDragOpen:null,beforeDrop:null,beforeEditName:null,beforeRemove:null,beforeRename:null,onDrag:null,onDrop:null,onRemove:null,
onRename:null}});o.addInitBind(function(b){var a=b.treeObj,c=d.event;a.unbind(c.RENAME);a.bind(c.RENAME,function(a,c,d){h.apply(b.callback.onRename,[a,c,d])});a.unbind(c.REMOVE);a.bind(c.REMOVE,function(a,c,d){h.apply(b.callback.onRemove,[a,c,d])});a.unbind(c.DRAG);a.bind(c.DRAG,function(a,c,d){h.apply(b.callback.onDrag,[a,c,d])});a.unbind(c.DROP);a.bind(c.DROP,function(a,c,d,f,g){h.apply(b.callback.onDrop,[a,c,d,f,g])})});o.addInitCache(function(){});o.addInitNode(function(b,a,c){if(c)c.isHover=
!1,c.editNameFlag=!1});o.addInitProxy(function(b){var a=b.target,c=o.getSetting(b.data.treeId),f=b.relatedTarget,e="",k=null,i="",g=null,m=null;if(h.eqs(b.type,"mouseover")){if(m=h.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+d.id.A}]))e=m.parentNode.id,i="hoverOverNode"}else if(h.eqs(b.type,"mouseout"))m=h.getMDom(c,f,[{tagName:"a",attrName:"treeNode"+d.id.A}]),m||(e="remove",i="hoverOutNode");else if(h.eqs(b.type,"mousedown")&&(m=h.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+d.id.A}])))e=m.parentNode.id,
i="mousedownNode";if(e.length>0)switch(k=o.getNodeCache(c,e),i){case "mousedownNode":g=C.onMousedownNode;break;case "hoverOverNode":g=C.onHoverOverNode;break;case "hoverOutNode":g=C.onHoverOutNode}return{stop:!1,node:k,nodeEventType:i,nodeEventCallback:g,treeEventType:"",treeEventCallback:null}});o.addInitRoot(function(b){b=o.getRoot(b);b.curEditNode=null;b.curEditInput=null;b.curHoverNode=null;b.dragFlag=0;b.dragNodeShowBefore=[];b.dragMaskList=[];b.showHoverDom=!0});o.addZTreeTools(function(b,a){a.addNodes=
function(a,d,e){function k(){f.addNodes(b,a,i,e==!0)}if(!d)return null;a||(a=null);if(a&&!a.isParent&&b.data.keep.leaf)return null;var i=h.clone(h.isArray(d)?d:[d]);b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,e,k):k();return i};a.cancelEditName=function(a){var d=o.getRoot(b),e=b.data.key.name,h=d.curEditNode;d.curEditNode&&f.cancelCurEditNode(b,a?a:h[e])};a.copyNode=function(a,l,e,k){if(!l)return null;if(a&&!a.isParent&&b.data.keep.leaf&&e===d.move.TYPE_INNER)return null;var i=h.clone(l);if(!a)a=
null,e=d.move.TYPE_INNER;e==d.move.TYPE_INNER?(l=function(){f.addNodes(b,a,[i],k)},b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,k,l):l()):(f.addNodes(b,a.parentNode,[i],k),f.moveNode(b,a,i,e,!1,k));return i};a.editName=function(a){a&&a.tId&&a===o.getNodeCache(b,a.tId)&&(a.parentTId&&f.expandCollapseParentNode(b,a.getParentNode(),!0),f.editNode(b,a))};a.moveNode=function(a,l,e,k){function i(){f.moveNode(b,a,l,e,!1,k)}if(!l)return l;if(a&&!a.isParent&&b.data.keep.leaf&&e===d.move.TYPE_INNER)return null;
else if(a&&(l.parentTId==a.tId&&e==d.move.TYPE_INNER||m("#"+l.tId).find("#"+a.tId).length>0))return null;else a||(a=null);b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,k,i):i();return l};a.removeNode=function(a,l){a&&(l=!!l,l&&h.apply(b.callback.beforeRemove,[b.treeId,a],!0)==!1||(f.removeNode(b,a),l&&this.setting.treeObj.trigger(d.event.REMOVE,[b.treeId,a])))};a.removeChildNodes=function(a){if(!a)return null;var d=a[b.data.key.children];f.removeChildNodes(b,a);return d?d:null};a.setEditable=function(a){b.edit.enable=
a;return this.refresh()}});var H=f.cancelPreSelectedNode;f.cancelPreSelectedNode=function(b,a){for(var c=o.getRoot(b).curSelectedList,d=0,e=c.length;d<e;d++)if(!a||a===c[d])if(f.removeTreeDom(b,c[d]),a)break;H&&H.apply(f,arguments)};var I=f.createNodes;f.createNodes=function(b,a,c,d){I&&I.apply(f,arguments);c&&f.repairParentChkClassWithSelf&&f.repairParentChkClassWithSelf(b,d)};f.makeNodeUrl=function(b,a){return a.url&&!b.edit.enable?a.url:null};var F=f.selectNode;f.selectNode=function(b,a,c){var d=
