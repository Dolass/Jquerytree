...
a.bind(c.CLICK,function(a,c,g,k,e){j.apply(b.callback.onClick,[c,g,k,e])});a.unbind(c.EXPAND);a.bind(c.EXPAND,function(a,c,g){j.apply(b.callback.onExpand,[a,c,g])});a.unbind(c.COLLAPSE);a.bind(c.COLLAPSE,function(a,c,g){j.apply(b.callback.onCollapse,[a,c,g])});a.unbind(c.ASYNC_SUCCESS);a.bind(c.ASYNC_SUCCESS,function(a,c,g,k){j.apply(b.callback.onAsyncSuccess,[a,c,g,k])});a.unbind(c.ASYNC_ERROR);a.bind(c.ASYNC_ERROR,function(a,c,g,k,e,h){j.apply(b.callback.onAsyncError,[a,c,g,k,e,h])})}],s=[function(b){var a=
i.getCache(b);a||(a={},i.setCache(b,a));a.nodes=[];a.doms=[]}],t=[function(b,a,c,d,f,g){if(c){var k=b.data.key.children;c.level=a;c.tId=b.treeId+"_"+ ++K;c.parentTId=d?d.tId:null;if(c[k]&&c[k].length>0){if(typeof c.open=="string")c.open=j.eqs(c.open,"true");c.open=!!c.open;c.isParent=!0;c.zAsync=!0}else{c.open=!1;if(typeof c.isParent=="string")c.isParent=j.eqs(c.isParent,"true");c.isParent=!!c.isParent;c.zAsync=!c.isParent}c.isFirstNode=f;c.isLastNode=g;c.getParentNode=function(){return i.getNodeCache(b,
c.parentTId)};c.getPreNode=function(){return i.getPreNode(b,c)};c.getNextNode=function(){return i.getNextNode(b,c)};c.isAjaxing=!1;i.fixPIdKeyValue(b,c)}}],u=[function(b){var a=b.target,c=p[b.data.treeId],d="",f=null,g="",k="",h=null,n=null,l=null;if(j.eqs(b.type,"mousedown"))k="mousedown";else if(j.eqs(b.type,"mouseup"))k="mouseup";else if(j.eqs(b.type,"contextmenu"))k="contextmenu";else if(j.eqs(b.type,"click"))if(j.eqs(a.tagName,"span")&&a.getAttribute("treeNode"+e.id.SWITCH)!==null)d=a.parentNode.id,
g="switchNode";else{if(l=j.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+e.id.A}]))d=l.parentNode.id,g="clickNode"}else if(j.eqs(b.type,"dblclick")&&(k="dblclick",l=j.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+e.id.A}])))d=l.parentNode.id,g="switchNode";if(k.length>0&&d.length==0&&(l=j.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+e.id.A}])))d=l.parentNode.id;if(d.length>0)switch(f=i.getNodeCache(c,d),g){case "switchNode":f.isParent?j.eqs(b.type,"click")||j.eqs(b.type,"dblclick")&&j.apply(c.view.dblClickExpand,
[c.treeId,f],c.view.dblClickExpand)?h=B:g="":g="";break;case "clickNode":h=C}switch(k){case "mousedown":n=D;break;case "mouseup":n=E;break;case "dblclick":n=F;break;case "contextmenu":n=G}return{stop:!1,node:f,nodeEventType:g,nodeEventCallback:h,treeEventType:k,treeEventCallback:n}}],v=[function(b){var a=i.getRoot(b);a||(a={},i.setRoot(b,a));a[b.data.key.children]=[];a.expandTriggerFlag=!1;a.curSelectedList=[];a.noSelection=!0;a.createdNodes=[]}],w=[],x=[],y=[],z=[],A=[],i={addNodeCache:function(b,
...
1]);a.isParent=!0;a[d]=a[d].concat(c)},addSelectedNode:function(b,a){var c=i.getRoot(b);i.isSelectedNode(b,a)||c.curSelectedList.push(a)},addCreatedNode:function(b,a){(b.callback.onNodeCreated||b.view.addDiyDom)&&i.getRoot(b).createdNodes.push(a)},addZTreeTools:function(b){A.push(b)},exSetting:function(b){l.extend(!0,I,b)},fixPIdKeyValue:function(b,a){b.data.simpleData.enable&&(a[b.data.simpleData.pIdKey]=a.parentTId?a.getParentNode()[b.data.simpleData.idKey]:b.data.simpleData.rootPId)},getAfterA:function(b,
a,c){for(var d=0,f=x.length;d<f;d++)x[d].apply(this,arguments)},getBeforeA:function(b,a,c){for(var d=0,f=w.length;d<f;d++)w[d].apply(this,arguments)},getInnerAfterA:function(b,a,c){for(var d=0,f=z.length;d<f;d++)z[d].apply(this,arguments)},getInnerBeforeA:function(b,a,c){for(var d=0,f=y.length;d<f;d++)y[d].apply(this,arguments)},getCache:function(b){return q[b.treeId]},getNextNode:function(b,a){if(!a)return null;var c=b.data.key.children,d=a.parentTId?a.getParentNode():i.getRoot(b);if(!a.isLastNode)if(a.isFirstNode)return d[c][1];
else for(var f=1,g=d[c].length-1;f<g;f++)if(d[c][f]===a)return d[c][f+1];return null},getNodeByParam:function(b,a,c,d){if(!a||!c)return null;for(var f=b.data.key.children,g=0,k=a.length;g<k;g++){if(a[g][c]==d)return a[g];var e=i.getNodeByParam(b,a[g][f],c,d);if(e)return e}return null},getNodeCache:function(b,a){if(!a)return null;var c=q[b.treeId].nodes[a];return c?c:null},getNodes:function(b){return i.getRoot(b)[b.data.key.children]},getNodesByParam:function(b,a,c,d){if(!a||!c)return[];for(var f=
b.data.key.children,g=[],k=0,e=a.length;k<e;k++)a[k][c]==d&&g.push(a[k]),g=g.concat(i.getNodesByParam(b,a[k][f],c,d));return g},getNodesByParamFuzzy:function(b,a,c,d){if(!a||!c)return[];for(var f=b.data.key.children,g=[],k=0,e=a.length;k<e;k++)typeof a[k][c]=="string"&&a[k][c].indexOf(d)>-1&&g.push(a[k]),g=g.concat(i.getNodesByParamFuzzy(b,a[k][f],c,d));return g},getNodesByFilter:function(b,a,c,d){if(!a)return d?null:[];for(var f=b.data.key.children,g=d?null:[],k=0,e=a.length;k<e;k++){if(j.apply(c,
[a[k]],!1)){if(d)return a[k];g.push(a[k])}var h=i.getNodesByFilter(b,a[k][f],c,d);if(d&&h)return h;g=d?h:g.concat(h)}return g},getPreNode:function(b,a){if(!a)return null;var c=b.data.key.children,d=a.parentTId?a.getParentNode():i.getRoot(b);if(!a.isFirstNode)if(a.isLastNode)return d[c][d[c].length-2];else for(var f=1,g=d[c].length-1;f<g;f++)if(d[c][f]===a)return d[c][f-1];return null},getRoot:function(b){return b?H[b.treeId]:null},getSetting:function(b){return p[b]},getSettings:function(){return p},
getTitleKey:function(b){return b.data.key.title===""?b.data.key.name:b.data.key.title},getZTreeTools:function(b){return(b=this.getRoot(this.getSetting(b)))?b.treeTools:null},initCache:function(b){for(var a=0,c=s.length;a<c;a++)s[a].apply(this,arguments)},initNode:function(b,a,c,d,f,g){for(var k=0,e=t.length;k<e;k++)t[k].apply(this,arguments)},initRoot:function(b){for(var a=0,c=v.length;a<c;a++)v[a].apply(this,arguments)},isSelectedNode:function(b,a){for(var c=i.getRoot(b),d=0,f=c.curSelectedList.length;d<
f;d++)if(a===c.curSelectedList[d])return!0;return!1},removeNodeCache:function(b,a){var c=b.data.key.children;if(a[c])for(var d=0,f=a[c].length;d<f;d++)arguments.callee(b,a[c][d]);delete i.getCache(b).nodes[a.tId]},removeSelectedNode:function(b,a){for(var c=i.getRoot(b),d=0,f=c.curSelectedList.length;d<f;d++)if(a===c.curSelectedList[d]||!i.getNodeCache(b,c.curSelectedList[d].tId))c.curSelectedList.splice(d,1),d--,f--},setCache:function(b,a){q[b.treeId]=a},setRoot:function(b,a){H[b.treeId]=a},setZTreeTools:function(b,
a){for(var c=0,d=A.length;c<d;c++)A[c].apply(this,arguments)},transformToArrayFormat:function(b,a){if(!a)return[];var c=b.data.key.children,d=[];if(j.isArray(a))for(var f=0,g=a.length;f<g;f++)d.push(a[f]),a[f][c]&&(d=d.concat(i.transformToArrayFormat(b,a[f][c])));else d.push(a),a[c]&&(d=d.concat(i.transformToArrayFormat(b,a[c])));return d},transformTozTreeFormat:function(b,a){var c,d,f=b.data.simpleData.idKey,g=b.data.simpleData.pIdKey,k=b.data.key.children;if(!f||f==""||!a)return[];if(j.isArray(a)){var e=
[],h=[];for(c=0,d=a.length;c<d;c++)h[a[c][f]]=a[c];for(c=0,d=a.length;c<d;c++)h[a[c][g]]&&a[c][f]!=a[c][g]?(h[a[c][g]][k]||(h[a[c][g]][k]=[]),h[a[c][g]][k].push(a[c])):e.push(a[c]);return e}else return[a]}},m={bindEvent:function(b){for(var a=0,c=r.length;a<c;a++)r[a].apply(this,arguments)},bindTree:function(b){var a={treeId:b.treeId},b=b.treeObj;b.unbind("click",m.proxy);b.bind("click",a,m.proxy);b.unbind("dblclick",m.proxy);b.bind("dblclick",a,m.proxy);b.unbind("mouseover",m.proxy);b.bind("mouseover",
a,m.proxy);b.unbind("mouseout",m.proxy);b.bind("mouseout",a,m.proxy);b.unbind("mousedown",m.proxy);b.bind("mousedown",a,m.proxy);b.unbind("mouseup",m.proxy);b.bind("mouseup",a,m.proxy);b.unbind("contextmenu",m.proxy);b.bind("contextmenu",a,m.proxy)},doProxy:function(b){for(var a=[],c=0,d=u.length;c<d;c++){var f=u[c].apply(this,arguments);a.push(f);if(f.stop)break}return a},proxy:function(b){var a=i.getSetting(b.data.treeId);if(!j.uCanDo(a,b))return!0;for(var c=m.doProxy(b),d=!0,f=!1,g=0,k=c.length;g<
k;g++){var e=c[g];e.nodeEventCallback&&(f=!0,d=e.nodeEventCallback.apply(e,[b,e.node])&&d);e.treeEventCallback&&(f=!0,d=e.treeEventCallback.apply(e,[b,e.node])&&d)}try{f&&l("input:focus").length==0&&j.noSel(a)}catch(h){}return d}};B=function(b,a){var c=p[b.data.treeId];if(a.open){if(j.apply(c.callback.beforeCollapse,[c.treeId,a],!0)==!1)return!0}else if(j.apply(c.callback.beforeExpand,[c.treeId,a],!0)==!1)return!0;i.getRoot(c).expandTriggerFlag=!0;h.switchNode(c,a);return!0};C=function(b,a){var c=
p[b.data.treeId],d=c.view.autoCancelSelected&&b.ctrlKey&&i.isSelectedNode(c,a)?0:c.view.autoCancelSelected&&b.ctrlKey&&c.view.selectedMulti?2:1;if(j.apply(c.callback.beforeClick,[c.treeId,a,d],!0)==!1)return!0;d===0?h.cancelPreSelectedNode(c,a):h.selectNode(c,a,d===2);c.treeObj.trigger(e.event.CLICK,[b,c.treeId,a,d]);return!0};D=function(b,a){var c=p[b.data.treeId];j.apply(c.callback.beforeMouseDown,[c.treeId,a],!0)&&j.apply(c.callback.onMouseDown,[b,c.treeId,a]);return!0};E=function(b,a){var c=p[b.data.treeId];
j.apply(c.callback.beforeMouseUp,[c.treeId,a],!0)&&j.apply(c.callback.onMouseUp,[b,c.treeId,a]);return!0};F=function(b,a){var c=p[b.data.treeId];j.apply(c.callback.beforeDblClick,[c.treeId,a],!0)&&j.apply(c.callback.onDblClick,[b,c.treeId,a]);return!0};G=function(b,a){var c=p[b.data.treeId];j.apply(c.callback.beforeRightClick,[c.treeId,a],!0)&&j.apply(c.callback.onRightClick,[b,c.treeId,a]);return typeof c.callback.onRightClick!="function"};var j={apply:function(b,a,c){return typeof b=="function"?
b.apply(J,a?a:[]):c},canAsync:function(b,a){var c=b.data.key.children;return b.async.enable&&a&&a.isParent&&!(a.zAsync||a[c]&&a[c].length>0)},clone:function(b){var a;if(b instanceof Array){a=[];for(var c=b.length;c--;)a[c]=arguments.callee(b[c]);return a}else if(typeof b=="function")return b;else if(b instanceof Object){a={};for(c in b)a[c]=arguments.callee(b[c]);return a}else return b},eqs:function(b,a){return b.toLowerCase()===a.toLowerCase()},isArray:function(b){return Object.prototype.toString.apply(b)===
...
[c]),b.data.simpleData.enable&&(c=i.transformTozTreeFormat(b,c)),a){var f=l("#"+a.tId+e.id.SWITCH),g=l("#"+a.tId+e.id.ICON),k=l("#"+a.tId+e.id.UL);if(!a.open)h.replaceSwitchClass(a,f,e.folder.CLOSE),h.replaceIcoClass(a,g,e.folder.CLOSE),a.open=!1,k.css({display:"none"});i.addNodesData(b,a,c);h.createNodes(b,a.level+1,c,a);d||h.expandCollapseParentNode(b,a,!0)}else i.addNodesData(b,i.getRoot(b),c),h.createNodes(b,0,c,null)},appendNodes:function(b,a,c,d,f,g){if(!c)return[];for(var e=[],j=b.data.key.children,
l=0,m=c.length;l<m;l++){var o=c[l];if(f){var p=(d?d:i.getRoot(b))[j].length==c.length&&l==0;i.initNode(b,a,o,d,p,l==c.length-1,g);i.addNodeCache(b,o)}p=[];o[j]&&o[j].length>0&&(p=h.appendNodes(b,a+1,o[j],o,f,g&&o.open));g&&(h.makeDOMNodeMainBefore(e,b,o),h.makeDOMNodeLine(e,b,o),i.getBeforeA(b,o,e),h.makeDOMNodeNameBefore(e,b,o),i.getInnerBeforeA(b,o,e),h.makeDOMNodeIcon(e,b,o),i.getInnerAfterA(b,o,e),h.makeDOMNodeNameAfter(e,b,o),i.getAfterA(b,o,e),o.isParent&&o.open&&h.makeUlHtml(b,o,e,p.join("")),
h.makeDOMNodeMainAfter(e,b,o),i.addCreatedNode(b,o))}return e},appendParentULDom:function(b,a){var c=[],d=l("#"+a.tId),f=l("#"+a.tId+e.id.UL),g=h.appendNodes(b,a.level+1,a[b.data.key.children],a,!1,!0);h.makeUlHtml(b,a,c,g.join(""));!d.get(0)&&a.parentTId&&(h.appendParentULDom(b,a.getParentNode()),d=l("#"+a.tId));f.get(0)&&f.remove();d.append(c.join(""))},asyncNode:function(b,a,c,d){var f,g;if(a&&!a.isParent)return j.apply(d),!1;else if(a&&a.isAjaxing)return!1;else if(j.apply(b.callback.beforeAsync,
[b.treeId,a],!0)==!1)return j.apply(d),!1;if(a)a.isAjaxing=!0,l("#"+a.tId+e.id.ICON).attr({style:"","class":"button ico_loading"});var k=b.async.contentType=="application/json",i=k?"{":"",n="";for(f=0,g=b.async.autoParam.length;a&&f<g;f++){var m=b.async.autoParam[f].split("="),o=m;m.length>1&&(o=m[1],m=m[0]);k?(n=typeof a[m]=="string"?'"':"",i+='"'+o+('":'+n+a[m]).replace(/'/g,"\\'")+n+","):i+=o+("="+a[m]).replace(/&/g,"%26")+"&"}if(j.isArray(b.async.otherParam))for(f=0,g=b.async.otherParam.length;f<
g;f+=2)k?(n=typeof b.async.otherParam[f+1]=="string"?'"':"",i+='"'+b.async.otherParam[f]+('":'+n+b.async.otherParam[f+1]).replace(/'/g,"\\'")+n+","):i+=b.async.otherParam[f]+("="+b.async.otherParam[f+1]).replace(/&/g,"%26")+"&";else for(var p in b.async.otherParam)k?(n=typeof b.async.otherParam[p]=="string"?'"':"",i+='"'+p+('":'+n+b.async.otherParam[p]).replace(/'/g,"\\'")+n+","):i+=p+("="+b.async.otherParam[p]).replace(/&/g,"%26")+"&";i.length>1&&(i=i.substring(0,i.length-1));k&&(i+="}");l.ajax({contentType:b.async.contentType,
type:b.async.type,url:j.apply(b.async.url,[b.treeId,a],b.async.url),data:i,dataType:b.async.dataType,success:function(f){var g=[];try{g=!f||f.length==0?[]:typeof f=="string"?eval("("+f+")"):f}catch(k){}if(a)a.isAjaxing=null,a.zAsync=!0;h.setNodeLineIcos(b,a);g&&g!==""?(g=j.apply(b.async.dataFilter,[b.treeId,a,g],g),h.addNodes(b,a,g?j.clone(g):[],!!c)):h.addNodes(b,a,[],!!c);b.treeObj.trigger(e.event.ASYNC_SUCCESS,[b.treeId,a,f]);j.apply(d)},error:function(c,d,f){if(a)a.isAjaxing=null;h.setNodeLineIcos(b,
...
[b.treeId,c]);b.callback.onNodeCreated&&b.treeObj.trigger(e.event.NODECREATED,[b.treeId,c])}},createNodes:function(b,a,c,d){if(c&&c.length!=0){var f=i.getRoot(b),g=b.data.key.children,g=!d||d.open||!!l("#"+d[g][0].tId).get(0);f.createdNodes=[];a=h.appendNodes(b,a,c,d,!0,g);d?(d=l("#"+d.tId+e.id.UL),d.get(0)&&d.append(a.join(""))):b.treeObj.append(a.join(""));h.createNodeCallback(b)}},expandCollapseNode:function(b,a,c,d,f){var g=i.getRoot(b),k=b.data.key.children;if(a){if(g.expandTriggerFlag){var m=
f,f=function(){m&&m();a.open?b.treeObj.trigger(e.event.EXPAND,[b.treeId,a]):b.treeObj.trigger(e.event.COLLAPSE,[b.treeId,a])};g.expandTriggerFlag=!1}if(a.open==c)j.apply(f,[]);else{if(!a.open&&a.isParent&&(!l("#"+a.tId+e.id.UL).get(0)||a[k]&&a[k].length>0&&!l("#"+a[k][0].tId).get(0)))h.appendParentULDom(b,a),h.createNodeCallback(b);var c=l("#"+a.tId+e.id.UL),g=l("#"+a.tId+e.id.SWITCH),n=l("#"+a.tId+e.id.ICON);a.isParent?(a.open=!a.open,a.iconOpen&&a.iconClose&&n.attr("style",h.makeNodeIcoStyle(b,
a)),a.open?(h.replaceSwitchClass(a,g,e.folder.OPEN),h.replaceIcoClass(a,n,e.folder.OPEN),d==!1||b.view.expandSpeed==""?(c.show(),j.apply(f,[])):a[k]&&a[k].length>0?c.slideDown(b.view.expandSpeed,f):(c.show(),j.apply(f,[]))):(h.replaceSwitchClass(a,g,e.folder.CLOSE),h.replaceIcoClass(a,n,e.folder.CLOSE),d==!1||b.view.expandSpeed==""||!(a[k]&&a[k].length>0)?(c.hide(),j.apply(f,[])):c.slideUp(b.view.expandSpeed,f))):j.apply(f,[])}}else j.apply(f,[])},expandCollapseParentNode:function(b,a,c,d,f){a&&(a.parentTId?
(h.expandCollapseNode(b,a,c,d),a.parentTId&&h.expandCollapseParentNode(b,a.getParentNode(),c,d,f)):h.expandCollapseNode(b,a,c,d,f))},expandCollapseSonNode:function(b,a,c,d,f){var g=i.getRoot(b),e=b.data.key.children,g=a?a[e]:g[e],e=a?!1:d,j=i.getRoot(b).expandTriggerFlag;i.getRoot(b).expandTriggerFlag=!1;if(g)for(var l=0,m=g.length;l<m;l++)g[l]&&h.expandCollapseSonNode(b,g[l],c,e);i.getRoot(b).expandTriggerFlag=j;h.expandCollapseNode(b,a,c,d,f)},makeDOMNodeIcon:function(b,a,c){var d=a.data.key.name,
d=a.view.nameIsHTML?c[d]:c[d].replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");b.push("<span id='",c.tId,e.id.ICON,"' title='' treeNode",e.id.ICON," class='",h.makeNodeIcoClass(a,c),"' style='",h.makeNodeIcoStyle(a,c),"'></span><span id='",c.tId,e.id.SPAN,"'>",d,"</span>")},makeDOMNodeLine:function(b,a,c){b.push("<span id='",c.tId,e.id.SWITCH,"' title='' class='",h.makeNodeLineClass(a,c),"' treeNode",e.id.SWITCH,"></span>")},makeDOMNodeMainAfter:function(b){b.push("</li>")},makeDOMNodeMainBefore:function(b,
a,c){b.push("<li id='",c.tId,"' class='level",c.level,"' tabindex='0' hidefocus='true' treenode>")},makeDOMNodeNameAfter:function(b){b.push("</a>")},makeDOMNodeNameBefore:function(b,a,c){var d=i.getTitleKey(a),f=h.makeNodeUrl(a,c),g=h.makeNodeFontCss(a,c),k=[],l;for(l in g)k.push(l,":",g[l],";");b.push("<a id='",c.tId,e.id.A,"' class='level",c.level,"' treeNode",e.id.A,' onclick="',c.click||"",'" ',f!=null&&f.length>0?"href='"+f+"'":""," target='",h.makeNodeTarget(c),"' style='",k.join(""),"'");j.apply(a.view.showTitle,
[a.treeId,c],a.view.showTitle)&&c[d]&&b.push("title='",c[d].replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),"'");b.push(">")},makeNodeFontCss:function(b,a){var c=j.apply(b.view.fontCss,[b.treeId,a],b.view.fontCss);return c&&typeof c!="function"?c:{}},makeNodeIcoClass:function(b,a){var c=["ico"];a.isAjaxing||(c[0]=(a.iconSkin?a.iconSkin+"_":"")+c[0],a.isParent?c.push(a.open?e.folder.OPEN:e.folder.CLOSE):c.push(e.folder.DOCU));return"button "+c.join("_")},makeNodeIcoStyle:function(b,
...
a.isParent?c.push(a.open?e.folder.OPEN:e.folder.CLOSE):c.push(e.folder.DOCU);return h.makeNodeLineClassEx(a)+c.join("_")},makeNodeLineClassEx:function(b){return"button level"+b.level+" switch "},makeNodeTarget:function(b){return b.target||"_blank"},makeNodeUrl:function(b,a){var c=b.data.key.url;return a[c]?a[c]:null},makeUlHtml:function(b,a,c,d){c.push("<ul id='",a.tId,e.id.UL,"' class='level",a.level," ",h.makeUlLineClass(b,a),"' style='display:",a.open?"block":"none","'>");c.push(d);c.push("</ul>")},
makeUlLineClass:function(b,a){return b.view.showLine&&!a.isLastNode?e.line.LINE:""},removeChildNodes:function(b,a){if(a){var c=b.data.key.children,d=a[c];if(d){for(var f=0,g=d.length;f<g;f++)i.removeNodeCache(b,d[f]);i.removeSelectedNode(b);delete a[c];b.data.keep.parent?l("#"+a.tId+e.id.UL).empty():(a.isParent=!1,a.open=!1,c=l("#"+a.tId+e.id.SWITCH),d=l("#"+a.tId+e.id.ICON),h.replaceSwitchClass(a,c,e.folder.DOCU),h.replaceIcoClass(a,d,e.folder.DOCU),l("#"+a.tId+e.id.UL).remove())}}},removeNode:function(b,
a){var c=i.getRoot(b),d=b.data.key.children,f=a.parentTId?a.getParentNode():c;a.isFirstNode=!1;a.isLastNode=!1;a.getPreNode=function(){return null};a.getNextNode=function(){return null};l("#"+a.tId).remove();i.removeNodeCache(b,a);i.removeSelectedNode(b,a);for(var g=0,k=f[d].length;g<k;g++)if(f[d][g].tId==a.tId){f[d].splice(g,1);break}var j;if(!b.data.keep.parent&&f[d].length<1)f.isParent=!1,f.open=!1,g=l("#"+f.tId+e.id.UL),k=l("#"+f.tId+e.id.SWITCH),j=l("#"+f.tId+e.id.ICON),h.replaceSwitchClass(f,
k,e.folder.DOCU),h.replaceIcoClass(f,j,e.folder.DOCU),g.css("display","none");else if(b.view.showLine&&f[d].length>0){var n=f[d][f[d].length-1];n.isLastNode=!0;n.isFirstNode=f[d].length==1;g=l("#"+n.tId+e.id.UL);k=l("#"+n.tId+e.id.SWITCH);j=l("#"+n.tId+e.id.ICON);f==c?f[d].length==1?h.replaceSwitchClass(n,k,e.line.ROOT):(c=l("#"+f[d][0].tId+e.id.SWITCH),h.replaceSwitchClass(f[d][0],c,e.line.ROOTS),h.replaceSwitchClass(n,k,e.line.BOTTOM)):h.replaceSwitchClass(n,k,e.line.BOTTOM);g.removeClass(e.line.LINE)}},
...
c}a.attr("class",d.join("_"));c!==e.folder.DOCU?a.removeAttr("disabled"):a.attr("disabled","disabled")}}},selectNode:function(b,a,c){c||h.cancelPreSelectedNode(b);l("#"+a.tId+e.id.A).addClass(e.node.CURSELECTED);i.addSelectedNode(b,a)},setNodeFontCss:function(b,a){var c=l("#"+a.tId+e.id.A),d=h.makeNodeFontCss(b,a);d&&c.css(d)},setNodeLineIcos:function(b,a){if(a){var c=l("#"+a.tId+e.id.SWITCH),d=l("#"+a.tId+e.id.UL),f=l("#"+a.tId+e.id.ICON),g=h.makeUlLineClass(b,a);g.length==0?d.removeClass(e.line.LINE):
d.addClass(g);c.attr("class",h.makeNodeLineClass(b,a));a.isParent?c.removeAttr("disabled"):c.attr("disabled","disabled");f.removeAttr("style");f.attr("style",h.makeNodeIcoStyle(b,a));f.attr("class",h.makeNodeIcoClass(b,a))}},setNodeName:function(b,a){var c=b.data.key.name,d=i.getTitleKey(b),f=l("#"+a.tId+e.id.SPAN);f.empty();b.view.nameIsHTML?f.html(a[c]):f.text(a[c]);j.apply(b.view.showTitle,[b.treeId,a],b.view.showTitle)&&a[d]&&l("#"+a.tId+e.id.A).attr("title",a[d])},setNodeTarget:function(b){l("#"+
b.tId+e.id.A).attr("target",h.makeNodeTarget(b))},setNodeUrl:function(b,a){var c=l("#"+a.tId+e.id.A),d=h.makeNodeUrl(b,a);d==null||d.length==0?c.removeAttr("href"):c.attr("href",d)},switchNode:function(b,a){a.open||!j.canAsync(b,a)?h.expandCollapseNode(b,a,!a.open):b.async.enable?h.asyncNode(b,a)||h.expandCollapseNode(b,a,!a.open):a&&h.expandCollapseNode(b,a,!a.open)}};l.fn.zTree={consts:{event:{NODECREATED:"ztree_nodeCreated",CLICK:"ztree_click",EXPAND:"ztree_expand",COLLAPSE:"ztree_collapse",ASYNC_SUCCESS:"ztree_async_success",
ASYNC_ERROR:"ztree_async_error"},id:{A:"_a",ICON:"_ico",SPAN:"_span",SWITCH:"_switch",UL:"_ul"},line:{ROOT:"root",ROOTS:"roots",CENTER:"center",BOTTOM:"bottom",NOLINE:"noline",LINE:"line"},folder:{OPEN:"open",CLOSE:"close",DOCU:"docu"},node:{CURSELECTED:"curSelectedNode"}},_z:{tools:j,view:h,event:m,data:i},getZTreeObj:function(b){return(b=i.getZTreeTools(b))?b:null},init:function(b,a,c){var d=j.clone(I);l.extend(!0,d,a);d.treeId=b.attr("id");d.treeObj=b;d.treeObj.empty();p[d.treeId]=d;if(l.browser.msie&&
parseInt(l.browser.version)<7)d.view.expandSpeed="";i.initRoot(d);b=i.getRoot(d);a=d.data.key.children;c=c?j.clone(j.isArray(c)?c:[c]):[];b[a]=d.data.simpleData.enable?i.transformTozTreeFormat(d,c):c;i.initCache(d);m.bindTree(d);m.bindEvent(d);c={setting:d,addNodes:function(a,b,c){function e(){h.addNodes(d,a,i,c==!0)}if(!b)return null;a||(a=null);if(a&&!a.isParent&&d.data.keep.leaf)return null;var i=j.clone(j.isArray(b)?b:[b]);j.canAsync(d,a)?h.asyncNode(d,a,c,e):e();return i},cancelSelectedNode:function(a){h.cancelPreSelectedNode(this.setting,
a)},expandAll:function(a){a=!!a;h.expandCollapseSonNode(this.setting,null,a,!0);return a},expandNode:function(a,b,c,e,n){if(!a||!a.isParent)return null;b!==!0&&b!==!1&&(b=!a.open);if((n=!!n)&&b&&j.apply(d.callback.beforeExpand,[d.treeId,a],!0)==!1)return null;else if(n&&!b&&j.apply(d.callback.beforeCollapse,[d.treeId,a],!0)==!1)return null;b&&a.parentTId&&h.expandCollapseParentNode(this.setting,a.getParentNode(),b,!1);if(b===a.open&&!c)return null;i.getRoot(d).expandTriggerFlag=n;c?h.expandCollapseSonNode(this.setting,
a,b,!0,function(){e!==!1&&l("#"+a.tId).focus().blur()}):(a.open=!b,h.switchNode(this.setting,a),e!==!1&&l("#"+a.tId).focus().blur());return b},getNodes:function(){return i.getNodes(this.setting)},getNodeByParam:function(a,b,c){return!a?null:i.getNodeByParam(this.setting,c?c[this.setting.data.key.children]:i.getNodes(this.setting),a,b)},getNodeByTId:function(a){return i.getNodeCache(this.setting,a)},getNodesByParam:function(a,b,c){return!a?null:i.getNodesByParam(this.setting,c?c[this.setting.data.key.children]:
i.getNodes(this.setting),a,b)},getNodesByParamFuzzy:function(a,b,c){return!a?null:i.getNodesByParamFuzzy(this.setting,c?c[this.setting.data.key.children]:i.getNodes(this.setting),a,b)},getNodesByFilter:function(a,b,c){b=!!b;return!a||typeof a!="function"?b?null:[]:i.getNodesByFilter(this.setting,c?c[this.setting.data.key.children]:i.getNodes(this.setting),a,b)},getNodeIndex:function(a){if(!a)return null;for(var b=d.data.key.children,c=a.parentTId?a.getParentNode():i.getRoot(this.setting),e=0,h=c[b].length;e<
h;e++)if(c[b][e]==a)return e;return-1},getSelectedNodes:function(){for(var a=[],b=i.getRoot(this.setting).curSelectedList,c=0,d=b.length;c<d;c++)a.push(b[c]);return a},isSelectedNode:function(a){return i.isSelectedNode(this.setting,a)},reAsyncChildNodes:function(a,b,c){if(this.setting.async.enable){var d=!a;d&&(a=i.getRoot(this.setting));b=="refresh"&&(a[this.setting.data.key.children]=[],d?this.setting.treeObj.empty():l("#"+a.tId+e.id.UL).empty());h.asyncNode(this.setting,d?null:a,!!c)}},refresh:function(){this.setting.treeObj.empty();
var a=i.getRoot(this.setting),b=a[this.setting.data.key.children];i.initRoot(this.setting);a[this.setting.data.key.children]=b;i.initCache(this.setting);h.createNodes(this.setting,0,a[this.setting.data.key.children])},removeChildNodes:function(a){if(!a)return null;var b=a[d.data.key.children];h.removeChildNodes(d,a);return b?b:null},removeNode:function(a,b){a&&(b=!!b,b&&j.apply(d.callback.beforeRemove,[d.treeId,a],!0)==!1||(h.removeNode(d,a),b&&this.setting.treeObj.trigger(e.event.REMOVE,[d.treeId,
a])))},selectNode:function(a,b){a&&j.uCanDo(this.setting)&&(b=d.view.selectedMulti&&b,a.parentTId?h.expandCollapseParentNode(this.setting,a.getParentNode(),!0,!1,function(){l("#"+a.tId).focus().blur()}):l("#"+a.tId).focus().blur(),h.selectNode(this.setting,a,b))},transformTozTreeNodes:function(a){return i.transformTozTreeFormat(this.setting,a)},transformToArray:function(a){return i.transformToArrayFormat(this.setting,a)},updateNode:function(a){a&&l("#"+a.tId).get(0)&&j.uCanDo(this.setting)&&(h.setNodeName(this.setting,
a),h.setNodeTarget(a),h.setNodeUrl(this.setting,a),h.setNodeLineIcos(this.setting,a),h.setNodeFontCss(this.setting,a))}};b.treeTools=c;i.setZTreeTools(d,c);b[a]&&b[a].length>0?h.createNodes(d,0,b[a]):d.async.enable&&d.async.url&&d.async.url!==""&&h.asyncNode(d);return c}};var J=l.fn.zTree,e=J.consts})(jQuery);
...
a){if(p.getRoot(b).showHoverDom)a.isHover=!0,b.edit.enable&&(f.addEditBtn(b,a),f.addRemoveBtn(b,a)),h.apply(b.view.addHoverDom,[b.treeId,a])},cancelCurEditNode:function(b,a){var c=p.getRoot(b),q=b.data.key.name,e=c.curEditNode;if(e){var l=c.curEditInput,j=a?a:l.val();if(!a&&h.apply(b.callback.beforeRename,[b.treeId,e,j],!0)===!1)return e.editNameFlag=!0,!1;else e[q]=j?j:l.val(),a||b.treeObj.trigger(d.event.RENAME,[b.treeId,e]);k("#"+e.tId+d.id.A).removeClass(d.node.CURSELECTED_EDIT);l.unbind();f.setNodeName(b,
...
var e=k("#"+a.tId+d.id.INPUT);e.attr("value",a[q]);b.edit.editNameSelectAll?h.inputSelect(e):h.inputFocus(e);e.bind("blur",function(){f.editNodeBlur||f.cancelCurEditNode(b)}).bind("keydown",function(c){c.keyCode=="13"?(f.editNodeBlur=!0,f.cancelCurEditNode(b,null,!0)):c.keyCode=="27"&&f.cancelCurEditNode(b,a[q])}).bind("click",function(){return!1}).bind("dblclick",function(){return!1});k("#"+a.tId+d.id.A).addClass(d.node.CURSELECTED_EDIT);c.curEditInput=e;c.noSelection=!1;c.curEditNode=a}},moveNode:function(b,
a,c,q,e,l){var j=p.getRoot(b),g=b.data.key.children;if(a!=c&&(!b.data.keep.leaf||!a||a.isParent||q!=d.move.TYPE_INNER)){var h=c.parentTId?c.getParentNode():j,o=a===null||a==j;o&&a===null&&(a=j);if(o)q=d.move.TYPE_INNER;j=a.parentTId?a.getParentNode():j;if(q!=d.move.TYPE_PREV&&q!=d.move.TYPE_NEXT)q=d.move.TYPE_INNER;if(q==d.move.TYPE_INNER)if(o)c.parentTId=null;else{if(!a.isParent)a.isParent=!0,a.open=!!a.open,f.setNodeLineIcos(b,a);c.parentTId=a.tId}var n;o?n=o=b.treeObj:(!l&&q==d.move.TYPE_INNER?
f.expandCollapseNode(b,a,!0,!1):l||f.expandCollapseNode(b,a.getParentNode(),!0,!1),o=k("#"+a.tId),n=k("#"+a.tId+d.id.UL),o.get(0)&&!n.get(0)&&(n=[],f.makeUlHtml(b,a,n,""),o.append(n.join(""))),n=k("#"+a.tId+d.id.UL));var m=k("#"+c.tId);m.get(0)?o.get(0)||m.remove():m=f.appendNodes(b,c.level,[c],null,!1,!0).join("");n.get(0)&&q==d.move.TYPE_INNER?n.append(m):o.get(0)&&q==d.move.TYPE_PREV?o.before(m):o.get(0)&&q==d.move.TYPE_NEXT&&o.after(m);var x=-1,y=0,t=null,o=null,r=c.level;if(c.isFirstNode){if(x=
0,h[g].length>1)t=h[g][1],t.isFirstNode=!0}else if(c.isLastNode)x=h[g].length-1,t=h[g][x-1],t.isLastNode=!0;else for(n=0,m=h[g].length;n<m;n++)if(h[g][n].tId==c.tId){x=n;break}x>=0&&h[g].splice(x,1);if(q!=d.move.TYPE_INNER)for(n=0,m=j[g].length;n<m;n++)j[g][n].tId==a.tId&&(y=n);if(q==d.move.TYPE_INNER){a[g]||(a[g]=[]);if(a[g].length>0)o=a[g][a[g].length-1],o.isLastNode=!1;a[g].splice(a[g].length,0,c);c.isLastNode=!0;c.isFirstNode=a[g].length==1}else a.isFirstNode&&q==d.move.TYPE_PREV?(j[g].splice(y,
0,c),o=a,o.isFirstNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!0,c.isLastNode=!1):a.isLastNode&&q==d.move.TYPE_NEXT?(j[g].splice(y+1,0,c),o=a,o.isLastNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!0):(q==d.move.TYPE_PREV?j[g].splice(y,0,c):j[g].splice(y+1,0,c),c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!1);p.fixPIdKeyValue(b,c);p.setSonNodeLevel(b,c.getParentNode(),c);f.setNodeLineIcos(b,c);f.repairNodeLevelClass(b,c,r);!b.data.keep.parent&&h[g].length<1?(h.isParent=!1,
h.open=!1,a=k("#"+h.tId+d.id.UL),q=k("#"+h.tId+d.id.SWITCH),g=k("#"+h.tId+d.id.ICON),f.replaceSwitchClass(h,q,d.folder.DOCU),f.replaceIcoClass(h,g,d.folder.DOCU),a.css("display","none")):t&&f.setNodeLineIcos(b,t);o&&f.setNodeLineIcos(b,o);b.check&&b.check.enable&&f.repairChkClass&&(f.repairChkClass(b,h),f.repairParentChkClassWithSelf(b,h),h!=c.parent&&f.repairParentChkClassWithSelf(b,c));l||f.expandCollapseParentNode(b,c.getParentNode(),!0,e)}},removeEditBtn:function(b){k("#"+b.tId+d.id.EDIT).unbind().remove()},
removeRemoveBtn:function(b){k("#"+b.tId+d.id.REMOVE).unbind().remove()},removeTreeDom:function(b,a){a.isHover=!1;f.removeEditBtn(a);f.removeRemoveBtn(a);h.apply(b.view.removeHoverDom,[b.treeId,a])},repairNodeLevelClass:function(b,a,c){if(c!==a.level){var b=k("#"+a.tId),f=k("#"+a.tId+d.id.A),e=k("#"+a.tId+d.id.UL),c="level"+c,a="level"+a.level;b.removeClass(c);b.addClass(a);f.removeClass(c);f.addClass(a);e.removeClass(c);e.addClass(a)}}},event:{},data:{setSonNodeLevel:function(b,a,c){if(c){var d=b.data.key.children;
c.level=a?a.level+1:0;if(c[d])for(var a=0,e=c[d].length;a<e;a++)c[d][a]&&p.setSonNodeLevel(b,c,c[d][a])}}}});var E=k.fn.zTree,h=E._z.tools,d=E.consts,f=E._z.view,p=E._z.data;p.exSetting({edit:{enable:!1,editNameSelectAll:!1,showRemoveBtn:!0,showRenameBtn:!0,removeTitle:"remove",renameTitle:"rename",drag:{autoExpandTrigger:!1,isCopy:!0,isMove:!0,prev:!0,next:!0,inner:!0,minMoveSize:5,borderMax:10,borderMin:-5,maxShowNodeNum:5,autoOpenTime:500}},view:{addHoverDom:null,removeHoverDom:null},callback:{beforeDrag:null,
beforeDragOpen:null,beforeDrop:null,beforeEditName:null,beforeRename:null,onDrag:null,onDrop:null,onRename:null}});p.addInitBind(function(b){var a=b.treeObj,c=d.event;a.unbind(c.RENAME);a.bind(c.RENAME,function(a,c,d){h.apply(b.callback.onRename,[a,c,d])});a.unbind(c.REMOVE);a.bind(c.REMOVE,function(a,c,d){h.apply(b.callback.onRemove,[a,c,d])});a.unbind(c.DRAG);a.bind(c.DRAG,function(a,c,d,f){h.apply(b.callback.onDrag,[c,d,f])});a.unbind(c.DROP);a.bind(c.DROP,function(a,c,d,f,g,k,o){h.apply(b.callback.onDrop,
[c,d,f,g,k,o])})});p.addInitCache(function(){});p.addInitNode(function(b,a,c){if(c)c.isHover=!1,c.editNameFlag=!1});p.addInitProxy(function(b){var a=b.target,c=p.getSetting(b.data.treeId),f=b.relatedTarget,e="",l=null,j="",g=null,k=null;if(h.eqs(b.type,"mouseover")){if(k=h.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+d.id.A}]))e=k.parentNode.id,j="hoverOverNode"}else if(h.eqs(b.type,"mouseout"))k=h.getMDom(c,f,[{tagName:"a",attrName:"treeNode"+d.id.A}]),k||(e="remove",j="hoverOutNode");else if(h.eqs(b.type,
