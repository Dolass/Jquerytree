...
i.makeNodeIcoStyle(b,a)),a.open?(i.replaceSwitchClass(a,h,f.folder.OPEN),i.replaceIcoClass(a,o,f.folder.OPEN),d==!1||b.view.expandSpeed==""?(c.show(),k.apply(e,[])):a[j]&&a[j].length>0?c.slideDown(b.view.expandSpeed,e):(c.show(),k.apply(e,[]))):(i.replaceSwitchClass(a,h,f.folder.CLOSE),i.replaceIcoClass(a,o,f.folder.CLOSE),d==!1||b.view.expandSpeed==""||!(a[j]&&a[j].length>0)?(c.hide(),k.apply(e,[])):c.slideUp(b.view.expandSpeed,e))):k.apply(e,[])}}else k.apply(e,[])},expandCollapseParentNode:function(b,
a,c,d,e){a&&(a.parentTId?(i.expandCollapseNode(b,a,c,d),a.parentTId&&i.expandCollapseParentNode(b,a.getParentNode(),c,d,e)):i.expandCollapseNode(b,a,c,d,e))},expandCollapseSonNode:function(b,a,c,d,e){var h=g.getRoot(b),f=b.data.key.children,h=a?a[f]:h[f],f=a?!1:d,k=g.getRoot(b).expandTriggerFlag;g.getRoot(b).expandTriggerFlag=!1;if(h)for(var l=0,m=h.length;l<m;l++)h[l]&&i.expandCollapseSonNode(b,h[l],c,f);g.getRoot(b).expandTriggerFlag=k;i.expandCollapseNode(b,a,c,d,e)},makeNodeFontCss:function(b,
a){var c=k.apply(b.view.fontCss,[b.treeId,a],b.view.fontCss);return c&&typeof c!="function"?c:{}},makeNodeIcoClass:function(b,a){var c=["ico"];a.isAjaxing||(c[0]=(a.iconSkin?a.iconSkin+"_":"")+c[0],a.isParent?c.push(a.open?f.folder.OPEN:f.folder.CLOSE):c.push(f.folder.DOCU));return c.join("_")},makeNodeIcoStyle:function(b,a){var c=[];if(!a.isAjaxing){var d=a.isParent&&a.iconOpen&&a.iconClose?a.open?a.iconOpen:a.iconClose:a.icon;d&&c.push("background:url(",d,") 0 0 no-repeat;");(b.view.showIcon==!1||
!k.apply(b.view.showIcon,[b.treeId,a],!0))&&c.push("width:0px;height:0px;")}return c.join("")},makeNodeLineClass:function(b,a){var c=[];b.view.showLine?a.level==0&&a.isFirstNode&&a.isLastNode?c.push(f.line.ROOT):a.level==0&&a.isFirstNode?c.push(f.line.ROOTS):a.isLastNode?c.push(f.line.BOTTOM):c.push(f.line.CENTER):c.push(f.line.NOLINE);a.isParent?c.push(a.open?f.folder.OPEN:f.folder.CLOSE):c.push(f.folder.DOCU);return i.makeNodeLineClassEx(a)+c.join("_")},makeNodeLineClassEx:function(b){return"level"+
b.level+" switch "},makeNodeTarget:function(b){return b.target||"_blank"},makeNodeUrl:function(b,a){return a.url?a.url:null},makeUlHtml:function(b,a,c,d){c.push("<ul id='",a.tId,f.id.UL,"' class='level",a.level," ",i.makeUlLineClass(b,a),"' style='display:",a.open?"block":"none","'>");c.push(d);c.push("</ul>")},makeUlLineClass:function(b,a){return b.view.showLine&&!a.isLastNode?f.line.LINE:""},replaceIcoClass:function(b,a,c){if(a&&!b.isAjaxing&&(b=a.attr("class"),b!=void 0)){b=b.split("_");switch(c){case f.folder.OPEN:case f.folder.CLOSE:case f.folder.DOCU:b[b.length-
...
s==o[0].parentTId&&u==d.move.TYPE_INNER&&(r=null);if(r){var p=s==null?null:n.getNodeCache(k,s);if(h.apply(g.callback.beforeDrop,[k.treeId,o,p,u,q],!0)!=!1){var w=q?h.clone(o):o;a=function(){if(v){if(!q)for(var b=0,a=o.length;b<a;b++)f.removeNode(g,o[b]);if(u==d.move.TYPE_INNER)f.addNodes(k,p,w);else if(f.addNodes(k,p.getParentNode(),w),u==d.move.TYPE_PREV)for(b=0,a=w.length;b<a;b++)f.moveNode(k,p,w[b],u,!1);else for(b=-1,a=w.length-1;b<a;a--)f.moveNode(k,p,w[a],u,!1)}else if(q&&u==d.move.TYPE_INNER)f.addNodes(k,
p,w);else if(q&&f.addNodes(k,p.getParentNode(),w),u==d.move.TYPE_PREV)for(b=0,a=w.length;b<a;b++)f.moveNode(k,p,w[b],u,!1);else for(b=-1,a=w.length-1;b<a;a--)f.moveNode(k,p,w[a],u,!1);for(b=0,a=w.length;b<a;b++)f.selectNode(k,w[b],b>0);j("#"+w[0].tId+d.id.ICON).focus().blur()};u==d.move.TYPE_INNER&&h.canAsync(k,p)?f.asyncNode(k,p,!1,a):a();g.treeObj.trigger(d.event.DROP,[b,k.treeId,w,p,u,q])}}else{for(a=0,m=o.length;a<m;a++)f.selectNode(k,o[a],a>0);g.treeObj.trigger(d.event.DROP,[b,g.treeId,null,
...
g[1]+"px; left:"+g[0]+"px; width:"+i.offsetWidth+"px; height:"+i.offsetHeight+"px;'></div>");i.appendTo("body");c.dragMaskList.push(i)}}},view:{addEditBtn:function(b,a){if(!(a.editNameFlag||j("#"+a.tId+d.id.EDIT).length>0)&&h.apply(b.edit.showRenameBtn,[b.treeId,a],b.edit.showRenameBtn)){var c=j("#"+a.tId+d.id.A),l="<button type='button' class='edit' id='"+a.tId+d.id.EDIT+"' title='"+h.apply(b.edit.renameTitle,[b.treeId,a],b.edit.renameTitle)+"' treeNode"+d.id.EDIT+" onfocus='this.blur();' style='display:none;'></button>";
c.append(l);j("#"+a.tId+d.id.EDIT).bind("click",function(){if(!h.uCanDo(b)||h.apply(b.callback.beforeEditName,[b.treeId,a],!0)==!1)return!0;f.editNode(b,a);return!1}).show()}},addRemoveBtn:function(b,a){if(!(a.editNameFlag||j("#"+a.tId+d.id.REMOVE).length>0)&&h.apply(b.edit.showRemoveBtn,[b.treeId,a],b.edit.showRemoveBtn)){var c=j("#"+a.tId+d.id.A),l="<button type='button' class='remove' id='"+a.tId+d.id.REMOVE+"' title='"+h.apply(b.edit.removeTitle,[b.treeId,a],b.edit.removeTitle)+"' treeNode"+d.id.REMOVE+
" onfocus='this.blur();' style='display:none;'></button>";c.append(l);j("#"+a.tId+d.id.REMOVE).bind("click",function(){if(!h.uCanDo(b)||h.apply(b.callback.beforeRemove,[b.treeId,a],!0)==!1)return!0;f.removeNode(b,a);b.treeObj.trigger(d.event.REMOVE,[b.treeId,a]);return!1}).bind("mousedown",function(){return!0}).show()}},addHoverDom:function(b,a){if(n.getRoot(b).showHoverDom)a.isHover=!0,b.edit.enable&&(f.addEditBtn(b,a),f.addRemoveBtn(b,a)),h.apply(b.view.addHoverDom,[b.treeId,a])},cancelCurEditNode:function(b,
a){var c=n.getRoot(b),l=b.data.key.name,e=c.curEditNode;if(e){var m=c.curEditInput,i=a?a:m.val();if(!a&&h.apply(b.callback.beforeRename,[b.treeId,e,i],!0)===!1)return e.editNameFlag=!0,!1;else e[l]=i?i:m.val(),a||b.treeObj.trigger(d.event.RENAME,[b.treeId,e]);j("#"+e.tId+d.id.A).removeClass(d.node.CURSELECTED_EDIT);m.unbind();f.setNodeName(b,e);e.editNameFlag=!1;c.curEditNode=null;c.curEditInput=null;f.selectNode(b,e,!1)}return c.noSelection=!0},editNode:function(b,a){var c=n.getRoot(b);f.editNodeBlur=
!1;if(n.isSelectedNode(b,a)&&c.curEditNode==a&&a.editNameFlag)setTimeout(function(){h.inputFocus(c.curEditInput)},0);else{var l=b.data.key.name;a.editNameFlag=!0;f.removeTreeDom(b,a);f.cancelCurEditNode(b);f.selectNode(b,a,!1);j("#"+a.tId+d.id.SPAN).html("<input type=text class='rename' id='"+a.tId+d.id.INPUT+"' treeNode"+d.id.INPUT+" >");var e=j("#"+a.tId+d.id.INPUT);e.attr("value",a[l]);b.edit.editNameSelectAll?h.inputSelect(e):h.inputFocus(e);e.bind("blur",function(){f.editNodeBlur||f.cancelCurEditNode(b)}).bind("keydown",
function(c){c.keyCode=="13"?(f.editNodeBlur=!0,f.cancelCurEditNode(b,null,!0)):c.keyCode=="27"&&f.cancelCurEditNode(b,a[l])}).bind("click",function(){return!1}).bind("dblclick",function(){return!1});j("#"+a.tId+d.id.A).addClass(d.node.CURSELECTED_EDIT);c.curEditInput=e;c.noSelection=!1;c.curEditNode=a}},moveNode:function(b,a,c,l,e,m){var i=n.getRoot(b),g=b.data.key.children;if(a!=c&&(!b.data.keep.leaf||!a||a.isParent||l!=d.move.TYPE_INNER)){var h=c.parentTId?c.getParentNode():i,q=a===null||a==i;q&&
a===null&&(a=i);if(q)l=d.move.TYPE_INNER;i=a.parentTId?a.getParentNode():i;if(l!=d.move.TYPE_PREV&&l!=d.move.TYPE_NEXT)l=d.move.TYPE_INNER;if(l==d.move.TYPE_INNER)if(q)c.parentTId=null;else{if(!a.isParent)a.isParent=!0,a.open=!!a.open,f.setNodeLineIcos(b,a);c.parentTId=a.tId}var p;q?p=q=b.treeObj:(!m&&l==d.move.TYPE_INNER?f.expandCollapseNode(b,a,!0,!1):m||f.expandCollapseNode(b,a.getParentNode(),!0,!1),q=j("#"+a.tId),p=j("#"+a.tId+d.id.UL),p.get(0)||(p=[],f.makeUlHtml(b,a,p,""),q.append(p.join(""))),
p=j("#"+a.tId+d.id.UL));var o=j("#"+c.tId);p.get(0)&&l==d.move.TYPE_INNER?p.append(o):q.get(0)&&l==d.move.TYPE_PREV?q.before(o):q.get(0)&&l==d.move.TYPE_NEXT&&q.after(o);var x=-1,v=0,t=null,q=null,r=c.level;if(c.isFirstNode){if(x=0,h[g].length>1)t=h[g][1],t.isFirstNode=!0}else if(c.isLastNode)x=h[g].length-1,t=h[g][x-1],t.isLastNode=!0;else for(p=0,o=h[g].length;p<o;p++)if(h[g][p].tId==c.tId){x=p;break}x>=0&&h[g].splice(x,1);if(l!=d.move.TYPE_INNER)for(p=0,o=i[g].length;p<o;p++)i[g][p].tId==a.tId&&
(v=p);if(l==d.move.TYPE_INNER){a[g]||(a[g]=[]);if(a[g].length>0)q=a[g][a[g].length-1],q.isLastNode=!1;a[g].splice(a[g].length,0,c);c.isLastNode=!0;c.isFirstNode=a[g].length==1}else a.isFirstNode&&l==d.move.TYPE_PREV?(i[g].splice(v,0,c),q=a,q.isFirstNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!0,c.isLastNode=!1):a.isLastNode&&l==d.move.TYPE_NEXT?(i[g].splice(v+1,0,c),q=a,q.isLastNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!0):(l==d.move.TYPE_PREV?i[g].splice(v,0,c):i[g].splice(v+
1,0,c),c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!1);n.fixPIdKeyValue(b,c);n.setSonNodeLevel(b,c.getParentNode(),c);f.setNodeLineIcos(b,c);f.repairNodeLevelClass(b,c,r);!b.data.keep.parent&&h[g].length<1?(h.isParent=!1,h.open=!1,a=j("#"+h.tId+d.id.UL),l=j("#"+h.tId+d.id.SWITCH),g=j("#"+h.tId+d.id.ICON),f.replaceSwitchClass(h,l,d.folder.DOCU),f.replaceIcoClass(h,g,d.folder.DOCU),a.css("display","none")):t&&f.setNodeLineIcos(b,t);q&&f.setNodeLineIcos(b,q);b.check.enable&&f.repairChkClass&&
(f.repairChkClass(b,h),f.repairParentChkClassWithSelf(b,h),h!=c.parent&&f.repairParentChkClassWithSelf(b,c));m||f.expandCollapseParentNode(b,c.getParentNode(),!0,e)}},removeChildNodes:function(b,a){if(a){var c=b.data.key.children,l=a[c];if(l){for(var e=0,m=l.length;e<m;e++)n.removeNodeCache(b,l[e]);n.removeSelectedNode(b);delete a[c];b.data.keep.parent?j("#"+a.tId+d.id.UL).empty():(a.isParent=!1,a.open=!1,c=j("#"+a.tId+d.id.SWITCH),l=j("#"+a.tId+d.id.ICON),f.replaceSwitchClass(a,c,d.folder.DOCU),
f.replaceIcoClass(a,l,d.folder.DOCU),j("#"+a.tId+d.id.UL).remove())}}},removeEditBtn:function(b){j("#"+b.tId+d.id.EDIT).unbind().remove()},removeNode:function(b,a){var c=n.getRoot(b),l=b.data.key.children,e=a.parentTId?a.getParentNode():c;if(c.curEditNode===a)c.curEditNode=null;a.isFirstNode=!1;a.isLastNode=!1;a.getPreNode=function(){return null};a.getNextNode=function(){return null};j("#"+a.tId).remove();n.removeNodeCache(b,a);n.removeSelectedNode(b,a);for(var m=0,i=e[l].length;m<i;m++)if(e[l][m].tId==
a.tId){e[l].splice(m,1);break}var g;if(!b.data.keep.parent&&e[l].length<1)e.isParent=!1,e.open=!1,m=j("#"+e.tId+d.id.UL),i=j("#"+e.tId+d.id.SWITCH),g=j("#"+e.tId+d.id.ICON),f.replaceSwitchClass(e,i,d.folder.DOCU),f.replaceIcoClass(e,g,d.folder.DOCU),m.css("display","none");else if(b.view.showLine&&e[l].length>0){var h=e[l][e[l].length-1];h.isLastNode=!0;h.isFirstNode=e[l].length==1;m=j("#"+h.tId+d.id.UL);i=j("#"+h.tId+d.id.SWITCH);g=j("#"+h.tId+d.id.ICON);e==c?e[l].length==1?f.replaceSwitchClass(h,
i,d.line.ROOT):(c=j("#"+e[l][0].tId+d.id.SWITCH),f.replaceSwitchClass(e[l][0],c,d.line.ROOTS),f.replaceSwitchClass(h,i,d.line.BOTTOM)):f.replaceSwitchClass(h,i,d.line.BOTTOM);m.removeClass(d.line.LINE)}},removeRemoveBtn:function(b){j("#"+b.tId+d.id.REMOVE).unbind().remove()},removeTreeDom:function(b,a){a.isHover=!1;f.removeEditBtn(a);f.removeRemoveBtn(a);h.apply(b.view.removeHoverDom,[b.treeId,a])},repairNodeLevelClass:function(b,a,c){if(c!==a.level){var b=j("#"+a.tId),l=j("#"+a.tId+d.id.A),e=j("#"+
a.tId+d.id.UL),c="level"+c,a="level"+a.level;b.removeClass(c);b.addClass(a);l.removeClass(c);l.addClass(a);e.removeClass(c);e.addClass(a)}}},event:v,data:{setSonNodeLevel:function(b,a,c){if(c){var d=b.data.key.children;c.level=a?a.level+1:0;if(c[d])for(var a=0,e=c[d].length;a<e;a++)c[d][a]&&n.setSonNodeLevel(b,c,c[d][a])}}}};j.extend(!0,j.fn.zTree.consts,{event:{DRAG:"ztree_drag",DROP:"ztree_drop",REMOVE:"ztree_remove",RENAME:"ztree_rename"},id:{EDIT:"_edit",INPUT:"_input",REMOVE:"_remove"},move:{TYPE_INNER:"inner",
TYPE_PREV:"prev",TYPE_NEXT:"next"},node:{CURSELECTED_EDIT:"curSelectedNode_Edit",TMPTARGET_TREE:"tmpTargetzTree",TMPTARGET_NODE:"tmpTargetNode"}});j.extend(!0,j.fn.zTree._z,v);var v=j.fn.zTree,h=v._z.tools,d=v.consts,f=v._z.view,n=v._z.data,v=v._z.event;n.exSetting({edit:{enable:!1,editNameSelectAll:!1,showRemoveBtn:!0,showRenameBtn:!0,removeTitle:"remove",renameTitle:"rename",drag:{autoExpandTrigger:!1,isCopy:!0,isMove:!0,prev:!0,next:!0,inner:!0,minMoveSize:5,borderMax:10,borderMin:-5,maxShowNodeNum:5,
autoOpenTime:500}},view:{addHoverDom:null,removeHoverDom:null},callback:{beforeDrag:null,beforeDragOpen:null,beforeDrop:null,beforeEditName:null,beforeRemove:null,beforeRename:null,onDrag:null,onDrop:null,onRemove:null,onRename:null}});n.addInitBind(function(b){var a=b.treeObj,c=d.event;a.unbind(c.RENAME);a.bind(c.RENAME,function(a,c,d){h.apply(b.callback.onRename,[a,c,d])});a.unbind(c.REMOVE);a.bind(c.REMOVE,function(a,c,d){h.apply(b.callback.onRemove,[a,c,d])});a.unbind(c.DRAG);a.bind(c.DRAG,function(a,
c,d,f){h.apply(b.callback.onDrag,[c,d,f])});a.unbind(c.DROP);a.bind(c.DROP,function(a,c,d,f,g,j,n){h.apply(b.callback.onDrop,[c,d,f,g,j,n])})});n.addInitCache(function(){});n.addInitNode(function(b,a,c){if(c)c.isHover=!1,c.editNameFlag=!1});n.addInitProxy(function(b){var a=b.target,c=n.getSetting(b.data.treeId),f=b.relatedTarget,e="",m=null,i="",g=null,j=null;if(h.eqs(b.type,"mouseover")){if(j=h.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+d.id.A}]))e=j.parentNode.id,i="hoverOverNode"}else if(h.eqs(b.type,
"mouseout"))j=h.getMDom(c,f,[{tagName:"a",attrName:"treeNode"+d.id.A}]),j||(e="remove",i="hoverOutNode");else if(h.eqs(b.type,"mousedown")&&(j=h.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+d.id.A}])))e=j.parentNode.id,i="mousedownNode";if(e.length>0)switch(m=n.getNodeCache(c,e),i){case "mousedownNode":g=D.onMousedownNode;break;case "hoverOverNode":g=D.onHoverOverNode;break;case "hoverOutNode":g=D.onHoverOutNode}return{stop:!1,node:m,nodeEventType:i,nodeEventCallback:g,treeEventType:"",treeEventCallback:null}});
n.addInitRoot(function(b){b=n.getRoot(b);b.curEditNode=null;b.curEditInput=null;b.curHoverNode=null;b.dragFlag=0;b.dragNodeShowBefore=[];b.dragMaskList=[];b.showHoverDom=!0});n.addZTreeTools(function(b,a){a.addNodes=function(a,d,e){function m(){f.addNodes(b,a,i,e==!0)}if(!d)return null;a||(a=null);if(a&&!a.isParent&&b.data.keep.leaf)return null;var i=h.clone(h.isArray(d)?d:[d]);b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,e,m):m();return i};a.cancelEditName=function(a){var d=n.getRoot(b),e=b.data.key.name,
h=d.curEditNode;d.curEditNode&&f.cancelCurEditNode(b,a?a:h[e])};a.copyNode=function(a,l,e,j){if(!l)return null;if(a&&!a.isParent&&b.data.keep.leaf&&e===d.move.TYPE_INNER)return null;var i=h.clone(l);if(!a)a=null,e=d.move.TYPE_INNER;e==d.move.TYPE_INNER?(l=function(){f.addNodes(b,a,[i],j)},b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,j,l):l()):(f.addNodes(b,a.parentNode,[i],j),f.moveNode(b,a,i,e,!1,j));return i};a.editName=function(a){a&&a.tId&&a===n.getNodeCache(b,a.tId)&&(a.parentTId&&f.expandCollapseParentNode(b,
a.getParentNode(),!0),f.editNode(b,a))};a.moveNode=function(a,l,e,m){function i(){f.moveNode(b,a,l,e,!1,m)}if(!l)return l;if(a&&!a.isParent&&b.data.keep.leaf&&e===d.move.TYPE_INNER)return null;else if(a&&(l.parentTId==a.tId&&e==d.move.TYPE_INNER||j("#"+l.tId).find("#"+a.tId).length>0))return null;else a||(a=null);b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,m,i):i();return l};a.removeNode=function(a,l){a&&(l=!!l,l&&h.apply(b.callback.beforeRemove,[b.treeId,a],!0)==!1||(f.removeNode(b,a),l&&this.setting.treeObj.trigger(d.event.REMOVE,
[b.treeId,a])))};a.removeChildNodes=function(a){if(!a)return null;var d=a[b.data.key.children];f.removeChildNodes(b,a);return d?d:null};a.setEditable=function(a){b.edit.enable=a;return this.refresh()}});var I=f.cancelPreSelectedNode;f.cancelPreSelectedNode=function(b,a){for(var c=n.getRoot(b).curSelectedList,d=0,e=c.length;d<e;d++)if(!a||a===c[d])if(f.removeTreeDom(b,c[d]),a)break;I&&I.apply(f,arguments)};var J=f.createNodes;f.createNodes=function(b,a,c,d){J&&J.apply(f,arguments);c&&f.repairParentChkClassWithSelf&&
f.repairParentChkClassWithSelf(b,d)};f.makeNodeUrl=function(b,a){return a.url&&!b.edit.enable?a.url:null};var G=f.selectNode;f.selectNode=function(b,a,c){var d=n.getRoot(b);if(n.isSelectedNode(b,a)&&d.curEditNode==a&&a.editNameFlag)return!1;G&&G.apply(f,arguments);f.addHoverDom(b,a);return!0};var H=h.uCanDo;h.uCanDo=function(b,a){var c=n.getRoot(b);return a&&(h.eqs(a.type,"mouseover")||h.eqs(a.type,"mouseout")||h.eqs(a.type,"mousedown")||h.eqs(a.type,"mouseup"))?!0:!c.curEditNode&&(H?H.apply(f,arguments):
!0)}})(jQuery);
