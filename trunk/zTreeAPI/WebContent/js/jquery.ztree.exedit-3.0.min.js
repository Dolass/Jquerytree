...
[b.treeId,a]);return!1}).bind("mousedown",function(){return!0}).show()}},addHoverDom:function(b,a){if(o.getRoot(b).showHoverDom)a.isHover=!0,b.edit.enable&&(g.addEditBtn(b,a),g.addRemoveBtn(b,a)),j.apply(b.view.addHoverDom,[b.treeId,a])},cancelCurEditNode:function(b,a){var c=o.getRoot(b),m=b.data.key.name,e=c.curEditNode;if(e){var h=c.curEditInput,a=a?a:h.val();if(j.apply(b.callback.beforeRename,[b.treeId,e,a],!0)===!1)return e.editNameStatus=!0,j.inputFocus(h),!1;else e[m]=a?a:h.val(),b.treeObj.trigger(d.event.RENAME,
