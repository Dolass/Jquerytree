...
beforeRightClick:null,beforeMouseDown:null,beforeMouseUp:null,beforeExpand:null,beforeCollapse:null,onAsyncError:null,onAsyncSuccess:null,onNodeCreated:null,onClick:null,onRightClick:null,onMouseDown:null,onMouseUp:null,onExpand:null,onCollapse:null}},s=[function(b){var a=b.treeObj,c=f.event;a.unbind(c.NODECREATED);a.bind(c.NODECREATED,function(a,c,g){k.apply(b.callback.onNodeCreated,[a,c,g])});a.unbind(c.CLICK);a.bind(c.CLICK,function(a,c,g,j){k.apply(b.callback.onClick,[a,c,g,j])});a.unbind(c.EXPAND);
a.bind(c.EXPAND,function(a,c,g){k.apply(b.callback.onExpand,[a,c,g])});a.unbind(c.COLLAPSE);a.bind(c.COLLAPSE,function(a,c,g){k.apply(b.callback.onCollapse,[a,c,g])});a.unbind(c.ASYNC_SUCCESS);a.bind(c.ASYNC_SUCCESS,function(a,c,g,j){k.apply(b.callback.onAsyncSuccess,[a,c,g,j])});a.unbind(c.ASYNC_ERROR);a.bind(c.ASYNC_ERROR,function(a,c,g,j,h,f){k.apply(b.callback.onAsyncError,[a,c,g,j,h,f])})}],p=[function(b){var a=h.getCache(b);a||(a={},h.setCache(b,a));a.nodes=[];a.doms=[]}],v=[function(b,a,c,
d,e,g){if(c){var j=b.data.key.children;c.level=a;c.tId=b.treeId+"_"+ ++M;c.parentTId=d?d.tId:null;if(c[j]&&c[j].length>0){if(typeof c.open=="string")c.open=k.eqs(c.open,"true");c.open=!!c.open;c.isParent=!0}else{c.open=!1;if(typeof c.isParent=="string")c.isParent=k.eqs(c.isParent,"true");c.isParent=!!c.isParent}c.isFirstNode=e;c.isLastNode=g;c.getParentNode=function(){return h.getNodeCache(b,c.parentTId)};c.getPreNode=function(){return h.getPreNode(b,c)};c.getNextNode=function(){return h.getNextNode(b,
c)};c.isAjaxing=!1;h.fixPIdKeyValue(b,c)}}],w=[function(b){var a=b.target,c=o[b.data.treeId],d="",e=null,g="",j="",i=null,l=null,m=null;if(k.eqs(b.type,"mousedown"))j="mousedown";else if(k.eqs(b.type,"mouseup"))j="mouseup";else if(k.eqs(b.type,"contextmenu"))j="contextmenu";else if(k.eqs(b.type,"click"))if(k.eqs(a.tagName,"button")&&a.blur(),k.eqs(a.tagName,"button")&&a.getAttribute("treeNode"+f.id.SWITCH)!==null)d=a.parentNode.id,g="switchNode";else{if(m=k.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+
f.id.A}]))d=m.parentNode.id,g="clickNode"}else if(k.eqs(b.type,"dblclick")&&(j="dblclick",m=k.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+f.id.A}])))d=m.parentNode.id,g="switchNode";if(j.length>0&&d.length==0&&(m=k.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+f.id.A}])))d=m.parentNode.id;if(d.length>0)switch(e=h.getNodeCache(c,d),g){case "switchNode":e.isParent?k.eqs(b.type,"click")||k.eqs(b.type,"dblclick")&&k.apply(c.view.dblClickExpand,[c.treeId,e],c.view.dblClickExpand)?i=D:g="":g="";break;
case "clickNode":i=E}switch(j){case "mousedown":l=F;break;case "mouseup":l=G;break;case "dblclick":l=H;break;case "contextmenu":l=I}return{stop:!1,node:e,nodeEventType:g,nodeEventCallback:i,treeEventType:j,treeEventCallback:l}}],x=[function(b){var a=h.getRoot(b);a||(a={},h.setRoot(b,a));a.children=[];a.expandTriggerFlag=!1;a.curSelectedList=[];a.noSelection=!0;a.createdNodes=[]}],y=[],z=[],A=[],B=[],C=[],h={addNodeCache:function(b,a){h.getCache(b).nodes[a.tId]=a},addAfterA:function(b){z.push(b)},
...
getBeforeA:function(b,a,c){for(var d=0,e=y.length;d<e;d++)y[d].apply(this,arguments)},getInnerAfterA:function(b,a,c){for(var d=0,e=B.length;d<e;d++)B[d].apply(this,arguments)},getInnerBeforeA:function(b,a,c){for(var d=0,e=A.length;d<e;d++)A[d].apply(this,arguments)},getCache:function(b){return r[b.treeId]},getNextNode:function(b,a){if(!a)return null;var c=b.data.key.children,d=a.parentTId?a.getParentNode():h.getRoot(b);if(!a.isLastNode)if(a.isFirstNode)return d[c][1];else for(var e=1,g=d[c].length-
...
[],c=0,d=w.length;c<d;c++){var e=w[c].apply(this,arguments);a.push(e);if(e.stop)break}return a},proxy:function(b){var a=h.getSetting(b.data.treeId);if(!k.uCanDo(a,b))return!0;for(var c=m.doProxy(b),d=!0,e=!1,g=0,j=c.length;g<j;g++){var f=c[g];f.nodeEventCallback&&(e=!0,d=f.nodeEventCallback.apply(f,[b,f.node])&&d);f.treeEventCallback&&(e=!0,d=f.treeEventCallback.apply(f,[b,f.node])&&d)}try{e&&l("input:focus").length==0&&k.noSel(a)}catch(i){}return d}};D=function(b,a){var c=o[b.data.treeId];if(a.open){if(k.apply(c.callback.beforeCollapse,
...
a,c,d){if(!b.data.keep.leaf||!a||a.isParent)if(k.isArray(c)||(c=[c]),b.data.simpleData.enable&&(c=h.transformTozTreeFormat(b,c)),a){var e=l("#"+a.tId+f.id.SWITCH),g=l("#"+a.tId+f.id.ICON),j=l("#"+a.tId+f.id.UL);if(!a.open)i.replaceSwitchClass(e,f.folder.CLOSE),i.replaceIcoClass(a,g,f.folder.CLOSE),a.open=!1,j.css({display:"none"});h.addNodesData(b,a,c);i.createNodes(b,a.level+1,c,a);d||i.expandCollapseParentNode(b,a,!0)}else h.addNodesData(b,h.getRoot(b),c),i.createNodes(b,0,c,null)},appendNodes:function(b,
a,c,d,e,g){if(!c)return[];for(var j=[],l=b.data.key.children,m=b.data.key.name,o=h.getTitleKey(b),t=0,N=c.length;t<N;t++){var n=c[t],u=(d?d:h.getRoot(b))[l].length==c.length&&t==0,q=t==c.length-1;e&&(h.initNode(b,a,n,d,u,q,g),h.addNodeCache(b,n));u=[];n[l]&&n[l].length>0&&(u=i.appendNodes(b,a+1,n[l],n,e,g&&n.open));if(g){var q=i.makeNodeUrl(b,n),r=i.makeNodeFontCss(b,n),s=[],p;for(p in r)s.push(p,":",r[p],";");j.push("<li id='",n.tId,"' class='level",n.level,"' treenode>","<button type='button' hidefocus='true'",
