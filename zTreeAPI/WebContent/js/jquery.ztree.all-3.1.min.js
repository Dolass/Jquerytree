...
a){for(var c=o.getRoot(b);c.dragMaskList.length>0;)c.dragMaskList[0].remove(),c.dragMaskList.shift();if(a)for(var j=m("iframe"),e=0,d=j.length;e<d;e++){var f=j.get(e),g=h.getAbs(f),f=m("<div id='zTreeMask_"+e+"' class='zTreeMask' style='background-color:yellow;opacity: 0.3;filter: alpha(opacity=30);    top:"+g[1]+"px; left:"+g[0]+"px; width:"+f.offsetWidth+"px; height:"+f.offsetHeight+"px;'></div>");f.appendTo("body");c.dragMaskList.push(f)}}},view:{addEditBtn:function(b,a){if(!(a.editNameFlag||m("#"+
a.tId+d.id.EDIT).length>0)&&h.apply(b.edit.showRenameBtn,[b.treeId,a],b.edit.showRenameBtn)){var c=m("#"+a.tId+d.id.A),j="<button type='button' class='edit' id='"+a.tId+d.id.EDIT+"' title='"+h.apply(b.edit.renameTitle,[b.treeId,a],b.edit.renameTitle)+"' treeNode"+d.id.EDIT+" onfocus='this.blur();' style='display:none;'></button>";c.append(j);m("#"+a.tId+d.id.EDIT).bind("click",function(){if(!h.uCanDo(b)||h.apply(b.callback.beforeEditName,[b.treeId,a],!0)==!1)return!0;f.editNode(b,a);return!1}).show()}},
addRemoveBtn:function(b,a){if(!(a.editNameFlag||m("#"+a.tId+d.id.REMOVE).length>0)&&h.apply(b.edit.showRemoveBtn,[b.treeId,a],b.edit.showRemoveBtn)){var c=m("#"+a.tId+d.id.A),j="<button type='button' class='remove' id='"+a.tId+d.id.REMOVE+"' title='"+h.apply(b.edit.removeTitle,[b.treeId,a],b.edit.removeTitle)+"' treeNode"+d.id.REMOVE+" onfocus='this.blur();' style='display:none;'></button>";c.append(j);m("#"+a.tId+d.id.REMOVE).bind("click",function(){if(!h.uCanDo(b)||h.apply(b.callback.beforeRemove,
...
!1)return e.editNameFlag=!0,!1;else e[j]=i?i:l.val(),a||b.treeObj.trigger(d.event.RENAME,[b.treeId,e]);m("#"+e.tId+d.id.A).removeClass(d.node.CURSELECTED_EDIT);l.unbind();f.setNodeName(b,e);e.editNameFlag=!1;c.curEditNode=null;c.curEditInput=null;f.selectNode(b,e,!1)}return c.noSelection=!0},editNode:function(b,a){var c=o.getRoot(b);f.editNodeBlur=!1;if(o.isSelectedNode(b,a)&&c.curEditNode==a&&a.editNameFlag)setTimeout(function(){h.inputFocus(c.curEditInput)},0);else{var j=b.data.key.name;a.editNameFlag=
!0;f.removeTreeDom(b,a);f.cancelCurEditNode(b);f.selectNode(b,a,!1);m("#"+a.tId+d.id.SPAN).html("<input type=text class='rename' id='"+a.tId+d.id.INPUT+"' treeNode"+d.id.INPUT+" >");var e=m("#"+a.tId+d.id.INPUT);e.attr("value",a[j]);h.inputFocus(e);e.bind("blur",function(){f.editNodeBlur||f.cancelCurEditNode(b)}).bind("keydown",function(c){c.keyCode=="13"?(f.editNodeBlur=!0,f.cancelCurEditNode(b,null,!0)):c.keyCode=="27"&&f.cancelCurEditNode(b,a[j])}).bind("click",function(){return!1}).bind("dblclick",
function(){return!1});m("#"+a.tId+d.id.A).addClass(d.node.CURSELECTED_EDIT);c.curEditInput=e;c.noSelection=!1;c.curEditNode=a}},moveNode:function(b,a,c,j,e,l){var i=o.getRoot(b),g=b.data.key.children;if(a!=c&&(!b.data.keep.leaf||!a||a.isParent||j!=d.move.TYPE_INNER)){var h=c.parentTId?c.getParentNode():i,p=a===null||a==i;p&&a===null&&(a=i);if(p)j=d.move.TYPE_INNER;i=a.parentTId?a.getParentNode():i;if(j!=d.move.TYPE_PREV&&j!=d.move.TYPE_NEXT)j=d.move.TYPE_INNER;var q,n;p?n=q=b.treeObj:l||(j==d.move.TYPE_INNER?
f.expandCollapseNode(b,a,!0,!1):f.expandCollapseNode(b,a.getParentNode(),!0,!1),q=m("#"+a.tId),n=m("#"+a.tId+d.id.UL));var x=m("#"+c.tId).remove();n&&j==d.move.TYPE_INNER?n.append(x):q&&j==d.move.TYPE_PREV?q.before(x):q&&j==d.move.TYPE_NEXT&&q.after(x);var w=-1,u=0,r=null;q=null;var C=c.level;if(c.isFirstNode){if(w=0,h[g].length>1)r=h[g][1],r.isFirstNode=!0}else if(c.isLastNode)w=h[g].length-1,r=h[g][w-1],r.isLastNode=!0;else for(n=0,x=h[g].length;n<x;n++)if(h[g][n].tId==c.tId){w=n;break}w>=0&&h[g].splice(w,
1);if(j!=d.move.TYPE_INNER)for(n=0,x=i[g].length;n<x;n++)i[g][n].tId==a.tId&&(u=n);if(j==d.move.TYPE_INNER){p?c.parentTId=null:(a.isParent=!0,a.open=!1,c.parentTId=a.tId);a[g]||(a[g]=[]);if(a[g].length>0)q=a[g][a[g].length-1],q.isLastNode=!1;a[g].splice(a[g].length,0,c);c.isLastNode=!0;c.isFirstNode=a[g].length==1}else a.isFirstNode&&j==d.move.TYPE_PREV?(i[g].splice(u,0,c),q=a,q.isFirstNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!0,c.isLastNode=!1):a.isLastNode&&j==d.move.TYPE_NEXT?(i[g].splice(u+
1,0,c),q=a,q.isLastNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!0):(j==d.move.TYPE_PREV?i[g].splice(u,0,c):i[g].splice(u+1,0,c),c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!1);o.fixPIdKeyValue(b,c);o.setSonNodeLevel(b,c.getParentNode(),c);f.setNodeLineIcos(b,c);f.repairNodeLevelClass(b,c,C);!b.data.keep.parent&&h[g].length<1?(h.isParent=!1,h.open=!1,a=m("#"+h.tId+d.id.UL),j=m("#"+h.tId+d.id.SWITCH),g=m("#"+h.tId+d.id.ICON),f.replaceSwitchClass(h,j,d.folder.DOCU),f.replaceIcoClass(h,
g,d.folder.DOCU),a.css("display","none")):r&&f.setNodeLineIcos(b,r);q&&f.setNodeLineIcos(b,q);b.check.enable&&f.repairChkClass&&(f.repairChkClass(b,h),f.repairParentChkClassWithSelf(b,h),h!=c.parent&&f.repairParentChkClassWithSelf(b,c));l||f.expandCollapseParentNode(b,c.getParentNode(),!0,e)}},removeChildNodes:function(b,a){if(a){var c=b.data.key.children,j=a[c];if(j){m("#"+a.tId+d.id.UL).remove();for(var e=0,l=j.length;e<l;e++)o.removeNodeCache(b,j[e]);o.removeSelectedNode(b);delete a[c];if(!b.data.keep.parent)a.isParent=
!1,a.open=!1,c=m("#"+a.tId+d.id.SWITCH),j=m("#"+a.tId+d.id.ICON),f.replaceSwitchClass(a,c,d.folder.DOCU),f.replaceIcoClass(a,j,d.folder.DOCU)}}},removeEditBtn:function(b){m("#"+b.tId+d.id.EDIT).unbind().remove()},removeNode:function(b,a){var c=o.getRoot(b),j=b.data.key.children,e=a.parentTId?a.getParentNode():c;if(c.curEditNode===a)c.curEditNode=null;a.isFirstNode=!1;a.isLastNode=!1;a.getPreNode=function(){return null};a.getNextNode=function(){return null};m("#"+a.tId).remove();o.removeNodeCache(b,
a);o.removeSelectedNode(b,a);for(var l=0,i=e[j].length;l<i;l++)if(e[j][l].tId==a.tId){e[j].splice(l,1);break}var g;if(!b.data.keep.parent&&e[j].length<1)e.isParent=!1,e.open=!1,l=m("#"+e.tId+d.id.UL),i=m("#"+e.tId+d.id.SWITCH),g=m("#"+e.tId+d.id.ICON),f.replaceSwitchClass(e,i,d.folder.DOCU),f.replaceIcoClass(e,g,d.folder.DOCU),l.css("display","none");else if(b.view.showLine&&e[j].length>0){var h=e[j][e[j].length-1];h.isLastNode=!0;h.isFirstNode=e[j].length==1;l=m("#"+h.tId+d.id.UL);i=m("#"+h.tId+
d.id.SWITCH);g=m("#"+h.tId+d.id.ICON);e==c?e[j].length==1?f.replaceSwitchClass(h,i,d.line.ROOT):(c=m("#"+e[j][0].tId+d.id.SWITCH),f.replaceSwitchClass(e[j][0],c,d.line.ROOTS),f.replaceSwitchClass(h,i,d.line.BOTTOM)):f.replaceSwitchClass(h,i,d.line.BOTTOM);l.removeClass(d.line.LINE)}},removeRemoveBtn:function(b){m("#"+b.tId+d.id.REMOVE).unbind().remove()},removeTreeDom:function(b,a){a.isHover=!1;f.removeEditBtn(a);f.removeRemoveBtn(a);h.apply(b.view.removeHoverDom,[b.treeId,a])},repairNodeLevelClass:function(b,
a,c){if(c!==a.level){var b=m("#"+a.tId),j=m("#"+a.tId+d.id.A),e=m("#"+a.tId+d.id.UL),c="level"+c,a="level"+a.level;b.removeClass(c);b.addClass(a);j.removeClass(c);j.addClass(a);e.removeClass(c);e.addClass(a)}}},event:p,data:{setSonNodeLevel:function(b,a,c){if(c){var d=b.data.key.children;c.level=a?a.level+1:0;if(c[d])for(var a=0,e=c[d].length;a<e;a++)c[d][a]&&o.setSonNodeLevel(b,c,c[d][a])}}}};m.extend(!0,m.fn.zTree.consts,{event:{DRAG:"ztree_drag",DROP:"ztree_drop",REMOVE:"ztree_remove",RENAME:"ztree_rename"},
id:{EDIT:"_edit",INPUT:"_input",REMOVE:"_remove"},move:{TYPE_INNER:"inner",TYPE_PREV:"prev",TYPE_NEXT:"next"},node:{CURSELECTED_EDIT:"curSelectedNode_Edit",TMPTARGET_TREE:"tmpTargetzTree",TMPTARGET_NODE:"tmpTargetNode"}});m.extend(!0,m.fn.zTree._z,p);var p=m.fn.zTree,h=p._z.tools,d=p.consts,f=p._z.view,o=p._z.data,p=p._z.event;o.exSetting({edit:{enable:!1,showRemoveBtn:!0,showRenameBtn:!0,removeTitle:"remove",renameTitle:"rename",drag:{autoExpandTrigger:!1,isCopy:!0,isMove:!0,prev:!0,next:!0,inner:!0,
minMoveSize:5,borderMax:10,borderMin:-5,maxShowNodeNum:5,autoOpenTime:500}},view:{addHoverDom:null,removeHoverDom:null},callback:{beforeDrag:null,beforeDragOpen:null,beforeDrop:null,beforeEditName:null,beforeRemove:null,beforeRename:null,onDrag:null,onDrop:null,onRemove:null,onRename:null}});o.addInitBind(function(b){var a=b.treeObj,c=d.event;a.unbind(c.RENAME);a.bind(c.RENAME,function(a,c,d){h.apply(b.callback.onRename,[a,c,d])});a.unbind(c.REMOVE);a.bind(c.REMOVE,function(a,c,d){h.apply(b.callback.onRemove,
...
m.parentNode.id,i="hoverOverNode"}else if(h.eqs(b.type,"mouseout"))m=h.getMDom(c,f,[{tagName:"a",attrName:"treeNode"+d.id.A}]),m||(e="remove",i="hoverOutNode");else if(h.eqs(b.type,"mousedown")&&(m=h.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+d.id.A}])))e=m.parentNode.id,i="mousedownNode";if(e.length>0)switch(l=o.getNodeCache(c,e),i){case "mousedownNode":g=C.onMousedownNode;break;case "hoverOverNode":g=C.onHoverOverNode;break;case "hoverOutNode":g=C.onHoverOutNode}return{stop:!1,node:l,nodeEventType:i,
nodeEventCallback:g,treeEventType:"",treeEventCallback:null}});o.addInitRoot(function(b){b=o.getRoot(b);b.curEditNode=null;b.curEditInput=null;b.curHoverNode=null;b.dragFlag=0;b.dragNodeShowBefore=[];b.dragMaskList=[];b.showHoverDom=!0});o.addZTreeTools(function(b,a){a.addNodes=function(a,d,e){function l(){f.addNodes(b,a,i,e==!0)}if(!d)return null;a||(a=null);if(a&&!a.isParent&&b.data.keep.leaf)return null;var i=h.clone(h.isArray(d)?d:[d]);b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,e,l):l();
return i};a.cancelEditName=function(a){var d=o.getRoot(b),e=b.data.key.name,h=d.curEditNode;d.curEditNode&&f.cancelCurEditNode(b,a?a:h[e])};a.copyNode=function(a,j,e,l){if(!j)return null;if(a&&!a.isParent&&b.data.keep.leaf&&e===d.move.TYPE_INNER)return null;var i=h.clone(j);if(!a)a=null,e=d.move.TYPE_INNER;e==d.move.TYPE_INNER?(j=function(){f.addNodes(b,a,[i],l)},b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,l,j):j()):(f.addNodes(b,a.parentNode,[i],l),f.moveNode(b,a,i,e,!1,l));return i};a.editName=
function(a){a&&a.tId&&a===o.getNodeCache(b,a.tId)&&(f.expandCollapseParentNode(b,a,!0),f.editNode(b,a))};a.moveNode=function(a,j,e,l){function i(){f.moveNode(b,a,j,e,!1,l)}if(!j)return j;if(a&&!a.isParent&&b.data.keep.leaf&&e===d.move.TYPE_INNER)return null;else if(a&&(j.parentTId==a.tId&&e==d.move.TYPE_INNER||m("#"+j.tId).find("#"+a.tId).length>0))return null;else a||(a=null);b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,l,i):i();return j};a.removeNode=function(a,j){a&&(j=!!j,j&&h.apply(b.callback.beforeRemove,
[b.treeId,a],!0)==!1||(f.removeNode(b,a),j&&this.setting.treeObj.trigger(d.event.REMOVE,[b.treeId,a])))};a.removeChildNodes=function(a){if(!a)return null;var d=a[b.data.key.children];f.removeChildNodes(b,a);return d?d:null};a.setEditable=function(a){b.edit.enable=a;return this.refresh()}});var H=f.cancelPreSelectedNode;f.cancelPreSelectedNode=function(b,a){for(var c=o.getRoot(b).curSelectedList,d=0,e=c.length;d<e;d++)if(!a||a===c[d])if(f.removeTreeDom(b,c[d]),a)break;H&&H.apply(f,arguments)};var I=
f.createNodes;f.createNodes=function(b,a,c,d){I&&I.apply(f,arguments);c&&f.repairParentChkClassWithSelf&&f.repairParentChkClassWithSelf(b,d)};f.makeNodeUrl=function(b,a){return a.url&&!b.edit.enable?a.url:null};var F=f.selectNode;f.selectNode=function(b,a,c){var d=o.getRoot(b);if(o.isSelectedNode(b,a)&&d.curEditNode==a&&a.editNameFlag)return!1;F&&F.apply(f,arguments);f.addHoverDom(b,a);return!0};var G=h.uCanDo;h.uCanDo=function(b,a){var c=o.getRoot(b);return a&&(h.eqs(a.type,"mouseover")||h.eqs(a.type,
"mouseout")||h.eqs(a.type,"mousedown")||h.eqs(a.type,"mouseup"))?!0:!c.curEditNode&&(G?G.apply(f,arguments):!0)}})(jQuery);
