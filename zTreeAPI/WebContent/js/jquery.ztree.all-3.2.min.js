 ...
 * Date: 2012-02-14
 */
(function(j){var C={onHoverOverNode:function(b,a){var c=o.getSetting(b.data.treeId),d=o.getRoot(c);if(d.curHoverNode!=a)C.onHoverOutNode(b);d.curHoverNode=a;f.addHoverDom(c,a)},onHoverOutNode:function(b){var b=o.getSetting(b.data.treeId),a=o.getRoot(b);if(a.curHoverNode&&!o.isSelectedNode(b,a.curHoverNode))f.removeTreeDom(b,a.curHoverNode),a.curHoverNode=null},onMousedownNode:function(b,a){function c(b){if(z.dragFlag==0&&Math.abs(H-b.clientX)<g.edit.drag.minMoveSize&&Math.abs(I-b.clientY)<g.edit.drag.minMoveSize)return!0;
var a,c,e,m,i;i=g.data.key.children;h.noSel(g);j("body").css("cursor","pointer");if(z.dragFlag==0){if(h.apply(g.callback.beforeDrag,[g.treeId,n],!0)==!1)return l(b),!0;for(a=0,c=n.length;a<c;a++){if(a==0)z.dragNodeShowBefore=[];e=n[a];e.isParent&&e.open?(f.expandCollapseNode(g,e,!e.open),z.dragNodeShowBefore[e.tId]=!0):z.dragNodeShowBefore[e.tId]=!1}z.dragFlag=1;z.showHoverDom=!1;h.showIfameMask(g,!0);e=!0;m=-1;if(n.length>1){var s=n[0].parentTId?n[0].getParentNode()[i]:o.getNodes(g);i=[];for(a=0,
c=s.length;a<c;a++)if(z.dragNodeShowBefore[s[a].tId]!==void 0&&(e&&m>-1&&m+1!==a&&(e=!1),i.push(s[a]),m=a),n.length===i.length){n=i;break}}e&&(C=n[0].getPreNode(),J=n[n.length-1].getNextNode());x=j("<ul class='zTreeDragUL'></ul>");for(a=0,c=n.length;a<c;a++)if(e=n[a],e.editNameFlag=!1,f.selectNode(g,e,a>0),f.removeTreeDom(g,e),m=j("<li id='"+e.tId+"_tmp'></li>"),m.append(j("#"+e.tId+d.id.A).clone()),m.css("padding","0"),m.children("#"+e.tId+d.id.A).removeClass(d.node.CURSELECTED),x.append(m),a==g.edit.drag.maxShowNodeNum-
1){m=j("<li id='"+e.tId+"_moretmp'><a>  ...  </a></li>");x.append(m);break}x.attr("id",n[0].tId+d.id.UL+"_tmp");x.addClass(g.treeObj.attr("class"));x.appendTo("body");v=j("<button class='tmpzTreeMove_arrow'></button>");v.attr("id","zTreeMove_arrow_tmp");v.appendTo("body");g.treeObj.trigger(d.event.DRAG,[g.treeId,n])}if(z.dragFlag==1){r&&v.attr("id")==b.target.id&&t&&b.clientX+w.scrollLeft()+2>j("#"+t+d.id.A,r).offset().left?(e=j("#"+t+d.id.A,r),b.target=e.length>0?e.get(0):b.target):r&&(r.removeClass(d.node.TMPTARGET_TREE),
t&&j("#"+t+d.id.A,r).removeClass(d.node.TMPTARGET_NODE));t=r=null;D=!1;k=g;e=o.getSettings();for(var B in e)if(e[B].treeId&&e[B].edit.enable&&e[B].treeId!=g.treeId&&(b.target.id==e[B].treeId||j(b.target).parents("#"+e[B].treeId).length>0))D=!0,k=e[B];B=w.scrollTop();m=w.scrollLeft();i=k.treeObj.offset();a=k.treeObj.get(0).scrollHeight;e=k.treeObj.get(0).scrollWidth;c=b.clientY+B-i.top;var q=k.treeObj.height()+i.top-b.clientY-B,p=b.clientX+m-i.left,E=k.treeObj.width()+i.left-b.clientX-m;i=c<g.edit.drag.borderMax&&
c>g.edit.drag.borderMin;var s=q<g.edit.drag.borderMax&&q>g.edit.drag.borderMin,N=p<g.edit.drag.borderMax&&p>g.edit.drag.borderMin,G=E<g.edit.drag.borderMax&&E>g.edit.drag.borderMin,q=c>g.edit.drag.borderMin&&q>g.edit.drag.borderMin&&p>g.edit.drag.borderMin&&E>g.edit.drag.borderMin,p=i&&k.treeObj.scrollTop()<=0,E=s&&k.treeObj.scrollTop()+k.treeObj.height()+10>=a,O=N&&k.treeObj.scrollLeft()<=0,P=G&&k.treeObj.scrollLeft()+k.treeObj.width()+10>=e;if(b.target.id&&k.treeObj.find("#"+b.target.id).length>
0){for(var A=b.target;A&&A.tagName&&!h.eqs(A.tagName,"li")&&A.id!=k.treeId;)A=A.parentNode;var K=!0;for(a=0,c=n.length;a<c;a++)if(e=n[a],A.id===e.tId){K=!1;break}else if(j("#"+e.tId).find("#"+A.id).length>0){K=!1;break}if(K&&b.target.id&&(b.target.id==A.id+d.id.A||j(b.target).parents("#"+A.id+d.id.A).length>0))r=j(A),t=A.id}e=n[0];if(q&&(b.target.id==k.treeId||j(b.target).parents("#"+k.treeId).length>0)){if(!r&&(b.target.id==k.treeId||p||E||O||P)&&(D||!D&&e.parentTId))r=k.treeObj;i?k.treeObj.scrollTop(k.treeObj.scrollTop()-
10):s&&k.treeObj.scrollTop(k.treeObj.scrollTop()+10);N?k.treeObj.scrollLeft(k.treeObj.scrollLeft()-10):G&&k.treeObj.scrollLeft(k.treeObj.scrollLeft()+10);r&&r!=k.treeObj&&r.offset().left<k.treeObj.offset().left&&k.treeObj.scrollLeft(k.treeObj.scrollLeft()+r.offset().left-k.treeObj.offset().left)}x.css({top:b.clientY+B+3+"px",left:b.clientX+m+3+"px"});m=a=0;if(r&&r.attr("id")!=k.treeId){var y=t==null?null:o.getNodeCache(k,t);c=b.ctrlKey&&g.edit.drag.isMove&&g.edit.drag.isCopy||!g.edit.drag.isMove&&
g.edit.drag.isCopy;a=!!(C&&t===C.tId);i=!!(J&&t===J.tId);m=e.parentTId&&e.parentTId==t;e=(c||!i)&&h.apply(k.edit.drag.prev,[k.treeId,n,y],!!k.edit.drag.prev);a=(c||!a)&&h.apply(k.edit.drag.next,[k.treeId,n,y],!!k.edit.drag.next);i=(c||!m)&&!(k.data.keep.leaf&&!y.isParent)&&h.apply(k.edit.drag.inner,[k.treeId,n,y],!!k.edit.drag.inner);if(!e&&!a&&!i){if(r=null,t="",u=d.move.TYPE_INNER,v.css({display:"none"}),window.zTreeMoveTimer)clearTimeout(window.zTreeMoveTimer),window.zTreeMoveTargetNodeTId=null}else{c=
j("#"+t+d.id.A,r);c.addClass(d.node.TMPTARGET_NODE);m=e?i?0.25:a?0.5:1:-1;i=a?i?0.75:e?0.5:0:-1;b=(b.clientY+B-c.offset().top)/c.height();(m==1||b<=m&&b>=-0.2)&&e?(a=1-v.width(),m=0-v.height()/2,u=d.move.TYPE_PREV):(i==0||b>=i&&b<=1.2)&&a?(a=1-v.width(),m=c.height()-v.height()/2,u=d.move.TYPE_NEXT):(a=5-v.width(),m=0,u=d.move.TYPE_INNER);v.css({display:"block",top:c.offset().top+m+"px",left:c.offset().left+a+"px"});if(L!=t||M!=u)F=(new Date).getTime();if(y&&y.isParent&&u==d.move.TYPE_INNER&&(b=!0,
window.zTreeMoveTimer&&window.zTreeMoveTargetNodeTId!==y.tId?(clearTimeout(window.zTreeMoveTimer),window.zTreeMoveTargetNodeTId=null):window.zTreeMoveTimer&&window.zTreeMoveTargetNodeTId===y.tId&&(b=!1),b))window.zTreeMoveTimer=setTimeout(function(){u==d.move.TYPE_INNER&&y&&y.isParent&&!y.open&&(new Date).getTime()-F>k.edit.drag.autoOpenTime&&h.apply(k.callback.beforeDragOpen,[k.treeId,y],!0)&&(f.switchNode(k,y),k.edit.drag.autoExpandTrigger&&k.treeObj.trigger(d.event.EXPAND,[k.treeId,y]))},k.edit.drag.autoOpenTime+
50),window.zTreeMoveTargetNodeTId=y.tId}}else if(u=d.move.TYPE_INNER,r&&h.apply(k.edit.drag.inner,[k.treeId,n,null],!!k.edit.drag.inner)?r.addClass(d.node.TMPTARGET_TREE):r=null,v.css({display:"none"}),window.zTreeMoveTimer)clearTimeout(window.zTreeMoveTimer),window.zTreeMoveTargetNodeTId=null;L=t;M=u}return!1}function l(b){if(window.zTreeMoveTimer)clearTimeout(window.zTreeMoveTimer),window.zTreeMoveTargetNodeTId=null;M=L=null;w.unbind("mousemove",c);w.unbind("mouseup",l);w.unbind("selectstart",e);
j("body").css("cursor","auto");r&&(r.removeClass(d.node.TMPTARGET_TREE),t&&j("#"+t+d.id.A,r).removeClass(d.node.TMPTARGET_NODE));h.showIfameMask(g,!1);z.showHoverDom=!0;if(z.dragFlag!=0){z.dragFlag=0;var a,m,i;for(a=0,m=n.length;a<m;a++)i=n[a],i.isParent&&z.dragNodeShowBefore[i.tId]&&!i.open&&(f.expandCollapseNode(g,i,!i.open),delete z.dragNodeShowBefore[i.tId]);x&&x.remove();v&&v.remove();var q=b.ctrlKey&&g.edit.drag.isMove&&g.edit.drag.isCopy||!g.edit.drag.isMove&&g.edit.drag.isCopy;!q&&r&&t&&n[0].parentTId&&
t==n[0].parentTId&&u==d.move.TYPE_INNER&&(r=null);if(r){var p=t==null?null:o.getNodeCache(k,t);if(h.apply(g.callback.beforeDrop,[k.treeId,n,p,u,q],!0)!=!1){var s=q?h.clone(n):n,b=function(){if(D){if(!q)for(var b=0,a=n.length;b<a;b++)f.removeNode(g,n[b]);if(u==d.move.TYPE_INNER)f.addNodes(k,p,s);else if(f.addNodes(k,p.getParentNode(),s),u==d.move.TYPE_PREV)for(b=0,a=s.length;b<a;b++)f.moveNode(k,p,s[b],u,!1);else for(b=-1,a=s.length-1;b<a;a--)f.moveNode(k,p,s[a],u,!1)}else if(q&&u==d.move.TYPE_INNER)f.addNodes(k,
p,s);else if(q&&f.addNodes(k,p.getParentNode(),s),u==d.move.TYPE_PREV)for(b=0,a=s.length;b<a;b++)f.moveNode(k,p,s[b],u,!1);else for(b=-1,a=s.length-1;b<a;a--)f.moveNode(k,p,s[a],u,!1);for(b=0,a=s.length;b<a;b++)f.selectNode(k,s[b],b>0);j("#"+s[0].tId+d.id.ICON).focus().blur()};u==d.move.TYPE_INNER&&h.canAsync(k,p)?f.asyncNode(k,p,!1,b):b();g.treeObj.trigger(d.event.DROP,[k.treeId,s,p,u,q])}}else{for(a=0,m=n.length;a<m;a++)f.selectNode(k,n[a],a>0);g.treeObj.trigger(d.event.DROP,[g.treeId,null,null,
...
a===null&&(a=i);if(p)l=d.move.TYPE_INNER;i=a.parentTId?a.getParentNode():i;if(l!=d.move.TYPE_PREV&&l!=d.move.TYPE_NEXT)l=d.move.TYPE_INNER;var q,n;p?n=q=b.treeObj:m||(l==d.move.TYPE_INNER?f.expandCollapseNode(b,a,!0,!1):f.expandCollapseNode(b,a.getParentNode(),!0,!1),q=j("#"+a.tId),n=j("#"+a.tId+d.id.UL),n.get(0)||(n=[],f.makeUlHtml(b,a,n,""),q.append(n.join(""))),n=j("#"+a.tId+d.id.UL));var w=j("#"+c.tId);n.get(0)&&l==d.move.TYPE_INNER?n.append(w):q.get(0)&&l==d.move.TYPE_PREV?q.before(w):q.get(0)&&
l==d.move.TYPE_NEXT&&q.after(w);var x=-1,v=0,r=null;q=null;var C=c.level;if(c.isFirstNode){if(x=0,h[g].length>1)r=h[g][1],r.isFirstNode=!0}else if(c.isLastNode)x=h[g].length-1,r=h[g][x-1],r.isLastNode=!0;else for(n=0,w=h[g].length;n<w;n++)if(h[g][n].tId==c.tId){x=n;break}x>=0&&h[g].splice(x,1);if(l!=d.move.TYPE_INNER)for(n=0,w=i[g].length;n<w;n++)i[g][n].tId==a.tId&&(v=n);if(l==d.move.TYPE_INNER){p?c.parentTId=null:(a.isParent=!0,a.open=!1,c.parentTId=a.tId);a[g]||(a[g]=[]);if(a[g].length>0)q=a[g][a[g].length-
1],q.isLastNode=!1;a[g].splice(a[g].length,0,c);c.isLastNode=!0;c.isFirstNode=a[g].length==1}else a.isFirstNode&&l==d.move.TYPE_PREV?(i[g].splice(v,0,c),q=a,q.isFirstNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!0,c.isLastNode=!1):a.isLastNode&&l==d.move.TYPE_NEXT?(i[g].splice(v+1,0,c),q=a,q.isLastNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!0):(l==d.move.TYPE_PREV?i[g].splice(v,0,c):i[g].splice(v+1,0,c),c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!1);o.fixPIdKeyValue(b,
c);o.setSonNodeLevel(b,c.getParentNode(),c);f.setNodeLineIcos(b,c);f.repairNodeLevelClass(b,c,C);!b.data.keep.parent&&h[g].length<1?(h.isParent=!1,h.open=!1,a=j("#"+h.tId+d.id.UL),l=j("#"+h.tId+d.id.SWITCH),g=j("#"+h.tId+d.id.ICON),f.replaceSwitchClass(h,l,d.folder.DOCU),f.replaceIcoClass(h,g,d.folder.DOCU),a.css("display","none")):r&&f.setNodeLineIcos(b,r);q&&f.setNodeLineIcos(b,q);b.check.enable&&f.repairChkClass&&(f.repairChkClass(b,h),f.repairParentChkClassWithSelf(b,h),h!=c.parent&&f.repairParentChkClassWithSelf(b,
c));m||f.expandCollapseParentNode(b,c.getParentNode(),!0,e)}},removeChildNodes:function(b,a){if(a){var c=b.data.key.children,l=a[c];if(l){for(var e=0,m=l.length;e<m;e++)o.removeNodeCache(b,l[e]);o.removeSelectedNode(b);delete a[c];b.data.keep.parent?j("#"+a.tId+d.id.UL).empty():(a.isParent=!1,a.open=!1,c=j("#"+a.tId+d.id.SWITCH),l=j("#"+a.tId+d.id.ICON),f.replaceSwitchClass(a,c,d.folder.DOCU),f.replaceIcoClass(a,l,d.folder.DOCU),j("#"+a.tId+d.id.UL).remove())}}},removeEditBtn:function(b){j("#"+b.tId+
d.id.EDIT).unbind().remove()},removeNode:function(b,a){var c=o.getRoot(b),l=b.data.key.children,e=a.parentTId?a.getParentNode():c;if(c.curEditNode===a)c.curEditNode=null;a.isFirstNode=!1;a.isLastNode=!1;a.getPreNode=function(){return null};a.getNextNode=function(){return null};j("#"+a.tId).remove();o.removeNodeCache(b,a);o.removeSelectedNode(b,a);for(var m=0,i=e[l].length;m<i;m++)if(e[l][m].tId==a.tId){e[l].splice(m,1);break}var g;if(!b.data.keep.parent&&e[l].length<1)e.isParent=!1,e.open=!1,m=j("#"+
...
e.addClass(a)}}},event:p,data:{setSonNodeLevel:function(b,a,c){if(c){var d=b.data.key.children;c.level=a?a.level+1:0;if(c[d])for(var a=0,e=c[d].length;a<e;a++)c[d][a]&&o.setSonNodeLevel(b,c,c[d][a])}}}};j.extend(!0,j.fn.zTree.consts,{event:{DRAG:"ztree_drag",DROP:"ztree_drop",REMOVE:"ztree_remove",RENAME:"ztree_rename"},id:{EDIT:"_edit",INPUT:"_input",REMOVE:"_remove"},move:{TYPE_INNER:"inner",TYPE_PREV:"prev",TYPE_NEXT:"next"},node:{CURSELECTED_EDIT:"curSelectedNode_Edit",TMPTARGET_TREE:"tmpTargetzTree",
TMPTARGET_NODE:"tmpTargetNode"}});j.extend(!0,j.fn.zTree._z,p);var p=j.fn.zTree,h=p._z.tools,d=p.consts,f=p._z.view,o=p._z.data,p=p._z.event;o.exSetting({edit:{enable:!1,editNameSelectAll:!1,showRemoveBtn:!0,showRenameBtn:!0,removeTitle:"remove",renameTitle:"rename",drag:{autoExpandTrigger:!1,isCopy:!0,isMove:!0,prev:!0,next:!0,inner:!0,minMoveSize:5,borderMax:10,borderMin:-5,maxShowNodeNum:5,autoOpenTime:500}},view:{addHoverDom:null,removeHoverDom:null},callback:{beforeDrag:null,beforeDragOpen:null,
beforeDrop:null,beforeEditName:null,beforeRemove:null,beforeRename:null,onDrag:null,onDrop:null,onRemove:null,onRename:null}});o.addInitBind(function(b){var a=b.treeObj,c=d.event;a.unbind(c.RENAME);a.bind(c.RENAME,function(a,c,d){h.apply(b.callback.onRename,[a,c,d])});a.unbind(c.REMOVE);a.bind(c.REMOVE,function(a,c,d){h.apply(b.callback.onRemove,[a,c,d])});a.unbind(c.DRAG);a.bind(c.DRAG,function(a,c,d){h.apply(b.callback.onDrag,[a,c,d])});a.unbind(c.DROP);a.bind(c.DROP,function(a,c,d,f,g,j){h.apply(b.callback.onDrop,
...
"mousedown")&&(j=h.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+d.id.A}])))e=j.parentNode.id,i="mousedownNode";if(e.length>0)switch(m=o.getNodeCache(c,e),i){case "mousedownNode":g=C.onMousedownNode;break;case "hoverOverNode":g=C.onHoverOverNode;break;case "hoverOutNode":g=C.onHoverOutNode}return{stop:!1,node:m,nodeEventType:i,nodeEventCallback:g,treeEventType:"",treeEventCallback:null}});o.addInitRoot(function(b){b=o.getRoot(b);b.curEditNode=null;b.curEditInput=null;b.curHoverNode=null;b.dragFlag=
0;b.dragNodeShowBefore=[];b.dragMaskList=[];b.showHoverDom=!0});o.addZTreeTools(function(b,a){a.addNodes=function(a,d,e){function m(){f.addNodes(b,a,i,e==!0)}if(!d)return null;a||(a=null);if(a&&!a.isParent&&b.data.keep.leaf)return null;var i=h.clone(h.isArray(d)?d:[d]);b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,e,m):m();return i};a.cancelEditName=function(a){var d=o.getRoot(b),e=b.data.key.name,h=d.curEditNode;d.curEditNode&&f.cancelCurEditNode(b,a?a:h[e])};a.copyNode=function(a,l,e,j){if(!l)return null;
if(a&&!a.isParent&&b.data.keep.leaf&&e===d.move.TYPE_INNER)return null;var i=h.clone(l);if(!a)a=null,e=d.move.TYPE_INNER;e==d.move.TYPE_INNER?(l=function(){f.addNodes(b,a,[i],j)},b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,j,l):l()):(f.addNodes(b,a.parentNode,[i],j),f.moveNode(b,a,i,e,!1,j));return i};a.editName=function(a){a&&a.tId&&a===o.getNodeCache(b,a.tId)&&(a.parentTId&&f.expandCollapseParentNode(b,a.getParentNode(),!0),f.editNode(b,a))};a.moveNode=function(a,l,e,m){function i(){f.moveNode(b,
a,l,e,!1,m)}if(!l)return l;if(a&&!a.isParent&&b.data.keep.leaf&&e===d.move.TYPE_INNER)return null;else if(a&&(l.parentTId==a.tId&&e==d.move.TYPE_INNER||j("#"+l.tId).find("#"+a.tId).length>0))return null;else a||(a=null);b.async.enable&&h.canAsync(b,a)?f.asyncNode(b,a,m,i):i();return l};a.removeNode=function(a,l){a&&(l=!!l,l&&h.apply(b.callback.beforeRemove,[b.treeId,a],!0)==!1||(f.removeNode(b,a),l&&this.setting.treeObj.trigger(d.event.REMOVE,[b.treeId,a])))};a.removeChildNodes=function(a){if(!a)return null;
var d=a[b.data.key.children];f.removeChildNodes(b,a);return d?d:null};a.setEditable=function(a){b.edit.enable=a;return this.refresh()}});var H=f.cancelPreSelectedNode;f.cancelPreSelectedNode=function(b,a){for(var c=o.getRoot(b).curSelectedList,d=0,e=c.length;d<e;d++)if(!a||a===c[d])if(f.removeTreeDom(b,c[d]),a)break;H&&H.apply(f,arguments)};var I=f.createNodes;f.createNodes=function(b,a,c,d){I&&I.apply(f,arguments);c&&f.repairParentChkClassWithSelf&&f.repairParentChkClassWithSelf(b,d)};f.makeNodeUrl=
function(b,a){return a.url&&!b.edit.enable?a.url:null};var F=f.selectNode;f.selectNode=function(b,a,c){var d=o.getRoot(b);if(o.isSelectedNode(b,a)&&d.curEditNode==a&&a.editNameFlag)return!1;F&&F.apply(f,arguments);f.addHoverDom(b,a);return!0};var G=h.uCanDo;h.uCanDo=function(b,a){var c=o.getRoot(b);return a&&(h.eqs(a.type,"mouseover")||h.eqs(a.type,"mouseout")||h.eqs(a.type,"mousedown")||h.eqs(a.type,"mouseup"))?!0:!c.curEditNode&&(G?G.apply(f,arguments):!0)}})(jQuery);
