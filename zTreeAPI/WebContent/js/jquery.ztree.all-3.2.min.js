...
0){for(var A=b.target;A&&A.tagName&&!h.eqs(A.tagName,"li")&&A.id!=k.treeId;)A=A.parentNode;var L=!0;for(a=0,c=n.length;a<c;a++)if(e=n[a],A.id===e.tId){L=!1;break}else if(j("#"+e.tId).find("#"+A.id).length>0){L=!1;break}if(L&&b.target.id&&(b.target.id==A.id+d.id.A||j(b.target).parents("#"+A.id+d.id.A).length>0))r=j(A),s=A.id}e=n[0];if(p&&(b.target.id==k.treeId||j(b.target).parents("#"+k.treeId).length>0)){if(!r&&(b.target.id==k.treeId||E||F||P||Q)&&(v||!v&&e.parentTId))r=k.treeObj;i?k.treeObj.scrollTop(k.treeObj.scrollTop()-
10):q&&k.treeObj.scrollTop(k.treeObj.scrollTop()+10);H?k.treeObj.scrollLeft(k.treeObj.scrollLeft()-10):O&&k.treeObj.scrollLeft(k.treeObj.scrollLeft()+10);r&&r!=k.treeObj&&r.offset().left<k.treeObj.offset().left&&k.treeObj.scrollLeft(k.treeObj.scrollLeft()+r.offset().left-k.treeObj.offset().left)}C.css({top:b.clientY+B+3+"px",left:b.clientX+m+3+"px"});m=a=0;if(r&&r.attr("id")!=k.treeId){var y=s==null?null:o.getNodeCache(k,s);c=b.ctrlKey&&g.edit.drag.isMove&&g.edit.drag.isCopy||!g.edit.drag.isMove&&
g.edit.drag.isCopy;a=!!(D&&s===D.tId);i=!!(K&&s===K.tId);m=e.parentTId&&e.parentTId==s;e=(c||!i)&&h.apply(k.edit.drag.prev,[k.treeId,n,y],!!k.edit.drag.prev);a=(c||!a)&&h.apply(k.edit.drag.next,[k.treeId,n,y],!!k.edit.drag.next);i=(c||!m)&&!(k.data.keep.leaf&&!y.isParent)&&h.apply(k.edit.drag.inner,[k.treeId,n,y],!!k.edit.drag.inner);if(!e&&!a&&!i){if(r=null,s="",u=d.move.TYPE_INNER,t.css({display:"none"}),window.zTreeMoveTimer)clearTimeout(window.zTreeMoveTimer),window.zTreeMoveTargetNodeTId=null}else{c=
...
50),window.zTreeMoveTargetNodeTId=y.tId}}else if(u=d.move.TYPE_INNER,r&&h.apply(k.edit.drag.inner,[k.treeId,n,null],!!k.edit.drag.inner)?r.addClass(d.node.TMPTARGET_TREE):r=null,t.css({display:"none"}),window.zTreeMoveTimer)clearTimeout(window.zTreeMoveTimer),window.zTreeMoveTargetNodeTId=null;M=s;N=u}return!1}function l(b){if(window.zTreeMoveTimer)clearTimeout(window.zTreeMoveTimer),window.zTreeMoveTargetNodeTId=null;N=M=null;x.unbind("mousemove",c);x.unbind("mouseup",l);x.unbind("selectstart",e);
j("body").css("cursor","auto");r&&(r.removeClass(d.node.TMPTARGET_TREE),s&&j("#"+s+d.id.A,r).removeClass(d.node.TMPTARGET_NODE));h.showIfameMask(g,!1);z.showHoverDom=!0;if(z.dragFlag!=0){z.dragFlag=0;var a,m,i;for(a=0,m=n.length;a<m;a++)i=n[a],i.isParent&&z.dragNodeShowBefore[i.tId]&&!i.open&&(f.expandCollapseNode(g,i,!i.open),delete z.dragNodeShowBefore[i.tId]);C&&C.remove();t&&t.remove();var q=b.ctrlKey&&g.edit.drag.isMove&&g.edit.drag.isCopy||!g.edit.drag.isMove&&g.edit.drag.isCopy;!q&&r&&s&&n[0].parentTId&&
s==n[0].parentTId&&u==d.move.TYPE_INNER&&(r=null);if(r){var p=s==null?null:o.getNodeCache(k,s);if(h.apply(g.callback.beforeDrop,[k.treeId,n,p,u,q],!0)!=!1){var w=q?h.clone(n):n,b=function(){if(v){if(!q)for(var b=0,a=n.length;b<a;b++)f.removeNode(g,n[b]);if(u==d.move.TYPE_INNER)f.addNodes(k,p,w);else if(f.addNodes(k,p.getParentNode(),w),u==d.move.TYPE_PREV)for(b=0,a=w.length;b<a;b++)f.moveNode(k,p,w[b],u,!1);else for(b=-1,a=w.length-1;b<a;a--)f.moveNode(k,p,w[a],u,!1)}else if(q&&u==d.move.TYPE_INNER)f.addNodes(k,
p,w);else if(q&&f.addNodes(k,p.getParentNode(),w),u==d.move.TYPE_PREV)for(b=0,a=w.length;b<a;b++)f.moveNode(k,p,w[b],u,!1);else for(b=-1,a=w.length-1;b<a;a--)f.moveNode(k,p,w[a],u,!1);for(b=0,a=w.length;b<a;b++)f.selectNode(k,w[b],b>0);j("#"+w[0].tId+d.id.ICON).focus().blur()};u==d.move.TYPE_INNER&&h.canAsync(k,p)?f.asyncNode(k,p,!1,b):b();g.treeObj.trigger(d.event.DROP,[k.treeId,w,p,u,q])}}else{for(a=0,m=n.length;a<m;a++)f.selectNode(k,n[a],a>0);g.treeObj.trigger(d.event.DROP,[g.treeId,null,null,
null,null])}}}function e(){return!1}var m,i,g=o.getSetting(b.data.treeId),z=o.getRoot(g);if(b.button==2||!g.edit.enable||!g.edit.drag.isCopy&&!g.edit.drag.isMove)return!0;var p=b.target,q=o.getRoot(g).curSelectedList,n=[];if(o.isSelectedNode(g,a))for(m=0,i=q.length;m<i;m++){if(q[m].editNameFlag&&h.eqs(p.tagName,"input")&&p.getAttribute("treeNode"+d.id.INPUT)!==null)return!0;n.push(q[m]);if(n[0].parentTId!==q[m].parentTId){n=[a];break}}else n=[a];f.editNodeBlur=!0;f.cancelCurEditNode(g,null,!0);var x=
j(document),C,t,r,v=!1,k=g,D,K,M=null,N=null,s=null,u=d.move.TYPE_INNER,I=b.clientX,J=b.clientY,G=(new Date).getTime();h.uCanDo(g)&&x.bind("mousemove",c);x.bind("mouseup",l);x.bind("selectstart",e);b.preventDefault&&b.preventDefault();return!0}},v={tools:{getAbs:function(b){b=b.getBoundingClientRect();return[b.left,b.top]},inputFocus:function(b){b.get(0)&&(b.focus(),h.setCursorPosition(b.get(0),b.val().length))},inputSelect:function(b){b.get(0)&&(b.focus(),b.select())},setCursorPosition:function(b,
a){if(b.setSelectionRange)b.focus(),b.setSelectionRange(a,a);else if(b.createTextRange){var c=b.createTextRange();c.collapse(!0);c.moveEnd("character",a);c.moveStart("character",a);c.select()}},showIfameMask:function(b,a){for(var c=o.getRoot(b);c.dragMaskList.length>0;)c.dragMaskList[0].remove(),c.dragMaskList.shift();if(a)for(var d=j("iframe"),e=0,f=d.length;e<f;e++){var i=d.get(e),g=h.getAbs(i),i=j("<div id='zTreeMask_"+e+"' class='zTreeMask' style='background-color:yellow;opacity: 0.3;filter: alpha(opacity=30);    top:"+
...
" onfocus='this.blur();' style='display:none;'></button>";c.append(l);j("#"+a.tId+d.id.REMOVE).bind("click",function(){if(!h.uCanDo(b)||h.apply(b.callback.beforeRemove,[b.treeId,a],!0)==!1)return!0;f.removeNode(b,a);b.treeObj.trigger(d.event.REMOVE,[b.treeId,a]);return!1}).bind("mousedown",function(){return!0}).show()}},addHoverDom:function(b,a){if(o.getRoot(b).showHoverDom)a.isHover=!0,b.edit.enable&&(f.addEditBtn(b,a),f.addRemoveBtn(b,a)),h.apply(b.view.addHoverDom,[b.treeId,a])},cancelCurEditNode:function(b,
a){var c=o.getRoot(b),l=b.data.key.name,e=c.curEditNode;if(e){var m=c.curEditInput,i=a?a:m.val();if(!a&&h.apply(b.callback.beforeRename,[b.treeId,e,i],!0)===!1)return e.editNameFlag=!0,!1;else e[l]=i?i:m.val(),a||b.treeObj.trigger(d.event.RENAME,[b.treeId,e]);j("#"+e.tId+d.id.A).removeClass(d.node.CURSELECTED_EDIT);m.unbind();f.setNodeName(b,e);e.editNameFlag=!1;c.curEditNode=null;c.curEditInput=null;f.selectNode(b,e,!1)}return c.noSelection=!0},editNode:function(b,a){var c=o.getRoot(b);f.editNodeBlur=
!1;if(o.isSelectedNode(b,a)&&c.curEditNode==a&&a.editNameFlag)setTimeout(function(){h.inputFocus(c.curEditInput)},0);else{var l=b.data.key.name;a.editNameFlag=!0;f.removeTreeDom(b,a);f.cancelCurEditNode(b);f.selectNode(b,a,!1);j("#"+a.tId+d.id.SPAN).html("<input type=text class='rename' id='"+a.tId+d.id.INPUT+"' treeNode"+d.id.INPUT+" >");var e=j("#"+a.tId+d.id.INPUT);e.attr("value",a[l]);b.edit.editNameSelectAll?h.inputSelect(e):h.inputFocus(e);e.bind("blur",function(){f.editNodeBlur||f.cancelCurEditNode(b)}).bind("keydown",
function(c){c.keyCode=="13"?(f.editNodeBlur=!0,f.cancelCurEditNode(b,null,!0)):c.keyCode=="27"&&f.cancelCurEditNode(b,a[l])}).bind("click",function(){return!1}).bind("dblclick",function(){return!1});j("#"+a.tId+d.id.A).addClass(d.node.CURSELECTED_EDIT);c.curEditInput=e;c.noSelection=!1;c.curEditNode=a}},moveNode:function(b,a,c,l,e,m){var i=o.getRoot(b),g=b.data.key.children;if(a!=c&&(!b.data.keep.leaf||!a||a.isParent||l!=d.move.TYPE_INNER)){var h=c.parentTId?c.getParentNode():i,p=a===null||a==i;p&&
a===null&&(a=i);if(p)l=d.move.TYPE_INNER;i=a.parentTId?a.getParentNode():i;if(l!=d.move.TYPE_PREV&&l!=d.move.TYPE_NEXT)l=d.move.TYPE_INNER;if(l==d.move.TYPE_INNER)if(p)c.parentTId=null;else{if(!a.isParent)a.isParent=!0,a.open=!!a.open,f.setNodeLineIcos(b,a);c.parentTId=a.tId}var q;p?q=p=b.treeObj:(!m&&l==d.move.TYPE_INNER?f.expandCollapseNode(b,a,!0,!1):m||f.expandCollapseNode(b,a.getParentNode(),!0,!1),p=j("#"+a.tId),q=j("#"+a.tId+d.id.UL),q.get(0)||(q=[],f.makeUlHtml(b,a,q,""),p.append(q.join(""))),
q=j("#"+a.tId+d.id.UL));var n=j("#"+c.tId);q.get(0)&&l==d.move.TYPE_INNER?q.append(n):p.get(0)&&l==d.move.TYPE_PREV?p.before(n):p.get(0)&&l==d.move.TYPE_NEXT&&p.after(n);var x=-1,v=0,t=null,p=null,r=c.level;if(c.isFirstNode){if(x=0,h[g].length>1)t=h[g][1],t.isFirstNode=!0}else if(c.isLastNode)x=h[g].length-1,t=h[g][x-1],t.isLastNode=!0;else for(q=0,n=h[g].length;q<n;q++)if(h[g][q].tId==c.tId){x=q;break}x>=0&&h[g].splice(x,1);if(l!=d.move.TYPE_INNER)for(q=0,n=i[g].length;q<n;q++)i[g][q].tId==a.tId&&
(v=q);if(l==d.move.TYPE_INNER){a[g]||(a[g]=[]);if(a[g].length>0)p=a[g][a[g].length-1],p.isLastNode=!1;a[g].splice(a[g].length,0,c);c.isLastNode=!0;c.isFirstNode=a[g].length==1}else a.isFirstNode&&l==d.move.TYPE_PREV?(i[g].splice(v,0,c),p=a,p.isFirstNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!0,c.isLastNode=!1):a.isLastNode&&l==d.move.TYPE_NEXT?(i[g].splice(v+1,0,c),p=a,p.isLastNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!0):(l==d.move.TYPE_PREV?i[g].splice(v,0,c):i[g].splice(v+
1,0,c),c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!1);o.fixPIdKeyValue(b,c);o.setSonNodeLevel(b,c.getParentNode(),c);f.setNodeLineIcos(b,c);f.repairNodeLevelClass(b,c,r);!b.data.keep.parent&&h[g].length<1?(h.isParent=!1,h.open=!1,a=j("#"+h.tId+d.id.UL),l=j("#"+h.tId+d.id.SWITCH),g=j("#"+h.tId+d.id.ICON),f.replaceSwitchClass(h,l,d.folder.DOCU),f.replaceIcoClass(h,g,d.folder.DOCU),a.css("display","none")):t&&f.setNodeLineIcos(b,t);p&&f.setNodeLineIcos(b,p);b.check.enable&&f.repairChkClass&&
(f.repairChkClass(b,h),f.repairParentChkClassWithSelf(b,h),h!=c.parent&&f.repairParentChkClassWithSelf(b,c));m||f.expandCollapseParentNode(b,c.getParentNode(),!0,e)}},removeChildNodes:function(b,a){if(a){var c=b.data.key.children,l=a[c];if(l){for(var e=0,m=l.length;e<m;e++)o.removeNodeCache(b,l[e]);o.removeSelectedNode(b);delete a[c];b.data.keep.parent?j("#"+a.tId+d.id.UL).empty():(a.isParent=!1,a.open=!1,c=j("#"+a.tId+d.id.SWITCH),l=j("#"+a.tId+d.id.ICON),f.replaceSwitchClass(a,c,d.folder.DOCU),
f.replaceIcoClass(a,l,d.folder.DOCU),j("#"+a.tId+d.id.UL).remove())}}},removeEditBtn:function(b){j("#"+b.tId+d.id.EDIT).unbind().remove()},removeNode:function(b,a){var c=o.getRoot(b),l=b.data.key.children,e=a.parentTId?a.getParentNode():c;if(c.curEditNode===a)c.curEditNode=null;a.isFirstNode=!1;a.isLastNode=!1;a.getPreNode=function(){return null};a.getNextNode=function(){return null};j("#"+a.tId).remove();o.removeNodeCache(b,a);o.removeSelectedNode(b,a);for(var m=0,i=e[l].length;m<i;m++)if(e[l][m].tId==
...
TYPE_PREV:"prev",TYPE_NEXT:"next"},node:{CURSELECTED_EDIT:"curSelectedNode_Edit",TMPTARGET_TREE:"tmpTargetzTree",TMPTARGET_NODE:"tmpTargetNode"}});j.extend(!0,j.fn.zTree._z,v);var v=j.fn.zTree,h=v._z.tools,d=v.consts,f=v._z.view,o=v._z.data,v=v._z.event;o.exSetting({edit:{enable:!1,editNameSelectAll:!1,showRemoveBtn:!0,showRenameBtn:!0,removeTitle:"remove",renameTitle:"rename",drag:{autoExpandTrigger:!1,isCopy:!0,isMove:!0,prev:!0,next:!0,inner:!0,minMoveSize:5,borderMax:10,borderMin:-5,maxShowNodeNum:5,
...
[b.treeId,a])))};a.removeChildNodes=function(a){if(!a)return null;var d=a[b.data.key.children];f.removeChildNodes(b,a);return d?d:null};a.setEditable=function(a){b.edit.enable=a;return this.refresh()}});var I=f.cancelPreSelectedNode;f.cancelPreSelectedNode=function(b,a){for(var c=o.getRoot(b).curSelectedList,d=0,e=c.length;d<e;d++)if(!a||a===c[d])if(f.removeTreeDom(b,c[d]),a)break;I&&I.apply(f,arguments)};var J=f.createNodes;f.createNodes=function(b,a,c,d){J&&J.apply(f,arguments);c&&f.repairParentChkClassWithSelf&&
f.repairParentChkClassWithSelf(b,d)};f.makeNodeUrl=function(b,a){return a.url&&!b.edit.enable?a.url:null};var G=f.selectNode;f.selectNode=function(b,a,c){var d=o.getRoot(b);if(o.isSelectedNode(b,a)&&d.curEditNode==a&&a.editNameFlag)return!1;G&&G.apply(f,arguments);f.addHoverDom(b,a);return!0};var H=h.uCanDo;h.uCanDo=function(b,a){var c=o.getRoot(b);return a&&(h.eqs(a.type,"mouseover")||h.eqs(a.type,"mouseout")||h.eqs(a.type,"mousedown")||h.eqs(a.type,"mouseup"))?!0:!c.curEditNode&&(H?H.apply(f,arguments):
!0)}})(jQuery);
