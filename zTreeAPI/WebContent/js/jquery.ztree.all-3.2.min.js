...
a){var c=[],d=l("#"+a.tId),f=l("#"+a.tId+e.id.UL),g=h.appendNodes(b,a.level+1,a[b.data.key.children],a,!1,!0);h.makeUlHtml(b,a,c,g.join(""));!d.get(0)&&a.parentTId&&(h.appendParentULDom(b,a.getParentNode()),d=l("#"+a.tId));f.get(0)&&f.remove();d.append(c.join(""))},asyncNode:function(b,a,c,d){var f,g;if(a&&!a.isParent)return j.apply(d),!1;else if(a&&a.isAjaxing)return!1;else if(j.apply(b.callback.beforeAsync,[b.treeId,a],!0)==!1)return j.apply(d),!1;if(a)a.isAjaxing=!0,l("#"+a.tId+e.id.ICON).attr({style:"",
"class":"button ico_loading"});var k=b.async.contentType=="application/json",i=k?"{":"",n="";for(f=0,g=b.async.autoParam.length;a&&f<g;f++){var m=b.async.autoParam[f].split("="),o=m;m.length>1&&(o=m[1],m=m[0]);k?(n=typeof a[m]=="string"?'"':"",i+='"'+o+('":'+n+a[m]).replace(/'/g,"\\'")+n+","):i+=o+("="+a[m]).replace(/&/g,"%26")+"&"}if(j.isArray(b.async.otherParam))for(f=0,g=b.async.otherParam.length;f<g;f+=2)k?(n=typeof b.async.otherParam[f+1]=="string"?'"':"",i+='"'+b.async.otherParam[f]+('":'+n+
b.async.otherParam[f+1]).replace(/'/g,"\\'")+n+","):i+=b.async.otherParam[f]+("="+b.async.otherParam[f+1]).replace(/&/g,"%26")+"&";else for(var p in b.async.otherParam)k?(n=typeof b.async.otherParam[p]=="string"?'"':"",i+='"'+p+('":'+n+b.async.otherParam[p]).replace(/'/g,"\\'")+n+","):i+=p+("="+b.async.otherParam[p]).replace(/&/g,"%26")+"&";i.length>1&&(i=i.substring(0,i.length-1));k&&(i+="}");l.ajax({contentType:b.async.contentType,type:b.async.type,url:j.apply(b.async.url,[b.treeId,a],b.async.url),
data:i,dataType:b.async.dataType,success:function(f){var g=[];try{g=!f||f.length==0?[]:typeof f=="string"?eval("("+f+")"):f}catch(k){}if(a)a.isAjaxing=null,a.zAsync=!0;h.setNodeLineIcos(b,a);g&&g!==""?(g=j.apply(b.async.dataFilter,[b.treeId,a,g],g),h.addNodes(b,a,g?j.clone(g):[],!!c)):h.addNodes(b,a,[],!!c);b.treeObj.trigger(e.event.ASYNC_SUCCESS,[b.treeId,a,f]);j.apply(d)},error:function(c,d,f){if(a)a.isAjaxing=null;h.setNodeLineIcos(b,a);b.treeObj.trigger(e.event.ASYNC_ERROR,[b.treeId,a,c,d,f])}});
...
makeDOMNodeNameAfter:function(b){b.push("</a>")},makeDOMNodeNameBefore:function(b,a,c){var d=i.getTitleKey(a),f=h.makeNodeUrl(a,c),g=h.makeNodeFontCss(a,c),k=[],l;for(l in g)k.push(l,":",g[l],";");b.push("<a id='",c.tId,e.id.A,"' class='level",c.level,"' treeNode",e.id.A,' onclick="',c.click||"",'" ',f!=null&&f.length>0?"href='"+f+"'":""," target='",h.makeNodeTarget(c),"' style='",k.join(""),"'");j.apply(a.view.showTitle,[a.treeId,c],a.view.showTitle)&&c[d]&&b.push("title='",c[d].replace(/'/g,"&#39;").replace(/</g,
...
a){if(a){var c=b.data.key.children,d=a[c];if(d){for(var f=0,g=d.length;f<g;f++)i.removeNodeCache(b,d[f]);i.removeSelectedNode(b);delete a[c];b.data.keep.parent?l("#"+a.tId+e.id.UL).empty():(a.isParent=!1,a.open=!1,c=l("#"+a.tId+e.id.SWITCH),d=l("#"+a.tId+e.id.ICON),h.replaceSwitchClass(a,c,e.folder.DOCU),h.replaceIcoClass(a,d,e.folder.DOCU),l("#"+a.tId+e.id.UL).remove())}}},setFirstNode:function(b,a){var c=b.data.key.children;if(a[c].length>0)a[c][0].isFirstNode=!0},setLastNode:function(b,a){var c=
b.data.key.children,d=a[c].length;if(d>0)a[c][d-1].isLastNode=!0},removeNode:function(b,a){var c=i.getRoot(b),d=b.data.key.children,f=a.parentTId?a.getParentNode():c;a.isFirstNode=!1;a.isLastNode=!1;a.getPreNode=function(){return null};a.getNextNode=function(){return null};l("#"+a.tId).remove();i.removeNodeCache(b,a);i.removeSelectedNode(b,a);for(var g=0,k=f[d].length;g<k;g++)if(f[d][g].tId==a.tId){f[d].splice(g,1);break}h.setFirstNode(b,f);h.setLastNode(b,f);var j,g=f[d].length;if(!b.data.keep.parent&&
g==0)f.isParent=!1,f.open=!1,g=l("#"+f.tId+e.id.UL),k=l("#"+f.tId+e.id.SWITCH),j=l("#"+f.tId+e.id.ICON),h.replaceSwitchClass(f,k,e.folder.DOCU),h.replaceIcoClass(f,j,e.folder.DOCU),g.css("display","none");else if(b.view.showLine&&g>0){var n=f[d][g-1],g=l("#"+n.tId+e.id.UL),k=l("#"+n.tId+e.id.SWITCH);j=l("#"+n.tId+e.id.ICON);f==c?f[d].length==1?h.replaceSwitchClass(n,k,e.line.ROOT):(c=l("#"+f[d][0].tId+e.id.SWITCH),h.replaceSwitchClass(f[d][0],c,e.line.ROOTS),h.replaceSwitchClass(n,k,e.line.BOTTOM)):
h.replaceSwitchClass(n,k,e.line.BOTTOM);g.removeClass(e.line.LINE)}},replaceIcoClass:function(b,a,c){if(a&&!b.isAjaxing&&(b=a.attr("class"),b!=void 0)){b=b.split("_");switch(c){case e.folder.OPEN:case e.folder.CLOSE:case e.folder.DOCU:b[b.length-1]=c}a.attr("class",b.join("_"))}},replaceSwitchClass:function(b,a,c){if(a){var d=a.attr("class");if(d!=void 0){d=d.split("_");switch(c){case e.line.ROOT:case e.line.ROOTS:case e.line.CENTER:case e.line.BOTTOM:case e.line.NOLINE:d[0]=h.makeNodeLineClassEx(b)+
c;break;case e.folder.OPEN:case e.folder.CLOSE:case e.folder.DOCU:d[1]=c}a.attr("class",d.join("_"));c!==e.folder.DOCU?a.removeAttr("disabled"):a.attr("disabled","disabled")}}},selectNode:function(b,a,c){c||h.cancelPreSelectedNode(b);l("#"+a.tId+e.id.A).addClass(e.node.CURSELECTED);i.addSelectedNode(b,a)},setNodeFontCss:function(b,a){var c=l("#"+a.tId+e.id.A),d=h.makeNodeFontCss(b,a);d&&c.css(d)},setNodeLineIcos:function(b,a){if(a){var c=l("#"+a.tId+e.id.SWITCH),d=l("#"+a.tId+e.id.UL),f=l("#"+a.tId+
e.id.ICON),g=h.makeUlLineClass(b,a);g.length==0?d.removeClass(e.line.LINE):d.addClass(g);c.attr("class",h.makeNodeLineClass(b,a));a.isParent?c.removeAttr("disabled"):c.attr("disabled","disabled");f.removeAttr("style");f.attr("style",h.makeNodeIcoStyle(b,a));f.attr("class",h.makeNodeIcoClass(b,a))}},setNodeName:function(b,a){var c=b.data.key.name,d=i.getTitleKey(b),f=l("#"+a.tId+e.id.SPAN);f.empty();b.view.nameIsHTML?f.html(a[c]):f.text(a[c]);j.apply(b.view.showTitle,[b.treeId,a],b.view.showTitle)&&
l("#"+a.tId+e.id.A).attr("title",!a[d]?"":a[d])},setNodeTarget:function(b){l("#"+b.tId+e.id.A).attr("target",h.makeNodeTarget(b))},setNodeUrl:function(b,a){var c=l("#"+a.tId+e.id.A),d=h.makeNodeUrl(b,a);d==null||d.length==0?c.removeAttr("href"):c.attr("href",d)},switchNode:function(b,a){a.open||!j.canAsync(b,a)?h.expandCollapseNode(b,a,!a.open):b.async.enable?h.asyncNode(b,a)||h.expandCollapseNode(b,a,!a.open):a&&h.expandCollapseNode(b,a,!a.open)}};l.fn.zTree={consts:{event:{NODECREATED:"ztree_nodeCreated",
CLICK:"ztree_click",EXPAND:"ztree_expand",COLLAPSE:"ztree_collapse",ASYNC_SUCCESS:"ztree_async_success",ASYNC_ERROR:"ztree_async_error"},id:{A:"_a",ICON:"_ico",SPAN:"_span",SWITCH:"_switch",UL:"_ul"},line:{ROOT:"root",ROOTS:"roots",CENTER:"center",BOTTOM:"bottom",NOLINE:"noline",LINE:"line"},folder:{OPEN:"open",CLOSE:"close",DOCU:"docu"},node:{CURSELECTED:"curSelectedNode"}},_z:{tools:j,view:h,event:m,data:i},getZTreeObj:function(b){return(b=i.getZTreeTools(b))?b:null},init:function(b,a,c){var d=
j.clone(I);l.extend(!0,d,a);d.treeId=b.attr("id");d.treeObj=b;d.treeObj.empty();p[d.treeId]=d;if(l.browser.msie&&parseInt(l.browser.version)<7)d.view.expandSpeed="";i.initRoot(d);b=i.getRoot(d);a=d.data.key.children;c=c?j.clone(j.isArray(c)?c:[c]):[];b[a]=d.data.simpleData.enable?i.transformTozTreeFormat(d,c):c;i.initCache(d);m.bindTree(d);m.bindEvent(d);c={setting:d,addNodes:function(a,b,c){function e(){h.addNodes(d,a,i,c==!0)}if(!b)return null;a||(a=null);if(a&&!a.isParent&&d.data.keep.leaf)return null;
...
a)},transformToArray:function(a){return i.transformToArrayFormat(this.setting,a)},updateNode:function(a){a&&l("#"+a.tId).get(0)&&j.uCanDo(this.setting)&&(h.setNodeName(this.setting,a),h.setNodeTarget(a),h.setNodeUrl(this.setting,a),h.setNodeLineIcos(this.setting,a),h.setNodeFontCss(this.setting,a))}};b.treeTools=c;i.setZTreeTools(d,c);b[a]&&b[a].length>0?h.createNodes(d,0,b[a]):d.async.enable&&d.async.url&&d.async.url!==""&&h.asyncNode(d);return c}};var J=l.fn.zTree,e=J.consts})(jQuery);
 ...
 * Date: 2012-07-15
 */
(function(i){i.extend(!0,i.fn.zTree._z,{tools:{},view:{clearOldFirstNode:function(c,b){for(var a=b.getNextNode();a;){if(a.isFirstNode){a.isFirstNode=!1;f.setNodeLineIcos(c,a);break}if(a.isLastNode)break;a=a.getNextNode()}},clearOldLastNode:function(c,b){for(var a=b.getPreNode();a;){if(a.isLastNode){a.isLastNode=!1;f.setNodeLineIcos(c,a);break}if(a.isFirstNode)break;a=a.getPreNode()}},makeDOMNodeMainBefore:function(c,b,a){c.push("<li ",a.isHidden?"style='display:none;' ":"","id='",a.tId,"' class='level",
a.level,"' tabindex='0' hidefocus='true' treenode>")},showNode:function(c,b){b.isHidden=!1;e.initShowForExCheck(c,b);i("#"+b.tId).show()},showNodes:function(c,b,a){if(b&&b.length!=0){var d={},g,j;for(g=0,j=b.length;g<j;g++){var h=b[g];if(!d[h.parentTId]){var i=h.getParentNode();d[h.parentTId]=i===null?e.getRoot(c):h.getParentNode()}f.showNode(c,h,a)}for(var k in d)b=d[k][c.data.key.children],f.setFirstNodeForShow(c,b),f.setLastNodeForShow(c,b)}},hideNode:function(c,b){b.isHidden=!0;b.isFirstNode=
!1;b.isLastNode=!1;e.initHideForExCheck(c,b);i("#"+b.tId).hide()},hideNodes:function(c,b,a){if(b&&b.length!=0){var d={},g,j;for(g=0,j=b.length;g<j;g++){var h=b[g];if((h.isFirstNode||h.isLastNode)&&!d[h.parentTId]){var i=h.getParentNode();d[h.parentTId]=i===null?e.getRoot(c):h.getParentNode()}f.hideNode(c,h,a)}for(var k in d)b=d[k][c.data.key.children],f.setFirstNodeForHide(c,b),f.setLastNodeForHide(c,b)}},setFirstNode:function(c,b){var a=c.data.key.children,d=b[a].length;d>0&&!b[a][0].isHidden?b[a][0].isFirstNode=
!0:d>0&&f.setFirstNodeForHide(c,b[a])},setLastNode:function(c,b){var a=c.data.key.children,d=b[a].length;d>0&&!b[a][0].isHidden?b[a][d-1].isLastNode=!0:d>0&&f.setLastNodeForHide(c,b[a])},setFirstNodeForHide:function(c,b){var a,d,g;for(d=0,g=b.length;d<g;d++){a=b[d];if(a.isFirstNode)break;if(!a.isHidden&&!a.isFirstNode){a.isFirstNode=!0;f.setNodeLineIcos(c,a);break}else a=null}return a},setFirstNodeForShow:function(c,b){var a,d,g,e,h;for(d=0,g=b.length;d<g;d++)if(a=b[d],!e&&!a.isHidden&&a.isFirstNode){e=
a;break}else if(!e&&!a.isHidden&&!a.isFirstNode)a.isFirstNode=!0,e=a,f.setNodeLineIcos(c,a);else if(e&&a.isFirstNode){a.isFirstNode=!1;h=a;f.setNodeLineIcos(c,a);break}return{"new":e,old:h}},setLastNodeForHide:function(c,b){var a,d;for(d=b.length-1;d>=0;d--){a=b[d];if(a.isLastNode)break;if(!a.isHidden&&!a.isLastNode){a.isLastNode=!0;f.setNodeLineIcos(c,a);break}else a=null}return a},setLastNodeForShow:function(c,b){var a,d,e,j;for(d=b.length-1;d>=0;d--)if(a=b[d],!e&&!a.isHidden&&a.isLastNode){e=a;
break}else if(!e&&!a.isHidden&&!a.isLastNode)a.isLastNode=!0,e=a,f.setNodeLineIcos(c,a);else if(e&&a.isLastNode){a.isLastNode=!1;j=a;f.setNodeLineIcos(c,a);break}return{"new":e,old:j}}},event:{},data:{initHideForExCheck:function(c,b){if(b.isHidden&&c.check.enable)b._nocheck=!!b.nocheck,b.nocheck=!0,f.repairParentChkClassWithSelf&&f.repairParentChkClassWithSelf(c,b)},initShowForExCheck:function(c,b){if(!b.isHidden&&c.check.enable){b.nocheck=b._nocheck;delete b._nocheck;if(f.setChkClass){var a=i("#"+
b.tId+m.id.CHECK);f.setChkClass(c,a,b)}f.repairParentChkClassWithSelf&&f.repairParentChkClassWithSelf(c,b)}}}});var k=i.fn.zTree,n=k._z.tools,m=k.consts,f=k._z.view,e=k._z.data;e.addInitNode(function(c,b,a){if(typeof a.isHidden=="string")a.isHidden=n.eqs(a.isHidden,"true");a.isHidden=!!a.isHidden;e.initHideForExCheck(c,a)});e.addBeforeA(function(){});e.addZTreeTools(function(c,b){b.showNodes=function(a,b){f.showNodes(c,a,b)};b.showNode=function(a,b){a&&f.showNodes(c,[a],b)};b.hideNodes=function(a,
b){f.hideNodes(c,a,b)};b.hideNode=function(a,b){a&&f.hideNodes(c,[a],b)}});var l=e.initNode;e.tmpHideParent=-1;e.initNode=function(c,b,a,d,g,j,h){if(e.tmpHideParent!==d){e.tmpHideParent=d;var i=(d?d:e.getRoot(c))[c.data.key.children];e.tmpHideFirstNode=f.setFirstNodeForHide(c,i);e.tmpHideLastNode=f.setLastNodeForHide(c,i);f.setNodeLineIcos(c,e.tmpHideFirstNode);f.setNodeLineIcos(c,e.tmpHideLastNode)}g=e.tmpHideFirstNode===a;j=e.tmpHideLastNode===a;l&&l.apply(e,arguments);j&&f.clearOldLastNode(c,a)}})(jQuery);
