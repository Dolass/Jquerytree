...
dataFilter:null},callback:{beforeAsync:null,beforeClick:null,beforeRightClick:null,beforeMouseDown:null,beforeMouseUp:null,beforeExpand:null,beforeCollapse:null,beforeRemove:null,onAsyncError:null,onAsyncSuccess:null,onNodeCreated:null,onClick:null,onRightClick:null,onMouseDown:null,onMouseUp:null,onExpand:null,onCollapse:null,onRemove:null}},s=[function(b){var a=b.treeObj,c=f.event;a.unbind(c.NODECREATED);a.bind(c.NODECREATED,function(a,c,g){k.apply(b.callback.onNodeCreated,[a,c,g])});a.unbind(c.CLICK);
...
a},addAfterA:function(b){z.push(b)},addBeforeA:function(b){y.push(b)},addInnerAfterA:function(b){B.push(b)},addInnerBeforeA:function(b){A.push(b)},addInitBind:function(b){s.push(b)},addInitCache:function(b){q.push(b)},addInitNode:function(b){v.push(b)},addInitProxy:function(b){w.push(b)},addInitRoot:function(b){x.push(b)},addNodesData:function(b,a,c){var d=b.data.key.children;a[d]||(a[d]=[]);if(a[d].length>0)a[d][a[d].length-1].isLastNode=!1,i.setNodeLineIcos(b,a[d][a[d].length-1]);a.isParent=!0;
...
0,e=z.length;d<e;d++)z[d].apply(this,arguments)},getBeforeA:function(b,a,c){for(var d=0,e=y.length;d<e;d++)y[d].apply(this,arguments)},getInnerAfterA:function(b,a,c){for(var d=0,e=B.length;d<e;d++)B[d].apply(this,arguments)},getInnerBeforeA:function(b,a,c){for(var d=0,e=A.length;d<e;d++)A[d].apply(this,arguments)},getCache:function(b){return r[b.treeId]},getNextNode:function(b,a){if(!a)return null;var c=b.data.key.children,d=a.parentTId?a.getParentNode():h.getRoot(b);if(!a.isLastNode)if(a.isFirstNode)return d[c][1];
...
m=b.data.key.name,n=h.getTitleKey(b),p=0,N=c.length;p<N;p++){var o=c[p];if(e){var u=(d?d:h.getRoot(b))[l].length==c.length&&p==0;h.initNode(b,a,o,d,u,p==c.length-1,g);h.addNodeCache(b,o)}u=[];o[l]&&o[l].length>0&&(u=i.appendNodes(b,a+1,o[l],o,e,g&&o.open));if(g){var t=i.makeNodeUrl(b,o),r=i.makeNodeFontCss(b,o),s=[],q;for(q in r)s.push(q,":",r[q],";");j.push("<li id='",o.tId,"' class='level",o.level,"' tabindex='0' hidefocus='true' treenode>","<span id='",o.tId,f.id.SWITCH,"' title='' class='",i.makeNodeLineClass(b,
o),"' treeNode",f.id.SWITCH,"></span>");h.getBeforeA(b,o,j);j.push("<a id='",o.tId,f.id.A,"' class='level",o.level,"' treeNode",f.id.A,' onclick="',o.click||"",'" ',t!=null&&t.length>0?"href='"+t+"'":""," target='",i.makeNodeTarget(o),"' style='",s.join(""),"'");k.apply(b.view.showTitle,[b.treeId,o],b.view.showTitle)&&o[n]&&j.push("title='",o[n].replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),"'");j.push(">");h.getInnerBeforeA(b,o,j);t=b.view.nameIsHTML?o[m]:o[m].replace(/&/g,"&amp;").replace(/</g,
"&lt;").replace(/>/g,"&gt;");j.push("<span id='",o.tId,f.id.ICON,"' title='' treeNode",f.id.ICON," class='",i.makeNodeIcoClass(b,o),"' style='",i.makeNodeIcoStyle(b,o),"'></span><span id='",o.tId,f.id.SPAN,"'>",t,"</span>");h.getInnerAfterA(b,o,j);j.push("</a>");h.getAfterA(b,o,j);o.isParent&&o.open&&i.makeUlHtml(b,o,j,u.join(""));j.push("</li>");h.addCreatedNode(b,o)}}return j},appendParentULDom:function(b,a){var c=[],d=l("#"+a.tId),e=l("#"+a.tId+f.id.UL),g=i.appendNodes(b,a.level+1,a[b.data.key.children],
a,!1,!0);i.makeUlHtml(b,a,c,g.join(""));!d.get(0)&&a.parentTId&&(i.appendParentULDom(b,a.getParentNode()),d=l("#"+a.tId));e.get(0)&&e.remove();d.append(c.join(""))},asyncNode:function(b,a,c,d){var e,g;if(a&&!a.isParent)return k.apply(d),!1;else if(a&&a.isAjaxing)return!1;else if(k.apply(b.callback.beforeAsync,[b.treeId,a],!0)==!1)return k.apply(d),!1;if(a)a.isAjaxing=!0,l("#"+a.tId+f.id.ICON).attr({style:"","class":"button ico_loading"});var j=b.async.contentType=="application/json",h=j?"{":"",m=
"";for(e=0,g=b.async.autoParam.length;a&&e<g;e++){var n=b.async.autoParam[e].split("="),p=n;n.length>1&&(p=n[1],n=n[0]);j?(m=typeof a[n]=="string"?'"':"",h+='"'+p+('":'+m+a[n]).replace(/'/g,"\\'")+m+","):h+=p+("="+a[n]).replace(/&/g,"%26")+"&"}if(k.isArray(b.async.otherParam))for(e=0,g=b.async.otherParam.length;e<g;e+=2)j?(m=typeof b.async.otherParam[e+1]=="string"?'"':"",h+='"'+b.async.otherParam[e]+('":'+m+b.async.otherParam[e+1]).replace(/'/g,"\\'")+m+","):h+=b.async.otherParam[e]+("="+b.async.otherParam[e+
1]).replace(/&/g,"%26")+"&";else for(var q in b.async.otherParam)j?(m=typeof b.async.otherParam[q]=="string"?'"':"",h+='"'+q+('":'+m+b.async.otherParam[q]).replace(/'/g,"\\'")+m+","):h+=q+("="+b.async.otherParam[q]).replace(/&/g,"%26")+"&";h.length>1&&(h=h.substring(0,h.length-1));j&&(h+="}");l.ajax({contentType:b.async.contentType,type:b.async.type,url:k.apply(b.async.url,[b.treeId,a],b.async.url),data:h,dataType:b.async.dataType,success:function(e){var g=[];try{g=!e||e.length==0?[]:typeof e=="string"?
eval("("+e+")"):e}catch(j){}if(a)a.isAjaxing=null,a.zAsync=!0;i.setNodeLineIcos(b,a);g&&g!==""?(g=k.apply(b.async.dataFilter,[b.treeId,a,g],g),i.addNodes(b,a,g?k.clone(g):[],!!c)):i.addNodes(b,a,[],!!c);b.treeObj.trigger(f.event.ASYNC_SUCCESS,[b.treeId,a,e]);k.apply(d)},error:function(c,d,e){if(a)a.isAjaxing=null;i.setNodeLineIcos(b,a);b.treeObj.trigger(f.event.ASYNC_ERROR,[b.treeId,a,c,d,e])}});return!0},cancelPreSelectedNode:function(b,a){for(var c=h.getRoot(b).curSelectedList,d=c.length-1;d>=0;d--)if(!a||
a===c[d])if(l("#"+c[d].tId+f.id.A).removeClass(f.node.CURSELECTED),i.setNodeName(b,c[d]),a){h.removeSelectedNode(b,a);break}if(!a)h.getRoot(b).curSelectedList=[]},createNodeCallback:function(b){if(b.callback.onNodeCreated||b.view.addDiyDom)for(var a=h.getRoot(b);a.createdNodes.length>0;){var c=a.createdNodes.shift();k.apply(b.view.addDiyDom,[b.treeId,c]);b.callback.onNodeCreated&&b.treeObj.trigger(f.event.NODECREATED,[b.treeId,c])}},createNodes:function(b,a,c,d){if(c&&c.length!=0){var e=h.getRoot(b),
g=b.data.key.children,g=!d||d.open||!!l("#"+d[g][0].tId).get(0);e.createdNodes=[];a=i.appendNodes(b,a,c,d,!0,g);d?(d=l("#"+d.tId+f.id.UL),d.get(0)&&d.append(a.join(""))):b.treeObj.append(a.join(""));i.createNodeCallback(b)}},expandCollapseNode:function(b,a,c,d,e){var g=h.getRoot(b),j=b.data.key.children;if(a){if(g.expandTriggerFlag){var n=e,e=function(){n&&n();a.open?b.treeObj.trigger(f.event.EXPAND,[b.treeId,a]):b.treeObj.trigger(f.event.COLLAPSE,[b.treeId,a])};g.expandTriggerFlag=!1}if(a.open==
c)k.apply(e,[]);else{if(!a.open&&a.isParent&&(!l("#"+a.tId+f.id.UL).get(0)||a[j]&&a[j].length>0&&!l("#"+a[j][0].tId).get(0)))i.appendParentULDom(b,a),i.createNodeCallback(b);var c=l("#"+a.tId+f.id.UL),g=l("#"+a.tId+f.id.SWITCH),m=l("#"+a.tId+f.id.ICON);a.isParent?(a.open=!a.open,a.iconOpen&&a.iconClose&&m.attr("style",i.makeNodeIcoStyle(b,a)),a.open?(i.replaceSwitchClass(a,g,f.folder.OPEN),i.replaceIcoClass(a,m,f.folder.OPEN),d==!1||b.view.expandSpeed==""?(c.show(),k.apply(e,[])):a[j]&&a[j].length>
0?c.slideDown(b.view.expandSpeed,e):(c.show(),k.apply(e,[]))):(i.replaceSwitchClass(a,g,f.folder.CLOSE),i.replaceIcoClass(a,m,f.folder.CLOSE),d==!1||b.view.expandSpeed==""||!(a[j]&&a[j].length>0)?(c.hide(),k.apply(e,[])):c.slideUp(b.view.expandSpeed,e))):k.apply(e,[])}}else k.apply(e,[])},expandCollapseParentNode:function(b,a,c,d,e){a&&(a.parentTId?(i.expandCollapseNode(b,a,c,d),a.parentTId&&i.expandCollapseParentNode(b,a.getParentNode(),c,d,e)):i.expandCollapseNode(b,a,c,d,e))},expandCollapseSonNode:function(b,
a,c,d,e){var g=h.getRoot(b),f=b.data.key.children,g=a?a[f]:g[f],f=a?!1:d,k=h.getRoot(b).expandTriggerFlag;h.getRoot(b).expandTriggerFlag=!1;if(g)for(var l=0,n=g.length;l<n;l++)g[l]&&i.expandCollapseSonNode(b,g[l],c,f);h.getRoot(b).expandTriggerFlag=k;i.expandCollapseNode(b,a,c,d,e)},makeNodeFontCss:function(b,a){var c=k.apply(b.view.fontCss,[b.treeId,a],b.view.fontCss);return c&&typeof c!="function"?c:{}},makeNodeIcoClass:function(b,a){var c=["ico"];a.isAjaxing||(c[0]=(a.iconSkin?a.iconSkin+"_":"")+
c[0],a.isParent?c.push(a.open?f.folder.OPEN:f.folder.CLOSE):c.push(f.folder.DOCU));return"button "+c.join("_")},makeNodeIcoStyle:function(b,a){var c=[];if(!a.isAjaxing){var d=a.isParent&&a.iconOpen&&a.iconClose?a.open?a.iconOpen:a.iconClose:a.icon;d&&c.push("background:url(",d,") 0 0 no-repeat;");(b.view.showIcon==!1||!k.apply(b.view.showIcon,[b.treeId,a],!0))&&c.push("width:0px;height:0px;")}return c.join("")},makeNodeLineClass:function(b,a){var c=[];b.view.showLine?a.level==0&&a.isFirstNode&&a.isLastNode?
...
c;a++){if(a==0)z.dragNodeShowBefore=[];e=m[a];e.isParent&&e.open?(f.expandCollapseNode(g,e,!e.open),z.dragNodeShowBefore[e.tId]=!0):z.dragNodeShowBefore[e.tId]=!1}z.dragFlag=1;z.showHoverDom=!1;h.showIfameMask(g,!0);e=!0;j=-1;if(m.length>1){var s=m[0].parentTId?m[0].getParentNode()[l]:p.getNodes(g);l=[];for(a=0,c=s.length;a<c;a++)if(z.dragNodeShowBefore[s[a].tId]!==void 0&&(e&&j>-1&&j+1!==a&&(e=!1),l.push(s[a]),j=a),m.length===l.length){m=l;break}}e&&(E=m[0].getPreNode(),N=m[m.length-1].getNextNode());
...
"_"+F.move.TYPE_INNER));u=r=null;w=!1;i=g;e=p.getSettings();for(var B in e)if(e[B].treeId&&e[B].edit.enable&&e[B].treeId!=g.treeId&&(b.target.id==e[B].treeId||k(b.target).parents("#"+e[B].treeId).length>0))w=!0,i=e[B];B=y.scrollTop();j=y.scrollLeft();l=i.treeObj.offset();a=i.treeObj.get(0).scrollHeight;e=i.treeObj.get(0).scrollWidth;c=b.clientY+B-l.top;var o=i.treeObj.height()+l.top-b.clientY-B,n=b.clientX+j-l.left,G=i.treeObj.width()+l.left-b.clientX-j;l=c<g.edit.drag.borderMax&&c>g.edit.drag.borderMin;
var s=o<g.edit.drag.borderMax&&o>g.edit.drag.borderMin,H=n<g.edit.drag.borderMax&&n>g.edit.drag.borderMin,D=G<g.edit.drag.borderMax&&G>g.edit.drag.borderMin,o=c>g.edit.drag.borderMin&&o>g.edit.drag.borderMin&&n>g.edit.drag.borderMin&&G>g.edit.drag.borderMin,n=l&&i.treeObj.scrollTop()<=0,G=s&&i.treeObj.scrollTop()+i.treeObj.height()+10>=a,L=H&&i.treeObj.scrollLeft()<=0,M=D&&i.treeObj.scrollLeft()+i.treeObj.width()+10>=e;if(b.target.id&&i.treeObj.find("#"+b.target.id).length>0){for(var A=b.target;A&&
...
null;Q=P=null;y.unbind("mousemove",c);y.unbind("mouseup",q);y.unbind("selectstart",e);k("body").css("cursor","auto");r&&(r.removeClass(d.node.TMPTARGET_TREE),u&&k("#"+u+d.id.A,r).removeClass(d.node.TMPTARGET_NODE+"_"+d.move.TYPE_PREV).removeClass(d.node.TMPTARGET_NODE+"_"+F.move.TYPE_NEXT).removeClass(d.node.TMPTARGET_NODE+"_"+F.move.TYPE_INNER));h.showIfameMask(g,!1);z.showHoverDom=!0;if(z.dragFlag!=0){z.dragFlag=0;var a,l,j;for(a=0,l=m.length;a<l;a++)j=m[a],j.isParent&&z.dragNodeShowBefore[j.tId]&&
!j.open&&(f.expandCollapseNode(g,j,!j.open),delete z.dragNodeShowBefore[j.tId]);C&&C.remove();t&&t.remove();var o=b.ctrlKey&&g.edit.drag.isMove&&g.edit.drag.isCopy||!g.edit.drag.isMove&&g.edit.drag.isCopy;!o&&r&&u&&m[0].parentTId&&u==m[0].parentTId&&v==d.move.TYPE_INNER&&(r=null);if(r){var n=u==null?null:p.getNodeCache(i,u);if(h.apply(g.callback.beforeDrop,[i.treeId,m,n,v,o],!0)!=!1){var s=o?h.clone(m):m;a=function(){if(w){if(!o)for(var b=0,a=m.length;b<a;b++)f.removeNode(g,m[b]);if(v==d.move.TYPE_INNER)f.addNodes(i,
...
f.expandCollapseNode(b,a,!0,!1):l||f.expandCollapseNode(b,a.getParentNode(),!0,!1),o=k("#"+a.tId),n=k("#"+a.tId+d.id.UL),o.get(0)&&!n.get(0)&&(n=[],f.makeUlHtml(b,a,n,""),o.append(n.join(""))),n=k("#"+a.tId+d.id.UL));var m=k("#"+c.tId);m.get(0)?o.get(0)||m.remove():m=f.appendNodes(b,c.level,[c],null,!1,!0).join("");n.get(0)&&q==d.move.TYPE_INNER?n.append(m):o.get(0)&&q==d.move.TYPE_PREV?o.before(m):o.get(0)&&q==d.move.TYPE_NEXT&&o.after(m);var y=-1,w=0,t=null,o=null,r=c.level;if(c.isFirstNode){if(y=
0,h[g].length>1)t=h[g][1],t.isFirstNode=!0}else if(c.isLastNode)y=h[g].length-1,t=h[g][y-1],t.isLastNode=!0;else for(n=0,m=h[g].length;n<m;n++)if(h[g][n].tId==c.tId){y=n;break}y>=0&&h[g].splice(y,1);if(q!=d.move.TYPE_INNER)for(n=0,m=j[g].length;n<m;n++)j[g][n].tId==a.tId&&(w=n);if(q==d.move.TYPE_INNER){a[g]||(a[g]=[]);if(a[g].length>0)o=a[g][a[g].length-1],o.isLastNode=!1;a[g].splice(a[g].length,0,c);c.isLastNode=!0;c.isFirstNode=a[g].length==1}else a.isFirstNode&&q==d.move.TYPE_PREV?(j[g].splice(w,
0,c),o=a,o.isFirstNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!0,c.isLastNode=!1):a.isLastNode&&q==d.move.TYPE_NEXT?(j[g].splice(w+1,0,c),o=a,o.isLastNode=!1,c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!0):(q==d.move.TYPE_PREV?j[g].splice(w,0,c):j[g].splice(w+1,0,c),c.parentTId=a.parentTId,c.isFirstNode=!1,c.isLastNode=!1);p.fixPIdKeyValue(b,c);p.setSonNodeLevel(b,c.getParentNode(),c);f.setNodeLineIcos(b,c);f.repairNodeLevelClass(b,c,r);!b.data.keep.parent&&h[g].length<1?(h.isParent=!1,
...
f,[{tagName:"a",attrName:"treeNode"+d.id.A}]),k||(e="remove",j="hoverOutNode");else if(h.eqs(b.type,"mousedown")&&(k=h.getMDom(c,a,[{tagName:"a",attrName:"treeNode"+d.id.A}])))e=k.parentNode.id,j="mousedownNode";if(e.length>0)switch(l=p.getNodeCache(c,e),j){case "mousedownNode":g=E.onMousedownNode;break;case "hoverOverNode":g=E.onHoverOverNode;break;case "hoverOutNode":g=E.onHoverOutNode}return{stop:!1,node:l,nodeEventType:j,nodeEventCallback:g,treeEventType:"",treeEventCallback:null}});p.addInitRoot(function(b){b=
p.getRoot(b);b.curEditNode=null;b.curEditInput=null;b.curHoverNode=null;b.dragFlag=0;b.dragNodeShowBefore=[];b.dragMaskList=[];b.showHoverDom=!0});p.addZTreeTools(function(b,a){a.cancelEditName=function(a){var d=p.getRoot(b),e=b.data.key.name,h=d.curEditNode;d.curEditNode&&f.cancelCurEditNode(b,a?a:h[e])};a.copyNode=function(a,k,e,l){if(!k)return null;if(a&&!a.isParent&&b.data.keep.leaf&&e===d.move.TYPE_INNER)return null;var j=h.clone(k);if(!a)a=null,e=d.move.TYPE_INNER;e==d.move.TYPE_INNER?(k=function(){f.addNodes(b,
a,[j],l)},h.canAsync(b,a)?f.asyncNode(b,a,l,k):k()):(f.addNodes(b,a.parentNode,[j],l),f.moveNode(b,a,j,e,!1,l));return j};a.editName=function(a){a&&a.tId&&a===p.getNodeCache(b,a.tId)&&(a.parentTId&&f.expandCollapseParentNode(b,a.getParentNode(),!0),f.editNode(b,a))};a.moveNode=function(a,q,e,l){function j(){f.moveNode(b,a,q,e,!1,l)}if(!q)return q;if(a&&!a.isParent&&b.data.keep.leaf&&e===d.move.TYPE_INNER)return null;else if(a&&(q.parentTId==a.tId&&e==d.move.TYPE_INNER||k("#"+q.tId).find("#"+a.tId).length>
0))return null;else a||(a=null);h.canAsync(b,a)?f.asyncNode(b,a,l,j):j();return q};a.setEditable=function(a){b.edit.enable=a;return this.refresh()}});var J=f.cancelPreSelectedNode;f.cancelPreSelectedNode=function(b,a){for(var c=p.getRoot(b).curSelectedList,d=0,e=c.length;d<e;d++)if(!a||a===c[d])if(f.removeTreeDom(b,c[d]),a)break;J&&J.apply(f,arguments)};var K=f.createNodes;f.createNodes=function(b,a,c,d){K&&K.apply(f,arguments);c&&f.repairParentChkClassWithSelf&&f.repairParentChkClassWithSelf(b,d)};
f.makeNodeUrl=function(b,a){return a.url&&!b.edit.enable?a.url:null};var I=f.removeNode;f.removeNode=function(b,a){var c=p.getRoot(b);if(c.curEditNode===a)c.curEditNode=null;I&&I.apply(f,arguments)};var L=f.selectNode;f.selectNode=function(b,a,c){var d=p.getRoot(b);if(p.isSelectedNode(b,a)&&d.curEditNode==a&&a.editNameFlag)return!1;L&&L.apply(f,arguments);f.addHoverDom(b,a);return!0};var M=h.uCanDo;h.uCanDo=function(b,a){var c=p.getRoot(b);return a&&(h.eqs(a.type,"mouseover")||h.eqs(a.type,"mouseout")||
h.eqs(a.type,"mousedown")||h.eqs(a.type,"mouseup"))?!0:!c.curEditNode&&(M?M.apply(f,arguments):!0)}})(jQuery);
